...
function PrintthisBillHMSSales(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    myWindow.document.write('<table style="border-left:1px solid black;border-right:1px solid black" width=100% ><tr ><td width=10% align=left >OP#&#160;&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#HOpNo').val() + '</td><td align=right width=10%>Bill No &#160;&#160;: </td><td  colspn=2 width=20% >' + SNo + '</td></tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#HPatient').val() + '</td><td align=right width=10%>Date &#160;&#160;&#160;&#160;&#160;&#160;: </td><td colspn=2 width=20% >' + $('#HSalesDate').val() + '</td></tr>');
    ...
    var HeaderRow = '';
    HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td align=center width=3%>Sl#</td><td align=center width=5%>MFR</td><td colspan=6 align=center width=22%>Product</td><td width=10% align=center>Batch</td><td width=5% align=center>Expiry</td><td width=5% align=center>Qty.</td><td align=center width=5%>Rate</td><td align=center width=5%>Amount</td></tr>';
    ...
    for (var i = 0; i <= Rowlen; i++) { 
        ...
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#tdSl' + Id).text() + '</td><td style="padding-left:5px">' + $('#Company' + Id).val() + '</td><td colspan=6 style="padding-left:5px">' + $('#Product' + Id).val().substring(0, 20) + '</td><td style="padding-left:5px">' + $('#ProductDesc' + Id).val() + '</td><td style="padding-left:5px">' + $('#Expiry' + Id).val() + '</td><td align=center style="padding-left:5px">' + $('#Quantity' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px">' + $('#Amount' + Id).val() + '</td></tr>');
    ...
    for (var i = 1; i <= Prlen; i++) {
        ...
        if ($('#Procedure' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + slnm + '</td><td style="padding-left:5px"> </td><td colspan=2 style="padding-left:5px">' + $('#Procedure' + Id).val().substring(0, 20) + '</td><td style="padding-left:5px"> </td><td style="padding-left:5px"> </td><td style="padding-left:5px">' + $('#ProcQty' + Id).val() + '</td><td style="padding-left:5px"> 0 </td><td align=right style="padding-right:5px">' + $('#ProcFee' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#ProcFee' + Id).val() + '</td><td align=right style="padding-right:5px">' + $('#ProcTaxable' + Id).val() + '</td><td align=right style="padding-right:5px">' + $('#ProcTaxamt' + Id).val() + '</td><td align=right style="padding-right:5px">' + $('#ProcTot' + Id).val() + '</td></tr>');
            if (Rowcount % MaxCnt == 0) {
                Rowcount = 0;
                myWindow.document.write('<tr style="border:1px solid black;border-left:1px solid white;border-right:1px solid white;"><td height=170px colspan=13></td></tr>');
            }
    ...
    for (var a = 1; a <= Cnt ; a++) {
        var RoughRow = '';
        RoughRow = '<tr class=brtd2 ><td style="border-left:1px solid grey;opacity:0" align=center >' + a + '</td><td style="padding-left:5px"></td><td colspan=6 style="padding-left:5px"></td><td align=right style="padding-right:5px"></td><td style="padding-left:5px"></td><td align=right style="padding-right:5px"></td><td align=right style="padding-right:5px"></td><td align=right style="padding-right:5px"></td></tr>';
...
function PrintthisBillLab(Rowlen, flg, type,Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    myWindow.document.write('<table width=100% ><tr ><td width=10% align=left >OP#&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#OpNo').val() + '</td><td align=right width=10%>Date &#160;&#160;&#160;&#160;&#160;&#160;: </td><td  colspn=2 width=20% >' + $('#BillDate').val() + '</td></tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#Name').val() + '</td><td align=right width=10%>Age/Sex : </td><td colspn=2 width=20% >' + Age + '</td></tr>');
    ...
    var HeaderRow = '';
    if (Bill == 'LB')
    { HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td align=center>Sl#</td><td align=center width=10% colspan=2>Department</td><td colspan=2 align=center width=30%>TestName</td><td align=center>Speicmen</td><td align=right>DueDate</td><td align=right>Amount</td></tr>';}
    else
    { HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td align=center>Sl#</td><td colspan=2 align=center width=30%>Description</td><td align=center>Speicmen</td><td align=right>DueDate</td><td align=center >Qty</td><td align=right >Rate</td><td align=right>Amount</td></tr>'; }
    ...
    myWindow.document.write('<table style="border-collapse:collapse;font-size:80%;" frame="box" width=100% bordercolor="grey">' + HeaderRow);
        ...
        for (var i = 0; i <= Rowlen; i++) {
            ...
            if ($('#TestName' + Id).length) {
                Rowcount += 1;
                if (Bill == 'LB')
                { myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px" colspan=2>' + $('#Department' + Id + ' :selected').text() + '</td><td style="padding-left:5px"  colspan=2>' + $('#TestName' + Id).val() + '</td><td align=center></td><td align=right style="padding-right:5px"></td><td align=right style="border-right:1px solid grey;padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
                else
                { myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=2>' + $('#TestCode' + Id).val() + '</td><td align=center></td><td align=right style="padding-right:5px"></td><td style="padding-left:5px" align=left>' + $('#PQty' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#PRate' + Id).val() + '</td><td align=right style="border-right:1px solid grey;padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
        ...
        if (Bill == 'LB')
        {
            RoughRow += '<tr class=brtd2><td style="border-left:1px solid grey;" align=center>&#160;</td><td style="padding-left:5px" colspan=2></td><td style="padding-left:5px" colspan=2></td><td align=center></td><td align=right style="padding-right:5px"></td><td align=right style="border-right:1px solid grey;padding-right:5px"></td></tr>';
        }
        else
        {
            RoughRow += '<tr class=brtd2><td style="border-left:1px solid grey;" align=center>&#160;</td><td style="padding-left:5px" colspan=2></td><td align=center></td><td align=right style="padding-right:5px"></td><td style="padding-left:5px" ></td><td style="padding-left:5px" ></td><td align=right style="border-right:1px solid grey;padding-right:5px"></td></tr>';
        }
        ...
        myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td colspan=6 font-size: 13px;" align=center style="font-weight:bold">' + AmountinWords + '</td><td style="font-family:tahoma;font-size: 13px;border-left:1px solid grey;" align=center ><b>Total</b></td><td style="font-family:tahoma; font-size: 13px;border-left:1px solid grey;"  align=right ><b>' + addCommas(parseFloat($('#GrandTotal').text()).toFixed(Decimal)) + '</b></td></tr>');
        myWindow.document.write('</table>');
