...
function PrintTestResult(Rowlen) {
   ...
   //  '<tr><td></td><td>  </td><td></td></tr></table></td>');
    ...
    myWindow.document.write('<table  style="" width=100%>' +
        ...
        '<tr><td>Contact No</td> <td> : </td><td>' +($("#Remarksphone").val()).replace('##','') + '</td></tr>' +
        '</table></td>');
   ...
   // myWindow.document.write('<td  width=15% align="right"><table  style="font-family:tahoma; font-size:13px;font-weight: bold;">' +
    ...
    for (var i = 1; i <= Rowlen; i++) {
        ...
        if ($("#selprint_" + i).is(":checked")) {
            ...
            if ($("#Notes_" + i).val() != '') {
                ...
                if (Dept != CurrentDept) {
                CurrentDept = Dept;
                myWindow.document.write('<tr><td align=left colspan=3 class="p-0" style=" border:0px solid black;" height="" ><b>' + $("#MedDept_" + i).val() + '</b></td><tr>');
                //linecount += 1;
            }
            if (TestHead != 0 && SubTestId == 0 && TestHead != CurrentMainTest) {
                CurrentMainTest = $("#TestId_" + i).val();
                myWindow.document.write('<tr><td colspan=3 class="p-0" height="20" style=" border:0px solid black;"><b>' + $("#TestName_" + i).text() + '<b></td><tr>');
                linecount += 1;
            }
                ...
                if (($("#TestName_" + i).text()).includes("@@")) {
                    myWindow.document.write('<tr>' +
                        '<td style="padding:5px;  border:0px solid black;font-family:tahoma; font-size: 13px;" class="p-0"  ><b>' + ($("#TestName_" + i).text()).replace("@@", "") + '</b></td>' +
                        '<td style="padding:5px;font-family:tahoma; border:0px solid black; font-size: 13px;"  class="p-0"  ></td>' +
                        '<td style="padding:5px;font-family:tahoma; border:0px solid black; font-size: 13px;"  class="p-0"  ></td>' +
                        '<tr>');

                }

                else if (($("#TestName_" + i).text()).includes("##")) {
                    myWindow.document.write('<tr>' +
                        '<td style="padding:5px;  border:0px solid black;font-family:tahoma; font-size: 13px;" class="p-0"  >&#160;&#160;' + ($("#TestName_" + i).text()).replace("##", "&#160;")   + '</td>' +
                        '<td style="padding:5px;font-family:tahoma; border:0px solid black; font-size: 13px;"  class="p-0"  ><b>' + $("#Result_" + i).val() + ' ' + $("#StdUnit_" + i).text() + '</b></td>' +
                        '<td style="padding:5px;font-family:tahoma; border:0px solid black; font-size: 13px;"  class="p-0"  >' + ($("#NormalValue_" + i).val()).replace(/##/g, "<br>") + '</td>' +
                        '<tr>');
                }
                else {

                    myWindow.document.write('<tr>' +
                        '<td style="padding:5px;  border:0px solid black;font-family:tahoma; font-size: 13px;" class="p-0"  >' + $("#TestName_" + i).text() + '</td>' +
                        '<td style="padding:5px;font-family:tahoma; border:0px solid black; font-size: 13px;"  class="p-0"  ><b>' + $("#Result_" + i).val() + ' ' + $("#StdUnit_" + i).text() + '</b></td>' +
                        '<td style="padding:5px;font-family:tahoma; border:0px solid black; font-size: 13px;"  class="p-0"  >' + ($("#NormalValue_" + i).val()).replace(/##/g, "<br>") + '</td>' +
                        '<tr>');
            ...
            if (linecount == 26 || linecount == 25 || linecount == 27)//from layout
            {
                var LROW1 = 150;
    ...
    myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;"  width=100%><tr><td height=20px></td></tr><tr><td colspan=3 style="font-family:tahoma;font-size: 12px;" align=center>*****  END OF REPORT  *****</td></tr> </table>');
    myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;"  width=100%>  <tr><td width=150px align=center>&#160; </td><td></td><td width=150px align=center>&#160;' + (SignPrintincharge.outerHTML) + ' </td></tr>                      <tr><td  width=150px align=center>LAB TECHNICIAN</td><td></td><td  width=150px align=center>LAB INCHARGE</td></tr></table>');
