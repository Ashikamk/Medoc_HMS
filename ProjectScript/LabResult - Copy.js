        ...
        for (var i = 0; i < result.length; i++) {
            ...
            if (result[i].Flag == 1) {
                ...
                var ProdEditRow = "<tr class='jsgrid-sub-header-row Resulttr' id='Trow_" + id + "' >" +
                    ...
                    "<input class='efgh'  id='selprint_" + id + "'  type='checkbox'  checked ></td>" +
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            if (FirstId == 0) FirstId = id;
                ...
                var ProdEditRow1 = "<tr class='jsgrid-row Resulttr' id='row_" + id + "' >" +
                    ...
                    "<input type='hidden' id='subtype_" + id + "' value='" + result[i].Status + "'/>" +
                    "</td>" +
                    "<td class='jsgrid-cell p-1 GridBRow " + Border + "' width=30px> <input class='efgh'   id='selprint_" + id + "' checked  type='checkbox'></td><td class='jsgrid-cell p-1 GridBRow " + Border + "' id='TestName_" + id + "'  style= 'width:384px;font-weight:bold;' >" + result[i].SubTestName +
                    "</td>" +
                    "<td class='jsgrid-cell p-1 GridBRow " + Border + "' id='Resulttd_" + id + "' style= 'width:384px;' >" +
