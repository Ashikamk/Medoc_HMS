...
$(document).ready(function () {
    ...
    $('#Expiry_0').keydown(function (e) {
        ...
        if (key == 13) {
            if ($('#Expiry_0').val() != '') {
                e.preventDefault();
                $("#Batch_color").focus().select();
            }

        }
    });
    $('#Batch_color').keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 13) {
            if ($('#Batch_color').val() != '') {
                e.preventDefault();
                $("#Batch_size").focus().select();
            }

        }
    });
    $('#Batch_size').keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 13) {
            if ($('#Batch_size').val() != '') {
                e.preventDefault();
                $("#Batch_material").focus().select();
            }

        }
    });
    $('#Batch_material').keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 13) {
            if ($('#Batch_material').val() != '') {
                e.preventDefault();
                $("#Qty_0").focus().select();
            }
...
function OKProductAdd() {
    ...
    var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
        ...
        '<td width="4%"><input id="Expiry_' + Id + '" value="' + $.trim($("#Expiry_0").val()) + '" class="form-control text-center smallTextbox borderno"  onkeypress="isNumberDate(event, this)" onkeyup="ExpiryDate(\'Expiry_' + Id + '\')" onkeydown="FocusNext(event, \'Batch_\', \'Expiry_\', \'Pack_\', ' + Id + ',\'MTr_\')" /></td>' +

        //stephy

        '<td width="3%"><input id="Batchcolor_' + Id + '" value="' + $.trim($("#Batch_color").val()) + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Batchsize_' + Id + '" value="' + $.trim($("#Batch_size").val()) + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Batchmaterial_' + Id + '" value="' + $.trim($("#Batch_material").val()) + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%" style="display:none;"><input id="Pack_' + Id + '" value="' + parseInt($("#Pack_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Expiry_\', \'Pack_\', \'Qty_\', ' + Id + ',\'MTr_\')" /></td>' +



        //  '<td width="4%"><input id="Pack_' + Id + '" value="' + parseInt($("#Pack_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Expiry_\', \'Pack_\', \'Qty_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="4%"><input id="Qty_' + Id + '" value="' + parseInt($("#Qty_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Pack_\', \'Qty_\', \'Free_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="4%"><input id="Free_' + Id + '" value="' + parseInt($("#Free_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Qty_\', \'Free_\', \'Loose_\', ' + Id + ',\'MTr_\')" /></td>' +
        ...
        '<td width="5%"><input id="amoutwithdis_' + Id + '" value="0" class="form-control text-right smallTextbox dedisa borderno bg-white" disabled onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Free_\', \'Loose_\', \'Rate_\', ' + Id + ',\'MTr_\')" /></td>' +
    ...
    for (var i = 1; i <= GridLength; i++) {
        ...
        if ($('#Product_' + i).val() != undefined) {
            ...
            oArray.push({
                ...
                'BatchSlNo': 0,
                //stephy
                'Batch': $.trim($("#Batch_" + i).val()) + '##' + $("#Batchcolor_" + i).val() + '##' + $("#Batchsize_" + i).val() + '##' + $("#Batchmaterial_" + i).val(),
...
function PurchaseGets(result) {
    ...
    if (result.length > 0) {
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            //stephy
            var batchh = (result[i].Batch).split("##");
            $('#Batch_').val(batchh[0])
            $('#Batchcolor_').val(batchh[1])
            $('#Batchsize_').val(batchh[2])
            $('#Batchmaterial_').val(batchh[3])
            ...
            var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
                ...
                '<td width="5%"><input id="Batch_' + Id + '" value="' + batchh[0] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="4%"><input id="Expiry_' + Id + '" value="' + result[i].Expiry + '" class="form-control text-center smallTextbox borderno"  onkeypress="isNumberDate(event, this)" onkeyup="ExpiryDate(\'Expiry_' + Id + '\')" onkeydown="FocusNext(event, \'Batch_\', \'Expiry_\', \'Pack_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="4%" style="display:none;"><input id="Pack_' + Id + '" value="' + result[i].Pack + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Expiry_\', \'Pack_\', \'Qty_\', ' + Id + ',\'MTr_\')" /></td>' +


                //stephy

                '<td width="3%"><input id="Batchcolor_' + Id + '" value="' + batchh[1] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Batchsize_' + Id + '" value="' + batchh[2] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Batchmaterial_' + Id + '" value="' + batchh[3] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +

                '<td width="4%"><input id="Qty_' + Id + '" value="' + result[i].Quantity + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Pack_\', \'Qty_\', \'Free_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="4%"><input id="Free_' + Id + '" value="' + result[i].Free + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Qty_\', \'Free_\', \'Loose_\', ' + Id + ',\'MTr_\')" /></td>' +
    ...
    if (result.length > 0) {
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
                ...
                '<td width="3%"><input id="Batchcolor_' + Id + '" value="' + batchh[1] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batchcolor_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Batchsize_' + Id + '" value="' + batchh[2] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batchsize_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Batchmaterial_' + Id + '" value="' + batchh[3] + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batchmaterial_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +



                '<td width="4%"><input id="Pack_' + Id + '" value="' + result[i].Pack + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Expiry_\', \'Pack_\', \'Qty_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="4%"><input id="Qty_' + Id + '" value="' + result[i].Quantity + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Pack_\', \'Qty_\', \'Free_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="4%"><input id="Free_' + Id + '" value="' + result[i].Free + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Qty_\', \'Free_\', \'Loose_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td style=display:none width="5%"><input id="Loose_' + Id + '" value="' + result[i].Loose + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Free_\', \'Loose_\', \'Rate_\', ' + Id + ',\'MTr_\')" /></td>' +
