        ...
        for (m = 1; m <= row; m++) {
            if ($("#SlNoCheckgrid" + m).is(":checked")) {
                ...
                var ProdEditRow = "<tr class='jsgrid-row' id='row_" + slno + "'>" +
                    ...
                    "<td id='col_13' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-left'  style='width:250px;'><input type='hidden' id='jobcodeid_" + slno + "' value='" + LiJobid + "'><input type='text' id='jobcode_" + slno + "' value='" + Lijobcode + "' class='form-control' style='height:30px;background-color:white'  disabled></td>" +
...
function Productadd() {
    ...
    if (Product == "") {
        ...
        CalCDefTaxSplit();
        $('#prodappdiv').empty();
        $('#prodappdiv').append("<input type='text' id='product_0' class='form-control editds ui-autocomplete-input' style='height:65%;margin-left:1px' onkeypress='LoadProduct()' onkeyup='checkproduct()'><div class='input-group-append'><button class='btn btn-outline-primary butndis' id='addproductbtn' type='button' style='height:65%' onclick=window.open('../Master/ItemMaster')>+</button></div>");
        ...
        var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'><td id='edit_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;' ><input class='jsgrid-button jsgrid-edit-button' type='button' title='Edit' onclick='Editrow(" + id + ")'><input class='jsgrid-button jsgrid-delete-button'  type= button onclick='DeleteRow(" + id + ")'  title= Delete ></td><td id='update_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;display:none' ><input class='jsgrid-button jsgrid-update-button' type='button' title='Update' onclick='UpdateRow(" + id + ")'><input class='jsgrid-button jsgrid-cancel-edit-button' type='button' title='Cancel edit' onclick='CancelEdit(" + id + ")'></td><td id='td_" + id + "' class='jsgrid-cell'  style= 'width:4%;text-align:center' >" +
            ...
            Product + "' title=" + Product + "></td><td id='col_x' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:27%;' ><input type='text' id='productdesc_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='"
            + $("#productdesc_0").val() + "' title='" + $("#productdesc_0").val() + "'></td><td id='col_4' class='jsgrid-cell'  style='width:120px;display:none' > <select id='unit_" + id + "' onchange='CheckFOC(" + id + ",this)' class='form-control' disabled style='height:30px;background-color:white' >" +
            UnitSelect + "</select><input type='hidden' id='txtunit_" + id + "' class='form-control' /></td><td id='col_5' class= 'jsgrid-cell jsgrid-align-center'  style='width:9%;' ><input type='text' id='quantity_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='" +
            parseInt($("#quantity_0").val()) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumberInt(event,this)' ></td><td id='col_6' class= 'jsgrid-cell jsgrid-align-center'  style='width:9%;' ><input type='text' id='txtrate_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
            ...
            parseFloat($("#baserate_0").val()).toFixed(Decimal) + "' ></td><td id='col_7' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:9%;' ><input type='text' id='discount_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
            parseFloat($("#discount_0").val() || 0).toFixed(Decimal) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumber(event,this)'></td><td id='col_8' class='jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:120px;display:none' ><input type='text' id='txttaxable_" + id + "' class='form-control' style='height:30px;background-color:white'  value='" +
            parseFloat($("#txttaxable_0").val()).toFixed(Decimal) + "' disabled></td><td id='col_9' class='jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:140px;display:none' > <select  class='form-control' disabled style='height:30px;background-color:white' id='tax_" + id + "' onchange='ChangeTax(" + id + ",this)' >" +
            TaxSelect + "</select><input type='hidden' id='taxpercentage_" + id + "' value=" +
            $("#taxpercentage_0").val() + "></td><td id='col_10' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:120px;display:none' ><input type='text' id='txttax_" + id + "' class='form-control' style='height:30px;background-color:white' disabled value='" +
            parseFloat($("#txttax_0").val()).toFixed(Decimal) + "'></td><td id='col_11' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:9%;' ><input type='hidden' id='txtsubtotal_" + id + "' value='" +
            ...
            parseFloat($("#basediscount_0").val()).toFixed(Decimal) + "'></td><td id='col_3' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:120px;display:none' > <select id='locn_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
            ...
            + $("#jobcode_0").val() + "'></td><td id='col_12' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center showothercost'  style='width:9%;display:none'><input type='text' id='othercost_" + id + "' class='form-control' style='height:30px;background-color:white'  disabled value=''></td></tr>";
...
function PurchaseGets(result) {
    ...
    for (var n = 0; n < result.length; n++) {
        ...
        "<td id='" + id + "' class='jsgrid-cell jsgrid-align-center jsgrid-sortable' style='width:4%'>" +
         id + "<input type='hidden' id='sl_" + id + "' value=" + id + "></td>" +
        "<td id='col_1' class='jsgrid-cell jsgrid-align-left jsgrid-sortable' style='width:18%'><input type='hidden' id='productId_" + id + "' value='" +
        ...
        "<td id='col_x' class='jsgrid-cell jsgrid-align-left jsgrid-sortable' style='width:27%'><input type='text' id='productdesc_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='"
        + result[n].ItemDescription + "'></td>" +
        "<td id='col_3' class='jsgrid-cell jsgrid-align-center jsgrid-sortable' style='width:120px;display:none'><select id='unit_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
        UnitSelect + "</select></td>" +
        "<td id='col_4' class='jsgrid-cell jsgrid-align-center jsgrid-sortable' style='width:9%'><input type='text' id='quantity_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='" +
        result[n].Quantity + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumberInt(event,this)' ></td>" +
        "<td id='col_5' class='jsgrid-cell jsgrid-align-center jsgrid-sortable' style='width:9%'><input type='text' id='txtrate_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
        ...
        "<td id='col_6' class='jsgrid-cell jsgrid-align-center' style='width:9%'><input type='text' id='discount_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
        result[n].Discount.toFixed(Decimal) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumber(event,this)'></td>" +
        "<td id='col_7' class='jsgrid-cell jsgrid-align-center' style='width:120px;display:none'><input type='text' id='txttaxable_" + id + "' class='form-control' style='height:30px;background-color:white'  value='" +
        result[n].TaxableAmount.toFixed(Decimal) + "' disabled></td>" +
        "<td id='col_8' class='jsgrid-cell jsgrid-align-center' style='width:140px;display:none'><select  class='form-control' disabled style='height:30px;background-color:white' id='tax_" + id + "' onchange='ChangeTax(" + id + ",this)' >" +
        TaxSelect + "</select><input type='hidden' id='taxpercentage_" + id + "' value=" +
        result[n].TaxRate + "></td>" +
        "<td id='col_9' class='jsgrid-cell jsgrid-align-center' style='width:120px;display:none'><input type='text' id='txttax_" + id + "' class='form-control' style='height:30px;background-color:white' disabled value='" +
        result[n].TaxAmount.toFixed(Decimal) + "'></td>" +
        "<td id='col_10' class='jsgrid-cell jsgrid-align-center' style='width:9%'><input type='hidden' id='txtsubtotal_" + id + "' value=''><input type='text' id='amount_" + id + "' class='form-control' style='height:30px;background-color:white'  disabled value='" +
        ...
        "<td id='col_2' class='jsgrid-cell jsgrid-align-center' style='width:120px;display:none'><select id='locn_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
        ...
        + result[n].JobCode + "'></td>" +
        "<td id='col_11' class='jsgrid-cell jsgrid-align-center showothercost' style='width:9%;display:none'><input type='text' id='othercost_" + id + "' class='form-control' style='height:30px;background-color:white'  disabled value=' " +
    ...
    for (m = 1; m <= row; m++) {
        if ($("#SlNoCheckgridMRV" + m).is(":checked")) {
            ...
            var ProdEditRow = "<tr class='jsgrid-row' id='row_" + slno + "'>" +
                ...
                "<td id='col_6' class= 'jsgrid-cell jsgrid-align-center'  style='width:120px;' ><input type='text' id='txtrate_" + slno + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
                ...
                "<td id='col_9' class='jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:140px;' > <select  class='form-control' disabled style='height:30px;background-color:white' id='tax_" + slno + "' onchange='ChangeTax(" + slno + ",this)' >" +
                ...
                Lijobcode + "' class='form-control' style='height:30px;background-color:white'  disabled></td>" +
                "<td id='col_12' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center showothercost'  style='width:120px;'><input type='text' id='othercost_" + slno + "' class='form-control' style='height:30px;background-color:white'  disabled value=''></td>" +
                "</tr>";
...
function FillPrevoiusUnsavedProduct(result) {
    if (result.length > 0) {
        ...
        for (var n = 0; n < result.length; n++) {
            ...
            "<td id='edit_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input class='jsgrid-button jsgrid-edit-button' type='button' title='Edit' onclick='Editrow(" + id + ")'><input class='jsgrid-button jsgrid-delete-button'  type= button onclick='DeleteRow(" + id + ")'  title= Delete ></td>" +
            "<td id='update_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%;display:none'><input class='jsgrid-button jsgrid-update-button' type='button' title='Update' onclick='UpdateRow(" + id + ")'><input class='jsgrid-button jsgrid-cancel-edit-button' type='button' title='Cancel edit' onclick='CancelEdit(" + id + ")'></td>" +
            "<td id='td_" + id + "' class='jsgrid-cell jsgrid-align-center jsgrid-sortable' style='width:4%'>" +
             id + "<input type='hidden' id='sl_" + id + "' value=" + id + "></td>" +
            "<td id='col_1' class='jsgrid-cell jsgrid-align-left jsgrid-sortable' style='width:18%'><input type='hidden' id='productId_" + id + "' value='" +
             result[n].ItemId + "'><input type='text' id='product_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='" +
             result[n].ItemCode + "'></td>" +
            ...
            + result[n].JobCode + "'></td>" +
            "<td id='col_11' class='jsgrid-cell jsgrid-align-center showothercost' style='width:9%;display:none'><input type='text' id='othercost_" + id + "' class='form-control' style='height:30px;background-color:white'  disabled value='"
            + parseFloat(0).toFixed(Decimal) + "'></td></tr>";
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.length > 0) {
                ...
                disable_datatable('tblalltrans');
                $('#tblalltrans tr').remove();
                var responseText = "<thead><tr><th>TransType</th><th>Bill No.</th><th>Date</th><th>Salesman</th><th>Account</th><th>Status</th><th>Quantity</th><th>Balance</th><th>Cost</th><th>Price</th><th>Location</th><th>Department</th></tr>" +
                     "<tr><th>TransType</th><th>Bill No.</th><th> Date</th><th>Salesman</th><th>Account</th><th>Status</th><th>Quantity</th><th>Balance</th><th>Cost</th><th>Price</th><th>Location</th><th>Department</th></tr></thead><tbody>";
                $('#tblalltrans').html(responseText + '</tbody>');
