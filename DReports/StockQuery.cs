        ...
        public void Configure(Models.ABDataTableModel<string> model)
        {
            ...
            builder.AddModel(model).AddSlnoCaption("Serial#", 10)
                ...
                .AddCol("(sum(Inv_stock.Stock_OpeningQty) + sum(Inv_stock.Stock_InQty) - sum(Inv_stock.Stock_OutQty))", "Stock", "Stock", 15)
                 ...
                 .AddCol("Mst_item.MrpRate", "MrpRate", "MRP", 15, ABDataColType.Numeric)
                //.AddCol("Mst_item.SellingPrice", "R_MRP", "R_MRP", 15, ABDataColType.Numeric)
                .AddCol("Mst_item.LPCost", "LPCost", "LP Cost", 15, ABDataColType.Numeric)
                .AddCol("Mst_item.SellingPrice_1", "W_MRP", "W_MRP", 15, ABDataColType.Numeric)
                .AddCol("Mst_item.SellingPrice_2", "L_MRP", "L_MRP", 15, ABDataColType.Numeric)
                .AddCol("Mst_Item.Active", "Active", "Status", -1)
               ...
               .AddWhere("Mst_Item.DelFlag = 1 group by Mst_Item.ItemId,Mst_Item.ItemCode,Mst_Item.[Description],Mst_UnitMain.UnitName,Mst_GroupMain.GrpName,Mst_SubGroupMain.SbgrpName,Mst_Category.CategoryName,Mst_SubCategory.SubCategoryName,Mst_item.SellingPrice,Mst_item.AvgCost,Mst_item.MrpRate, Mst_item.LPCost,Mst_item.SellingPrice_1,Mst_item.SellingPrice_2,Mst_Item.Active,Mst_item.OpenQty,Mst_item.OpeningCost,Mst_item.GroupId,Mst_item.CategoryId")
