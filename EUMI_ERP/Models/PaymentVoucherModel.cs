...
namespace EUMI_ERP.Models
{
    public class PaymentVoucherModel
    {
        ...
        public DataSet PaymentVoucherGetandGets(PaymentVoucherModel oPaymentVoucherModel, string dbName)
        {
            return oDAccounts.PaymentVoucherGetandGets(oPaymentVoucherModel, dbName);
        }

        public DataSet PaymentVoucherTableInsert(DataTable dt, string dbName)
        {
