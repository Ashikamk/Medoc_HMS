...
function PrintthisBillHMSSalesQR(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    //DL No:RLF20KL2023002604,RLF21KL2023002613

    var GSTINNO = 'GSTIN: 33GUMPS3161Q1ZS';
    ...
    var HeaderRow = '';
    HeaderRow = '<tr  style="font-family:tahoma;border-bottom:0px solid grey;font-size:12px;"><td align=center width=3%>SLNO</td><td colspan=7 align=left width=20%>&#160;&#160;&#160;&#160;&#160;PRODUCT</td><td width=5% align=center>BATCH</td><td width=5% align=center>EXPIRY</td><td width=5% align=center>QTY.</td><td align=right width=5%>MRP</td><td align=right width=5%>RATE</td><td align=right width=5%>AMOUNT</td></tr>';
    ...
    var slnm = 0; var page = 0; var line = 0;
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#Product' + Id).length) {
            ...
            Rowcount += 1;
            line += 1;
            myWindow.document.write('<tr  ><td style="border-left:0px solid grey;font-size:11px;" align=center>' + $('#tdSl' + Id).text() + '</td><td colspan=7 style="padding-left:5px;font-size:11px;">&#160;&#160;&#160;&#160;&#160' + $('#Product' + Id).val() + '</td><td style="padding-left:5px;font-size:11px;">' + $('#ProductDesc' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Expiry' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Quantity' + Id).val() + '</td><td align=right style="padding-left:5px;font-size:11px;">' + $('#PurPrice' + Id).val() + '</td><td style="padding-right:5px;font-size:11px;" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px;font-size:11px;">' + $('#Amount' + Id).val() + '</td></tr>');



            if (line == 17 || line == 34) {

                myWindow.document.write('<tr><td colspan=16 style="border-top:1px solid black;height=20px"></td></tr>');
...
//NO GST
function PrintthisBillHMSSalesQR0(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    var today = new Date();
    var date = today.getFullYear() + '-' + (today.getMonth() + 1) + '-' + today.getDate();
    var today1 = new Date();
    ...
    var HeaderRow = '';
    HeaderRow = '<tr  style="font-family:tahoma;border-bottom:0px solid grey;font-size:12px;"><td align=center width=3%>SLNO</td><td colspan=6 align=left width=20%>&#160;&#160;&#160;&#160;&#160;PRODUCT</td><td width=5% align=center>BATCH</td><td width=5% align=center>EXPIRY</td><td width=5% align=center>QTY.</td>  <td align=right width=5%>MRP</td><td align=right width=5%>RATE</td><td align=right width=5%>AMOUNT</td></tr>';
    ...
    for (var i = 1; i <= Prlen; i++) {
        ...
        if ($('#Procedure' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr  ><td style="border-left:0px solid grey;font-size:11px;" align=center>' + slnm + '</td><td colspan=6 style="padding-left:5px;font-size:11px;">&#160;&#160;&#160;&#160;&#160' + $('#Procedure' + Id).val().substring(0, 20) + '</td><td style="padding-left:5px;font-size:10px;"></td><td align=center style="padding-left:5px;font-size:11px;"></td><td align=center style="padding-left:5px;font-size:10px;"></td><td align=center style="padding-left:5px;font-size:10px;"></td><td style="padding-right:5px;font-size:10px;" align=right></td><td align=right style="padding-right:5px;font-size:11px;">' + $('#ProcTot' + Id).val() + '</td></tr>');
        }
    }
    for (var a = 0; a <= (10 - slnm); a++) {
    ...
    myWindow.document.write('<td width=50% style="border-right:1px solid grey;"><table width=100%><tr><td style="font-family:tahoma;font-size:12;"><center>SPECIALITY CONSULTATION, CASUALITY, PHARMACY, LABORATORY, ECG</center> </td></tr> <tr style="font-family:tahoma;font-size:12;"><td> <b><center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</center></b></td></tr></table> </td>');
...
function PrintthisBillLabsugamhosp(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    var TypeText = '';
    if (Bill == 'LB' || Bill == 'PB') {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-15px" width=100% ><tr ><td  style="font-weight:bold;" width=10% align=left >MR#&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#RegNo').val() + '</td><td width=10%>Date&#160;&#160;&#160;  </td><td  colspn=2 width=20% >:' + $('#BillDate').val() + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 style="font-weight:bold;" align=left width=60%>' + $('#Name').val() + '</td>                                                                        <td width=10%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>                                                            <td width=10%>Bill No</td><td style="font-weight:bold;" colspn=2 width=20% >:' + SNo + '/' + $('#PayType option:selected').text() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');
...
function PrintthisBillLabwithlettertheadIPB(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    if ($('#IpNo').val() != 0) {
        MRHEAD = 'RegNo:';
        MRVALUE = $('#Opseriesname').val() + '-' + $('#RegNo').val() + '&#160;&#160;&#160;&#160;&#160;&#160;&#160;   IP No:' + $('#AdmitDate').val().substring(8,10)+'-'+   $('#IpNo').val()
    }
    ...
    var TypeText = '';
    if (Bill == 'LB' || Bill == 'PB') {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-15px" width=100% ><tr ><td style="font-weight:bold;" width=10% align=left >' + MRHEAD + ' :</td><td colspan=4 style="font-weight:bold;" align=left width=60%>' + MRVALUE + '</td><td width=10%>Date&#160;&#160;&#160;  </td><td  colspn=2 width=20% >:' + $('#BillDate').val() + ' ' + BBilltime + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 style="font-weight:bold;" align=left width=60%>' + $('#Name').val() + '</td>                                                                        <td width=10%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>                                                            <td width=10%>Bill No</td><td style="font-weight:bold;" colspn=2 width=20% >:' + SNo + '/' + $('#PayType option:selected').text() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');
        ...
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;" width=100% ><tr ><td style="font-weight:bold;" width=10% align=left >' + MRHEAD + ' :</td><td style="font-weight:bold;" colspan=4 align=left width=50%>' + MRVALUE + '</td><td align=left width=8%><b> Bill No</b></td><td  colspn=2 width=15% ><b>:' + $('#BillNoCopy').val() + '</b></td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=50%>' + $('#Name').val() + '</td><td align=left width=8%>Bill Date</td><td colspn=2 width=15% >:' + $('#BillDate').val() + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Age/Gender</td><td colspan=4 align=left width=50%>' + Age + '</td><td align=left width=8%>DOA </td><td colspn=2 width=15% >:' + $('#AdmitDate').val() + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=50%>' + $('#Doctor :selected').text() + '</td><td align=left width=8%>DOD </td><td colspn=2 width=15% >:' + $('#DischargeDate').val() + '</td></tr>');
    ...
    if (Bill == 'LB') {
        ...
        myWindow.document.write('<tr  style="font-size: 12px;border-right:1px solid grey;border-bittom:1px solid grey;"><td style="border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;">Sl#</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" colspan=7  width=50%>Description</td>   <td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" align=center >Qty/Days</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" align=right>Amount</td></tr>');
    }
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#TestName' + Id).length) {
            ...
            if (Bill == 'LB') {
                ...
                myWindow.document.write('<tr ><td style=font-family:tahoma;font-size:11px>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px"  colspan=7>' + $('#TestCode' + Id).val() + '</td>     <td style="padding-left:5px;font-family:tahoma;font-size: 11px" align=center>' + $('#PQty' + Id).val() + '</td><td align=right style="padding-right:5px;font-family:tahoma;font-size: 11px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>');
            }
    ...
    if (parseFloat($('#DiscAmt').val() || 0) != 0) {
        ...
        myWindow.document.write('<tr><td style="border-top:1px solid gray" colspan=10></td></tr><tr><td>&#160;</td> <td style="font-weight: bold;font-size: 14px;" align=right>Total  :</td>   <td  style="font-weight: bold;font-size: 14px;" align=right >' + addCommas(parseFloat($('#TotalAmt').text()).toFixed(Decimal)) + '</td></tr>');
        myWindow.document.write('<tr><td></td>   <td style="font-weight: bold;font-size: 14px;" align=right>Dis  :</td><td   style="font-weight: bold;font-size: 14px;" align=right >' + addCommas(parseFloat($('#DiscAmt').val()).toFixed(Decimal)) + '</td></tr>');
    }
    ...
    myWindow.document.write('<tr><td><b>Rupees ' + AmountinWords + '</b></td><td style="font-weight: bold;font-size: 14px;" align=right>Net Total  :</td><td style="font-weight: bold;font-size: 14px;" align=right >' + addCommas(parseFloat($('#GrandTotal').text()).toFixed(Decimal)) + '</td></tr><tr><td style="border-top:1px solid gray" colspan=10></td></tr></table>');
    //myWindow.document.write('<tr><td>This is a computer generated Bill.</td></tr></table>');

    myWindow.document.write('<br><br><table style="font-family:tahoma" width=100%><tr><td style="font-weight: bold;font-size: 14px;">Prepared by</td><td style="font-weight: bold;font-size: 14px;">Checked by</td><td style="font-weight: bold;font-size: 14px;">Approved by</td><td align=right style="font-weight: bold;font-size: 14px;">Cashier</td></tr></table>');


    myWindow.document.write('<br><br><table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:12px;font-weight: bold;" width=100%><tr><td align=center>SPECIALITY CONSULTATION, CASUALITY, PHARMACY, LABORATORY, ECG</td></tr><tr><td align=center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
    ...
    myWindow.document.write('<table style="font-family:tahoma;font-size:10px;" width=100%><tr><td align=left> Prepared by     -' + $('#printiuserdet').text() + '</td></tr></table>');
