...
$(document).keydown(function (e) {
        ...
        else if ((e.altKey && e.keyCode == 83) && (!$("#addacnttype").is(":visible")) && (!$("#iconForm,#salestranspopupdiv,#alertpopup").is(":visible")) && (!$('#duecheckdiv,#confirm,#promptdiv').is(":visible"))) {                        //Alt+S
        ...
        else if ((e.altKey && e.keyCode == 67) && (!$("#addacnttype").is(":visible")) && (!$("#iconForm,#salestranspopupdiv,#alertpopup").is(":visible")) && (!$('#duecheckdiv,#confirm,#promptdiv').is(":visible"))) {                 //Alt+C        
        if (copyflag != 1 && updateflag == 0)
            GetRows();
    }
        else if ((e.altKey && e.keyCode == 78) && (!$("#addacnttype").is(":visible")) && (!$("#iconForm,#salestranspopupdiv,#alertpopup").is(":visible")) && (!$('#duecheckdiv,#confirm,#promptdiv').is(":visible"))) {                  //Alt+N
        formrefreshconfirm();
    }
        ...
        if ($('#salesviewpopup').is(":visible"))
        {
            $('#salesviewpopup').hide(); $('#txtBillSlNocopy').focus(); $('#txtBillSlNocopy').select();
        }
    ...
    else if ((e.altKey) && e.keyCode == 68 && copyflag == 0 && updateflag==0) { 
        //$('#btnQtn').show();
...
function SalesTransactions(ProductId, product, ProductDesc, flag) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            var qty = 0;
            $('#totalnosales,#totalnosalesqty').text('');
            ...
            var ProdRow = "<thead><tr><th>SalesInvoice</th><th>Date</th><th style='width:12%'>AccountName</th><th style='width:15%'>Address</th><th style='width:6%'>Qty.</th><th>Price</th><th>Location</th><th>SalesMan</th><th style='width:7%'>LPO</th><th>Dept</th></tr>" +
                               "<tr><th>SalesInvoice</th><th>Date</th><th style='width:12%'>AccountName</th><th style='width:15%'>Address</th><th style='width:6%'>Qty.</th><th>Price</th><th>Location</th><th>SalesMan</th><th style='width:7%'>LPO</th><th>Dept</th></tr></thead><tbody>";
            ...
            if (result.length != 0) {
                ...
                for (var n = 0; n < result.length; n++) {
                    ...
                    ProdRow += "<tr class='jsgrid-row' id=" + 'pdctrow' + (n + 1) + ">" +
                       ...
                       "<td class='text-left'>" + result[n].DepartmentName + "                                   </td>" +
                        "</tr>";
                    qty = parseInt(qty) + parseInt(result[n].ProdQty);
                }
                ...
                $('#totalnosales,#totalnosalesqty').text(0);
                $('#tblsalestrans').html(ProdRow + '</tbody>');
                datatableWithsearch('tblsalestrans', 'MultipleSalesT');
            }
        }
...
function PurchaseTransactions(ProductId, product, ProductDesc, flag) {
    ...
    $.ajax({
        ...
        success: function (result) {
            ...
            $('#totalnopurchase,#totalnopurchaseqty').text('');
            ...
            if (result.length != 0) {
                ...
                for (var p = 0; p < result.length; p++) {                   
                    ...
                    qtys = parseInt(qtys) + parseInt(result[p].Quantity);
                }
                $('#totalnopurchaseqty').text(qtys);
        ...
        success: function (result) {
            ...
            if (result.length != 0) {
                ...
                for (var n = 0; n < result.length; n++) {
                    ...
                    ProdRow += "<tr class='jsgrid-row' id=" + 'pdctrow' + (n + 1) + ">" +
                               "<td class='text-left text-sizebold'  style='width:1%'> " + result[n].BillNo + "</td>" +
                                 "<td class='text-left text-sizebold' style='width:1%'>" + result[n].InvoDate + " </td>" +
                               "<td class='text-left text-sizebold' style='width:1%'>" + result[n].TransType + "  </td>" +
                              "<td class='text-left text-sizebold' style='width:3%'>" + result[n].Salesman + " </td>" +
                                "<td class='text-left text-sizebold' style='width:1%'>" + result[n].Status + "  </td>" +
                              "<td class='text-left text-sizebold' style='width:6%'>" + result[n].AccountName + " </td>" +
                                "<td class='text-left text-sizebold' style='width:6%'>" + result[n].Remarks + " </td>" +
                              "<td class='text-left text-sizebold' style='width:1%'>" + result[n].Quantity + " </td>" +
                              "<td class='text-left text-sizebold' style='width:1%'>" + BalQty + "  </td>" +
                              "<td class='text-right text-sizebold' style='width:3%'>" + parseFloat(result[n].Cost || 0).toFixed(Decimal) + "   </td>" +
                              "<td class='text-right text-sizebold' style='width:3%'>" + parseFloat(result[n].TransPrice || 0).toFixed(Decimal) + " </td>" +
                               "<td class='text-left text-sizebold' style='width:5%'>" + result[n].Locnname + " </td>" +
                                "<td class='text-left text-sizebold' style='width:1%'>" + result[n].DeptName + "  </td>" +
                                "<td class='text-left text-sizebold' style='width:6%'>" + result[n].JobCode + "  </td>" + "</tr>";
                }
    ...
    if (result != 0) {
        ...
        for (var l = 0; l < result.length; l++) {
            ...
            if((MultiPdtArray.indexOf("" + result[l].ItemId + "") == -1))
            {
                ...
                if ($('#select_location0').val() == 1) { if (result[l].Bin_A != '') { bins = bins + result[l].Bin_A; } }
                else if ($('#select_location0').val() == 2) { if (result[l].Bin_B != '') { bins = bins + result[l].Bin_B; } }
                else if ($('#select_location0').val() == 3) { if (result[l].Bin_C != '') { bins = bins + result[l].Bin_C; } }
                else if ($('#select_location0').val() == 4) { if (result[l].Bin_D != '') { bins = bins + result[l].Bin_D; } }
                else if ($('#select_location0').val() == 5) { if (result[l].Bin_E != '') { bins = bins + result[l].Bin_E; } }
                else if ($('#select_location0').val() == 6) { if (result[l].Bin_F != '') { bins = bins + result[l].Bin_F; } }
                else if ($('#select_location0').val() == 7) { if (result[l].Bin_G != '') { bins = bins + result[l].Bin_G; } }
                else if ($('#select_location0').val() == 8) { if (result[l].Bin_H != '') { bins = bins + result[l].Bin_H; } }
               
                slno++;
                var responseText =
                    '<tr class="removeme"  onclick="rowbgcolor(' + slno + '),GetPrdtId(' + result[l].ItemId + ",'" + result[l].Description + "','" + result[l].ItemCode + "'," + 1 + '),Getproddetails(' + slno + ')" id="mltplerow' + slno + '"><td style="width:90px;" ><input name="Checkprdtlist" onchange=clearcheck(' + slno + ') type="checkbox" disabled id= ' + 'SlNoHeadCheckgrid' + slno + '  class="form-control" style="align:center"></td>' +
                    ...
                    '<td style="text-align:center;" ><select  style="height:30px;" class=form-control id=' + 'Itemunitgrid' + slno + ' onchange=changeunitlist(' + slno + ',this) onkeydown=Focusnext(event,' + slno + ',"u")>' + UnitSelect + '</select></td>' +
                    '<td style="text-align:center;" ><select  style="height:30px;" class=form-control id=' + 'ItemLocngrid' + slno + ' onchange=GetBin(' + slno + ',' + result[l].ItemId + ',1),Locationqtycheck(' + slno + ') onkeydown=Focusnext(event,' + slno + ',"l") >' + LocnSelect + '</select></td>' +
                    ...
                    '<td style="display:none" id=' + 'BCost1_' + slno + '>' + result[l].MultiPriceId + '</td>' + 
                    '</tr>';
...
function checkratestock(id) {
   ...
   // if ($("#SlNoHeadCheckgrid" + id).is(":checked")) {
    ...
    if (($('#Itemunitgrid' + id + ' :selected').text().toLowerCase() != 'foc') && (BelowCost == 'NO') && ($('#BCost1_' + id).text() == 0) && ($('#pravgcost' + id).val() != 0) && (parseFloat($('#prrate' + id).val()) < parseFloat($('#pravgcost' + id).val()))) {
...
function addgridproducts() {
        ...
        for (j = 1; j <= $('#mltrcurrlength').val() ; j++)
        {
            ...
            {
                if (($('#Itemunitgrid' + j + ' :selected').text().toLowerCase() != 'foc') && (BelowCost == 'NO') && ($('#BCost1_' + j).text() == 0) && ($('#pravgcost' + j).val() != 0) && (parseFloat($('#prrate' + j).val()) < parseFloat($('#pravgcost' + j).val()))) {
                    rateflg = 1;
                    break;
                }
                else
        ...
        if (Prodarray.length <= 0) {
            ...
            for (var b = 0; b < Prodarray.length; b++) {
                ...
                if ($("#SlNoHeadCheckgrid" + m).is(":checked")) {
                    ...
                    if ($("#qtypr" + m).val() == '' || 0) {
                    ...
                    else if (($("#prrate" + m).val() == '' || $("#prrate" + m).val() == 0) && ($('#Itemunitgrid' + m + ' :selected').text().toLowerCase() != 'foc')) {
                    ...
                    else if (($("#prdamnt" + m).val() == '' || $("#prdamnt" + m).val() == 0)&&($('#Itemunitgrid' + m + ' :selected').text().toLowerCase() != 'foc')) {
                        ...
                        var ProdRows = "<tr onclick=GetPrdtId(" + $('#ItemIdgrid' + m).val() + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                            "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +                          
                            "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                            "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + $('#ItemIdgrid' + m).val() + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + $('#Itemcodegrid' + m).val() + "'  data-toggle='tooltip' title='" + $('#Itemcodegrid' + m).val() + "'></td>" +
                            "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center;'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + $('#Itemdescgrid' + m).text() + "' data-toggle='tooltip' title='" + $('#Itemdescgrid' + m).text() + "'></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:4%;'><select style='background-color:white;height:30px'  id=" + 'select_location' + id + " class='form-control' onchange ='Locationqtycheckmain(" + id + ")' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text' class='form-control text-center' name='prdaddqty' id=" + 'txtquantity' + id + " value=" + parseInt($('#qtypr' + m).val()) + " style='background-color:white;height:30px' onkeyup='checkqty(" + id + "),amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + ($('#prStockqty' + m).val() || 0) + " style='display:none'></td>" +
                            ...
                            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + parseFloat($('#prdfcdiscount' + m).val()).toFixed(Decimal) + "  style='display:none'><input type='text' id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + parseFloat($('#prdisc' + m).val() || 0).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
                            ...
                            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value=" + $('#Itemtaxgrid' + m).find("option:selected").attr("name") + " onkeyup='amountcalculation(" + id + ")'></td>" +
                            ...
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + parseFloat($('#prLineAvgCost' + m).val()).toFixed(Decimal) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + parseFloat($('#pravgcost' + m).val()).toFixed(Decimal) + " style='background-color:white;height:30px'></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px;' id=" + 'select_tax' +id + " class='form-control' onchange='ChangeTax(" +id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," +id + ") onfocusin=focusingrid('t'," + id + ")>" +TaxSelect + "</select></td>" +
                            "<td style='display:none' id=" + 'Bin' + id + ">" + bins + "</td>" +
                            "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost1_' + m).text() + " ></td>" + 
                            "</tr>";
...
function Checkme(Id) {
    if (($('#qtypr' + Id).val() != '') && ((($('#prrate' + Id).val() != '') && ($('#prdamnt' + Id).val() != 0)) || ($('#Itemunitgrid' + Id + ' :selected').text().toLowerCase() == 'foc'))) {
...
function Focusnext(e, Id, col) {
    ...
    if (key == 40) {            // Down Arrow
        ...
        var nextID = Id;
        try {
            nextID = ($('#mltplerow' + Id).closest('tr').next('tr').attr('id')).match(/\d+/)[0];
        }
        catch (err) {
            nextID = Id;
        }
        ...
        var prevID = Id;
        try {
            prevID = ($('#mltplerow' + Id).closest('tr').prev('tr').attr('id')).match(/\d+/)[0];
        }
        catch (err) {
            prevID = Id;
        }
    ...
    window.setTimeout(function () {
        if ((key == 40) || (key == 39) || (key == 37) || (key == 38) || (key == 13))
            try {

                $('#Productlist tr').removeClass('rowactive');
                var ActiveId = ($(document.activeElement).attr('id')).match(/\d+/)[0];
                Getproddetails(ActiveId);
                GetPrdtId($('#ItemIdgrid' + ActiveId).val(), $('#Itemdescgrid' + ActiveId).text(), $('#col' + ActiveId).text(), 1)
                $('#mltplerow' + ActiveId).addClass('rowactive');
                rowbgcolor(ActiveId);
            }
            catch (err) {
            }
...
function rowbgcolor(Id) {
    ...
    $('#Productlist tr').css('background-color', '');
    $('#Productlist tr').css('font-weight', '');
    for (var c = 1; c <= a; c++) {
...
function loadcust()
{
    ...
    //    $('#txtcustomer').val('');            
    //}
    if ($('#typecash').prop("checked"))         //if Paytype=Cash load Cashcustomer details 
    {       
        $('#txtcustomer').val('CASH CUSTOMER');
        checkcustomerempty(this.event);
...
function savesales(flag) {
    ...
    var r = parseFloat($('#txtcrncyrate').val()).toFixed(Decimal);
    ...
    //}
        ...
        if (a!=false)
        {
            ...
            if (flag == 0)
            {
                ...
                for (var k = 1; k <= i; k++)
                {
                    if (($('#PrdtId' + k).val() != 'undefined') && ($('#PrdtId' + k).val() != undefined))
                    {
                        ch = checkrate(k);
                        if (ch == false)
                        {
                    ...
                    if (k == i && ch==true)
                    {
                        focCheck('save', 'Do You Want To Save The Bill?');
                        //$('#Confirmflag').val('save'); $('#ConfirmRowId').val(0); 
                        //$('#confirmmessage').text('Do You Want To Save The Bill?');
                        //$('#confirm').show();
                        //$('#confirmOk').focus();
            ...
            {
            $('#Confirmflag').val('Quotation'); $('#ConfirmRowId').val(0);
            $('#confirmmessage').text('Do You Want To Save The Quotation?');
            $('#confirm').show();
            $('#confirmOk').focus();
            }
        }
...
function focCheck(flg,Msg)
{
    var ch = 0;
    for (var k = 1; k < i; k++) {
      
        if ($('#PrdtId' + k).val() != undefined) {        
            if (($('#select_unit' + k + ' :selected').text().toLowerCase() != 'foc') && (($.trim($('#txtrate' + k).val()) == 0) || ($.trim($('#txtrate' + k).val()) == ''))) { 
                warningshow('Please Enter Rate', 'txtrate' + k);
                $('#txtrate' + k).select();
                ch = 1;
                break;
            }
        ...
        if (k == (i-1) && ch == 0) {
            $('#Confirmflag').val(flg); $('#ConfirmRowId').val(0);
...
function savesalesconfirm()
{
    ...
    if ($('#select_location0').val() == 0 || $('#select_location0').val() == '')
        $('#select_location0').val(UserLocationId);
    ...
    for (var k = 1; k <= i - 1; k++) {
        ...
        var UnitId = parseInt($('#select_unit' + k).val()||0);
        ...
        var BatchSNo = 1;
        var Batch = ' ';           //$('#txtlgrgname').val() + '-#%%#-' + $('#txtlgrgadr').val() + '-#%%#-' + $('#PhoneNo').val();        //Save Garrage Details
        ...
        var CashAdvance = 0;  //$('#CashAdvance').val();
        var GarageName = $('#txtlgrgname').val(); 
        var GaragePhone = $('#PhoneNo').val();
        var Email = $('#Email').val();
        ...
        $.ajax(
    {
        ...
        type: "POST",
        url: "../SalesInvoice/SalesRentCarInsertandUpdate",
        data: data,
        success: function (result) {
            for (var i = 0; i < result.oList.length; i++) {
                ...
                $('#CurrentTimeSales').val(result.oList[0].CurrentDate);
...
function SaveQuotation()
{
   ...
   // $('#btnQtn').prop('disabled', true);
    ...
    for (var k = 1; k <= i; k++) {
        ...
        var Subjects = '';
        var QuotationCount = 1;
        var Attention = '';
        var Location = $('#select_location0').val(); 
        var QDays = 0;
        ...
        $.ajax(
    {
        ...
        success: function (result) {
               ...
               // $('#btnQtn').prop('disabled', false);
                $('#Loadingsave').hide();
                if (status == 1)
                {
                    Showalerts(7,0, QuotationNo);
                }
...
function FillPrevoiusUnsavedProduct(result) {
    ...
    if (result.length > 0)
    {
        ...
        for (var n = 0; n < result.length; n++) {
            ...
            var bins = '';
            if (result[n].LocnId == 1) { if (result[n].Bin_A != '') { bins = bins + result[n].Bin_A; } }
            else if (result[n].LocnId == 2) { if (result[n].Bin_B != '') { bins = bins + result[n].Bin_B; } }
            else if (result[n].LocnId == 3) { if (result[n].Bin_C != '') { bins = bins + result[n].Bin_C; } }
            else if (result[n].LocnId == 4) { if (result[n].Bin_D != '') { bins = bins + result[n].Bin_D; } }
            else if (result[n].LocnId == 5) { if (result[n].Bin_E != '') { bins = bins + result[n].Bin_E; } }
            else if (result[n].LocnId == 6) { if (result[n].Bin_F != '') { bins = bins + result[n].Bin_F; } }
            else if (result[n].LocnId == 7) { if (result[n].Bin_G != '') { bins = bins + result[n].Bin_G; } }
            else if (result[n].LocnId == 8) { if (result[n].Bin_H != '') { bins = bins + result[n].Bin_H; } }
            ...
            var ProdRow1 = "<tr onclick=GetPrdtId(" + result[n].ProductId + ",'" + desc + "','" + code + "'," + 3 + ") onfocusout='updaterow(" + id + ")'  id=" + 'row' + id + " class='jsgrid-row'>" +
                      "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                      "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + " </td>" +
                      "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' style='display:none;height:30px' id=" + 'Otherdescription' + id + " value='" + Otherdescription + "'><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + result[n].ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + result[n].ProductCode + "' data-toggle='tooltip' title='" + result[n].ProductCode + "'></td>" +
                      "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + result[n].ProductDescr + "' data-toggle='tooltip' title='" + result[n].ProductDescr + "'></td>" +
                      "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                      "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:4%;'><select id=" + 'select_location' + id + " value=" + result[n].LocnId + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + result[n].ProductId + ",0),Locationqtycheckmain(" + id + ")'  onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                      "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text' name='prdaddqty' class='form-control text-center' id=" + 'txtquantity' + id + " value=" + result[n].ProdQty + " style='background-color:white;height:30px' onkeyup='checkqty(" + id + "),amountcalculation(" + id + ")' onkeydown=Focusnextgrid(event,'q'," + id + ") onkeypress=isNumberInt(event,this) onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + parseInt(result[n].stocktotloseqty) + " style='display:none'></td>" +
                      ...
                      "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + parseFloat(result[n].FcProdDisc).toFixed(Decimal) + "  style='display:none'><input type='text' id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + parseFloat(result[n].ProdDisc).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
                      ...
                      "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value=" + result[n].TaxPercent + " onkeyup='amountcalculation(" + id + ")'></td>" +
                      ...
                      "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + (result[n].AvgCost * result[n].ProdQty) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + parseFloat(result[n].AvgCost).toFixed(Decimal) + " style='background-color:white;height:30px'></td>" +
                      "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px' id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                      "<td style='display:none' id=" + 'Bin' + id + ">" + bins + "</td>" +
                      "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + result[n].JobNumber + " ></td>" + 
                      "</tr>";
...
function deptload()
{
    ...
    $.ajax({
        ...
        data: data,
        success: function (result) {
            $("#DepartmentCode,#SalesDepartment").val(result.oList[0].DepartmentCode);
        }
    });
...
function GetBin(Id, ItemId, type) {
    var data = {};
    data.ItemId = ItemId;
    $.ajax({
        type: "POST",
        ...
        success: function (result) {
            if (type == 1)
                LocId = $('#ItemLocngrid' + Id).val();
            else if (type == 0)
                LocId = $('#select_location' + Id).val();
            else if (type == 2)
                LocId = $('#autoItemLocngrid' + Id).val();

            ItemBinGet(result, type, Id, LocId);
        }
    });
}
...
//Load Stock Qty When Location Change in Multiple Product Selection List for Qty Checking 
function ItemBinGet(result, type, id, LocId) {
    ...
    if (type == 1)    //Multiple ProductList 
        $('#Binm' + id).text(bins);
    else if (type == 0 && id == 0)     //Product Add
        $("#PopUpDetailbin").text(bins);
    else if (type == 0)    //Product Grid
        $('#Bin' + id).text(bins);
    else if (type == 2)      //Front-Rear Product List
        $('#Bina' + id).text(bins);
}
...
{
    var dateObj = new Date(Date.now() - 86400000 * 1);
    var month = parseInt(1 + dateObj.getUTCMonth());
    var day = dateObj.getUTCDate();
    var year = dateObj.getUTCFullYear();
    WeekDate = (day < 10 ? '0' : '') + day + '/' + (month < 10 ? '0' : '') + month + '/' + year;

}

function balload(BankAccount) {
    ...
    $.ajax({
        ...
        success: function (result) {
          ...
          balo = result.oList[0].bal;
            ...
            if (balo < 0) {
                balo = balo * -1;
                $('#CustOutStanding').text('OutStanding Amount : '+balo.toFixed(Decimal) + ' CR');
            }
            else {
                $('#CustOutStanding').text('OutStanding Amount : ' + balo.toFixed(Decimal) + ' DR');
            }
...
function getMaxdate(flg)
{
    if (flg == 1)
    {
        var tt = document.getElementById('DateFrom').value;
        var ab = tt.split('/')
        var NowDate = (ab[1] < 10 ? '0' : '') + ab[1] + '/' + (ab[0] < 10 ? '0' : '') + ab[0] + '/' + ab[2];
        var date = new Date(NowDate);
        var newdate = new Date(date);
        newdate.setDate(newdate.getDate() + DateSelectionDays);
        var dd = newdate.getDate();
        var mm = newdate.getMonth() + 1;
        var y = newdate.getFullYear();
        var someFormattedDate = (dd < 10 ? '0' : '') + dd + '/' + (mm < 10 ? '0' : '') + mm + '/' + y;      
        $("#DateTo").daterangepicker({
            singleDatePicker: true, minDate: tt, maxDate: someFormattedDate, locale: {
                format: 'DD/MM/YYYY'
            }
        });
    }
    ...
    {
        $("#DateTo").daterangepicker({
            singleDatePicker: true, minDate: minDate, maxDate: CurDate, locale: { 
                format: 'DD/MM/YYYY'
            }
        });
    }
...
function getMindate(flg) {
    if (flg == 1)
    {
    var tt = document.getElementById('DateTo').value;
    var ab = tt.split('/')
    var NowDate = (ab[1] < 10 ? '0' : '') + ab[1] + '/' + (ab[0] < 10 ? '0' : '') + ab[0] + '/' + ab[2];
    var date = new Date(NowDate);
    var newdate = new Date(date);
    ...
    $("#DateFrom").daterangepicker({
        singleDatePicker: true, minDate: someFormattedDate, maxDate: tt, locale: {
            format: 'DD/MM/YYYY'
        }
    });
    }
...
$(document).ready(function () {
    ...
    if ((usermenu1.indexOf("M224") != -1)) {
        $("#btnExporttoExcelsave").show(); 
    }
    else{
        $("#btnExporttoExcelsave").hide(); 
    }

    setInterval(function () {
        if ($('#txtcustomer').val()!='')
            document.title = 'SI - ' + $('#txtcustomer').val();
        else if(copyflag==1)
            document.title = 'SI - ' + $('#txtBillSlNocopy').val();
        else  
            document.title = 'SI - ' + $('#txtBillSlNo').val();     
    })
    ...
    $("#confirmOksales").keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 37) {
            $("#confirmCancelsales").focus();
        }
    });

    $("#confirmCancelsales").focus(function (e) {
        $("#confirmCancelsales").removeClass("btn grey btn-outline-secondary");
        $("#confirmCancelsales").addClass("btn grey btn-secondary");
    });

    $("#confirmCancelsales").focusout(function (e) {
        $("#confirmCancelsales").removeClass("btn grey btn-secondary");
        $("#confirmCancelsales").addClass("btn grey btn-outline-secondary");
    });

    $("#confirmCancelsales").keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 39) {
            $("#confirmOksales").focus();
        }
    });

   
    $('#btnsubmitsgo').click(function () {
        var Link = $('#SelectSalesReports').val();
        if (Link == 0) {
            $('#SelectSalesReports').val(0);
        }
        else {
    ...
    if (usermenu1.indexOf("M58") != -1) {
        $('#salesrep').show();
    }
    else {
        $('#salesrep').hide();
    }
     if (usermenu1.indexOf("M208") != -1) {
        $('#detsalesrep').show();
    }
    else {
        $('#detsalesrep').hide();
     }
     if (usermenu1.indexOf("M212") != -1) {
         $('#itemwiserep').show();
     }
     else {
         $('#itemwiserep').hide();
     }
     if (usermenu1.indexOf("M59") != -1) {
         $('#detitemrep').show();
     }
     else {
         $('#detitemrep').hide();
     }
     if (usermenu1.indexOf("M60") != -1) {
         $('#datewisewrep').show();
     }
     else {
         $('#datewisewrep').hide();
     ...
     if (usermenu1.indexOf("M61") != -1) {
         $('#areagrprep').show();
     }
     else {
         $('#areagrprep').hide();
     }
     if (usermenu1.indexOf("M62") != -1) {
         $('#subgrprep').show();
     }
     else {
         $('#subgrprep').hide();
     }
     if (usermenu1.indexOf("M63") != -1) {
         $('#custrep').show();
     }
     else {
         $('#custrep').hide();
     }
     if (usermenu1.indexOf("M64") != -1) {
         $('#salperfrep').show();
     }
     else {
         $('#salperfrep').hide();
     }
     if (usermenu1.indexOf("M65") != -1) {
         $('#areasalerep').show();
     }
     else {
         $('#areasalerep').hide();
     }
     if (usermenu1.indexOf("M66") != -1) {
         $('#areacustrep').show();
     }
     else {
         $('#areacustrep').hide();
     }
     if (usermenu1.indexOf("M68") != -1) {
         $('#invoprojrep').show();
     }
     else {
         $('#invoprojrep').hide();
     }
     if (usermenu1.indexOf("M69") != -1) {
         $('#topcustrep').show();
     }
     else {
         $('#topcustrep').hide();
     }
     if (usermenu1.indexOf("M70") != -1) {
         $('#monthcustrep').show();
     }
     else {
         $('#monthcustrep').hide();
     }
     if (usermenu1.indexOf("M71") != -1) {
         $('#monthitemrep').show();
     }
     else {
         $('#monthitemrep').hide();
     }
     if (usermenu1.indexOf("M202") != -1) {
         $('#cashcollrep').show();
     }
     else {
         $('#cashcollrep').hide();
     }
      if (usermenu1.indexOf("M229") != -1) {
         $('#scannrep').show();
     }
     else {
         $('#scannrep').hide();
     }
      if (usermenu1.indexOf("M67") != -1) {
          $('#salecustrep').show();
     }
     else {
         $('#salecustrep').hide();
    ...
    $("#select_dept").keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 13) {
            e.preventDefault();
            $("#Btlgetlist").focus();           
    ...
    $("#btnExporttoExcelsave").keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 37) {
            $("#btncnclalrt").focus();
        }
    ...
    $('#btnok').click(function () {
        ...
        //    PrintthisBillWindows('SALES', i, 'MAINSPAREPARTS');
        //else if (SalesBillType == 'DEFAULT')
        //    PrintthisBillWindowsNew('SALES', i, 'SPAREPARTSCOPY');
        //else if (SalesBillType == 'SPAREPARTS')
        //    PrintthisBillSalesNew(i,'save'); 
        alertpopuprefresh();
        formrefresh();
        Tbldelete();
    });
    ...
    $("#txtproduct0").keydown(function (e) {
        ...
        if (key == 13 && qtyflag == 1 && (Negativebill == 'NO') && ($("#select_location0").find("option:selected").attr("name") == 0)) {
            qtyflag == 1;
    ...
    $("#txtlgrgname").keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 13) {
            e.preventDefault();
            $('#txtaddress').focus();
    ...
    $("#select_unit0").change(function () {
        ...
        //$('#txtquantity0').focus();
        if ($(this).find("option:selected").attr("name").toLowerCase() == 'foc') {
            foc = 1;
            $('#txtrate0').val(0);
            amountcalculation(0);
        }
    ...
    if (getQueryString('slno') != null) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#btnprint,#btncustomprint,#btncustprnt,#btncustprnt1').prop("disabled", false);
    ...
    if (getQueryString('AccId') != null) {
        ...
        $.ajax({
            ...
            data: data,
            success: function (result) {
                $('#txtcustomer').val(AccDesc);
                $("#txtCustId").val(getQueryString('CustId'));
               
                    var addr = '';
                    if (result.oList[0].CustStreet1 != '') { addr = result.oList[0].CustStreet1; }
                    if (result.oList[0].CustCity1 != '') { if (addr == '') addr = result.oList[0].CustCity1; else addr = addr + ',' + result.oList[0].CustCity1 }
                    if (result.oList[0].CustState1 != '') { if (addr == '') addr = result.oList[0].CustState1; else addr = addr + ',' + result.oList[0].CustState1; }
                    $('#txtaddress').val(addr);

                    $('#txtCustId').val(result.oList[0].CustId);
                    if (result.oList[0].SalesmanId != 0 && result.oList[0].SalesmanId != null)
                        $('#select_salesman').val(result.oList[0].SalesmanId);
                    $('#select_crncy').val(result.oList[0].CurrencyId);
                    $('#txtcrncyrate').val(parseFloat($('#select_crncy').find("option:selected").attr("name") || 0).toFixed(Decimal));
                    $('#select_terms').val(result.oList[0].CustTermsId || 0);
                    $('#adr1').val(result.oList[0].CustStreet1);
                    $('#adr2').val(result.oList[0].CustCity1);
                    $('#adr3').val(result.oList[0].CustState1);
                    $('#Trnno').val(result.oList[0].TRNNumber);
                    $('#txtlpono').val(result.oList[0].TRNNumber);

                    $('#PhoneNo').val(result.oList[0].PhoneNumber);
                    $('#txtcreditlimit').val(result.oList[0].CreditLimit);
                    if (result.oList[0].AreaId > 0)
                        $('#select_place').val(result.oList[0].AreaId);

                    $('#PriceGroupId').val(result.oList[0].PriceGroupId || 0);
                    getdate();
        ...
        for (m = 1; m <= row; m++) {
            ...
            if (flg == 0) {
                ...
                if ($("#SlNoCheckItem" + m).is(":checked")) {
                    ...
                    var bin = $('#binenq' + m).val();
                    var enqno = $('#enqnoRow' + m).text();
                    if (Location != 0 || Location != '')
                        $('#select_location0').val(Location);
                    else
                        $('#select_location0').val(UserLocationId);
                    $('#EnquiryNo').val(enqno)
                    var rowcount = CountRows();
                    ...
                    var ProdRow1 = "<tr onclick=GetproddetailsGrid(" + id + "),GetPrdtId(" + ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'enqno' + id + " style='display:none' value='" + enqno + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "' data-toggle='tooltip' title='" + Productcode + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input disabled='' class='form-control text-left' type='text' style='height:30px;background-color:white' id=" + 'ProductDesc' + id + " value='" + ProductDescr + "' data-toggle='tooltip' title='" + ProductDescr + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:4%;'><select  id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + fcdiscount + "  style='display:none'><input type='text' id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + discount + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value=" + taxrate + " onkeyup='amountcalculation(" + id + ")'></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px' id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)'  onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                        "<td style='display:none' id=" + 'Bin' + id + ">" + bin + "</td>" +
                        "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost2_'+m).val() + " ></td>" + 
                        "</tr>";
                    $('#tblsalesinvoice').append(ProdRow1);
        ...
        for (m = 1; m <= row; m++) {
            ...
            if (flg == 0) {
                ...
                if ($("#SlNoCheckQtnItem" + m).is(":checked")) {
                    ...
                    var bin = $('#binqtn' + m).val(); 

                    $('#QuotationNo').val(qtnno);
                    if (Location1 != 0 || Location1 != '')
                        $('#select_location0').val(Location1);
                    else
                        $('#select_location0').val(UserLocationId);
                    var rowcount = CountRows();
                    if (rowcount == 0) {
                    ...
                    var ProdRow1 = "<tr onclick=GetPrdtId(" + ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'qutnnum' + id + " style='display:none' value='" + qtnno + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "' data-toggle='tooltip' title='" + Productcode + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input disabled='' class='form-control text-left' type='text' style='height:30px;background-color:white' id=" + 'ProductDesc' + id + " value='" + ProductDescr + "' data-toggle='tooltip' title='" + ProductDescr + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:4%'><select id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text' class='form-control text-center' id=" + 'txtquantity' + id + " value=" + qty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + (avgcst * qty) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + avgcst + " style='background-color:white;height:30px'></td>" +
                        "<td style='display:none' id=" + 'Bin' + id + ">" + bin + "</td>" +
                        "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost3_'+m).val() + " ></td>" + 
                        "</tr>";
    ...
    $("#btnview2").click(function (e) {
        ...
        if (fl == 0) {
            ...
            for (var n = 1; n <= row; n++) {
                if ($("#SlNoHdCheckCustso" + n).is(":checked")) {
                    CurncyId = $('#CurncyId' + n).text();
                    break;
                }
            }
            for (var m = 1; m <= row; m++) {
                if ($("#SlNoHdCheckCustso" + m).is(":checked")) {
                    if (($('#CurncyId' + m).text() != CurncyId)) {
            ...
            if (flg == 0) {
                ...
                if ($("#SlNoCheckSoItem" + m).is(":checked")) {
                    ...
                    var ProdRow1 = "<tr onclick=GetPrdtId(" + ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'slordsubid' + id + " style='display:none' value='" + ordersubid + "' /><input type='text' id=" + 'slordeno' + id + " style='display:none' value='" + orderno + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "' data-toggle='tooltip' title='" + Productcode + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input disabled='' class='form-control text-left' type='text' style='height:30px;background-color:white' id=" + 'ProductDesc' + id + " value='" + ProductDescr + "' data-toggle='tooltip' title='" + ProductDescr + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:4%;'><select id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control'  onchange ='GetBin(" + id + "," + ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text' class='form-control text-center' id=" + 'txtquantity' + id + " value=" + qty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px'  id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)'  onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + (avgcst * qty) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + avgcst + " style='background-color:white;height:30px'></td>" +
                        "<td style='display:none' id=" + 'Bin' + id + ">" + binsor + "</td>" +
                        "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost4_'+m).val() + " ></td>" + 
                        "</tr>";
    ...
    $("#btnview3").click(function (e) {
        ...
        var Billsr = 0;
        var CurncyId = '';
        var row = $('#tblSalesInvcust tr').length;
        var fl = 0;
        var SBlsrs = '';
            ...
            if (flg == 0) {
                ...
                if ($("#SlNoCheckSIItem" + m).is(":checked")) {
                    ...
                    var ProdRow1 = "<tr onclick=GetPrdtId(" + ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'bilsers' + id + " style='display:none' value='" + srsno + "' /><input type='text' id=" + 'bilnum' + id + " style='display:none' value='" + srlno + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "' data-toggle='tooltip' title='" + Productcode + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input disabled='' class='form-control text-left' type='text' style='height:30px;background-color:white' id=" + 'ProductDesc' + id + " value='" + ProductDescr + "' data-toggle='tooltip' title='" + ProductDescr + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:4%'><select id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text'  class='form-control text-center' id=" + 'txtquantity' + id + " value=" + qty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + (avgcst * qty) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + avgcst + " style='background-color:white;height:30px'></td>" +
                         "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px' id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                        "<td style='display:none' id=" + 'Bin' + id + ">" + binsin + "</td>" +
                        "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost5_'+m).val() + " ></td>" + 
                       "</tr>";
    ...
    $("#btnview4").click(function (e) {
        ...
        if (fl == 0) {
            ...
            for (var n = 1; n <= row; n++) {
                if ($("#SlNoHdCheckCustdo" + n).is(":checked")) {
                    CurncyId = $('#CurncyId' + n).text();
                    break;
                }
            }
            ...
            for (var m = 1; m <= row; m++) {
                if ($("#SlNoHdCheckCustdo" + m).is(":checked")) {
                    if ($('#CurncyId' + m).text() != CurncyId) {
                        warningshow('Please Select Sales Order with Same Curency!');
                        return false;
                    }
    ...
    $("#btnview5").click(function (e) {

        var row = $('#RowGet15').val();
        var fg = 0;
        var Price = 0;
        $("#tblsalesinvoice tr").remove();
        TaxClear();
        ...
        for (m = 1; m <= row; m++) {
            var checkboxes = document.getElementsByName('CheckAgr');
            for (var k = 0, j = checkboxes.length; k < j; k++) {
                if (checkboxes[k].checked == true) {
                    fg++;
                }
            ...
            if (fg == 0) {
                warningshow('Select One Agreement');
            }
            else {
                $('#Warningpopup').fadeOut();
                $("#typecredit").prop('checked', true)
                ...
                if ($("#SlNoCheckAgreement" + m).is(":checked")) {
                    $('#txtcustomer').val($('#Customer' + m).text());
                    $('#txtCustId').val($('#CId' + m).val());
                    $('#txtaddress').val($('#Address' + m).val());
                    $('#PhoneNo').val($('#Phone' + m).val());
                    $('#Email').val($('#EmailId' + m).val());
                    var ProductId = $('#VechicleId' + m).val();
                    var Productcode = $('#VechicleNo' + m).text();
                    var ProductDescr = $('#VechicleDesc' + m).text();
                    var qty = parseInt($('#Daysdiff' + m).val() || 0);
                    var rate = 0;

                    if ($('#Daysdiff' + m).val() <= 7) {
                        //Price = Price + $('#DLPrice' + m).val();
                        rate = parseFloat($('#DLPrice' + m).val() || 0).toFixed(Decimal);
                    }
                    else if ($('#Daysdiff' + m).val() >= 7 && $('#Daysdiff' + m).val() <= 14) {
                        rate = parseFloat($('#WLPrice' + m).val() || 0).toFixed(Decimal);
                    }
                    else if ($('#Daysdiff' + m).val() >= 15 && $('#Daysdiff' + m).val() <= 30) {
                        rate = parseFloat($('#MLPrice' + m).val() || 0).toFixed(Decimal);
                    }
                    else if ($('#Daysdiff' + m).val() >= 31) {
                        rate = parseFloat($('#ALPrice' + m).val() || 0).toFixed(Decimal);
                    }
                   ...
                   //var taxid = $('#taxid' + m).val();
                    var taxrate = $('#taxrate' + m).val();
                    var taxableamt = parseFloat(Price || 0).toFixed(Decimal);
                    var taxamt = parseFloat($('#taxamt_' + m).val() || 0).toFixed(Decimal);
                    var total = parseFloat($('#total_' + m).val() || 0).toFixed(Decimal);
                    var fcrate = parseFloat($('#fcrte_' + m).val() || 0).toFixed(Decimal);
                    var fcdiscount = parseFloat($('#fcdis_' + m).val() || 0).toFixed(Decimal);
                    var fctaxableamt = parseFloat(Price || 0).toFixed(Decimal);
                    var fctaxamt = parseFloat(0).toFixed(Decimal);
                    var fctotal = parseFloat($('#fctotal_' + m).val() || 0).toFixed(Decimal);
                    var AgreementNo = $('#AgreementNo' + m).text();
                    var ordersubid = $('#delvordsubid' + m).text();
                    var Locnid = $('#LocnId' + m).val();
                    var bindel = $('#bindelv' + m).val();
                    ...
                    var ProdRow1 = "<tr onclick=GetPrdtId(" + ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'delvsubid' + id + " style='display:none' value='" + ordersubid + "' /><input type='text' id=" + 'delvno' + id + " style='display:none' value='" + AgreementNo + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "' data-toggle='tooltip' title='" + Productcode + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input disabled='' class='form-control text-left' type='text' style='height:30px;background-color:white' id=" + 'ProductDesc' + id + " value='" + ProductDescr + "' data-toggle='tooltip' title='" + ProductDescr + "'></td>" +

                        "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text'  class='form-control text-center' id=" + 'txtquantity' + id + " value=" + qty + " style='background-color:white;height:30px' onkeyup='RentCalculationGrid(" + id + "),amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%'> <input type='text' id=" + 'txtfcrate' + id + " value=" + fcrate + "  style='display:none'><input type='text'  class='form-control text-center' id=" + 'txtrate' + id + " value=" + rate + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'r'," + id + ") onfocusout=focusoutgrid('r'," + id + ") onfocusin=focusingrid('r'," + id + ")></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + fcdiscount + "  style='display:none'><input type='text'  id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + discount + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxableamnt' + id + " value=" + parseFloat(fctaxableamt||0) + "  style='display:none'><input type='text' disabled='' class='form-control text-center' style='background-color:white;height:30px' id=" + 'txttaxableamnt' + id + " value=" + parseFloat(taxableamt || 0).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")'></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + "  onkeyup='amountcalculation(" + id + ")'></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxamnt' + id + " value=" + parseFloat(fctaxamt||0) + "  style='display:none'><input typ='text' style='background-color:white;height:30px' class='form-control text-center'  id=" + 'txttaxamnt' + id + " value=" + parseFloat(taxamt || 0).toFixed(Decimal) + " disabled=''></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfcamnt' + id + " value=" + parseFloat(fctotal||0) + "  style='display:none'><input typ='text' class='form-control text-center' style='background-color:white;height:30px' disabled='' id=" + 'txtamnt' + id + " value=" + parseFloat(total || 0).toFixed(Decimal) + "></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + (avgcst * qty) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + avgcst + " style='background-color:white;height:30px'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px'  id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                        "<td style='display:none' id=" + 'Bin' + id + ">" + bindel + "</td>" +
                         "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost6_' + m).val() + " ><input style='display:none' id=" + 'DPriceNew' + id + " value=" + $('#DLPrice' + m).val() + "><input style='display:none' id=" + 'WPriceNew' + id + " value=" + $('#WLPrice' + m).val() + "><input style='display:none' id=" + 'MPriceNew' + id + " value=" + $('#MLPrice' + m).val() + "><input style='display:none' id=" + 'APriceNew' + id + " value=" + $('#ALPrice' + m).val() + "></td>" +
                        "</tr>";

                    $('#tblsalesinvoice').append(ProdRow1);
                    $('#txttaxpercent' + id).val($('#select_tax' + id+' :selected').attr('name'));
            ...
            if (flg == 0) {
                ...
                if ($("#SlNoCheckSoItem" + m).is(":checked")) {
                    ...
                    var ProdRow1 = "<tr onclick=GetPrdtId(" + ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'delvsubid' + id + " style='display:none' value='" + ordersubid + "' /><input type='text' id=" + 'delvno' + id + " style='display:none' value='" + orderno + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "' data-toggle='tooltip' title='" + Productcode + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input disabled='' class='form-control text-left' type='text' style='height:30px;background-color:white' id=" + 'ProductDesc' + id + " value='" + ProductDescr + "' data-toggle='tooltip' title='" + ProductDescr + "'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:4%;'><select  id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text'  class='form-control text-center' id=" + 'txtquantity' + id + " value=" + qty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxableamnt' + id + " value=" + fctaxableamt + "  style='display:none'><input type='text' disabled='' class='form-control text-center' style='background-color:white;height:30px' id=" + 'txttaxableamnt' + id + " value=" + parseFloat(taxableamt||0).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")'></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value=" + taxrate + " onkeyup='amountcalculation(" + id + ")'></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxamnt' + id + " value=" + fctaxamt + "  style='display:none'><input typ='text' style='background-color:white;height:30px' class='form-control text-center'  id=" + 'txttaxamnt' + id + " value=" + parseFloat(taxamt || 0).toFixed(Decimal) + " disabled=''></td>" +
                        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfcamnt' + id + " value=" + fctotal + "  style='display:none'><input typ='text' class='form-control text-center' style='background-color:white;height:30px' disabled='' id=" + 'txtamnt' + id + " value=" + parseFloat(total || 0).toFixed(Decimal) + "></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + (avgcst * qty) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + avgcst + " style='background-color:white;height:30px'></td>" +
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px'  id=" + 'select_tax' +id + " class='form-control' onchange='ChangeTax(" +id + ",this)' onkeydown=Focusnextgrid(event,'t'," +id + ") onfocusout=focusoutgrid('t'," +id + ") onfocusin=focusingrid('t'," +id + ")>" +TaxSelect + "</select></td>" +                       
                        "<td style='display:none' id=" + 'Bin' + id + ">" + bindel + "</td>" +
                         "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost6_' + m).val() + " ></td>" +
                        "</tr>";
...
function Transfer() {
    ...
    else if ($('#select_transfer').val() == 6)       //Agreement
    {
        Enquirypopupwindow(6);
    }
}
...
function Enquirypopupwindow(id) {
    ...
    else if (id == 6)                                                      //List Agreement Details in pop up
    {
        if ($('#txtCustId').val() == 0)              //If CustId==0 Get all DeliveryOrder Details
        {
            $("#Enquirypopup").css("margin-top", '-50px');
            $('#Enquirypopup').show();
            $('#Enquiryheader').text('Agreement Details');
            $('#SalesOrderdiv').hide();
            $('#Qtndiv').hide();
            $('#Qtndivcust').hide();
            $('#Qtndivsub').hide();
            ...
            var data = {};
            data.FromDate = CurDate;
            data.EndDate = CurDate;
            data.CustomerId = $('#txtCustId').val();
            $.ajax({
                type: "POST",
                url: "../CarAgreement/CarAgreementView",
                data: data,
                success: function (result) {
                    $('#tblAgreement tr').remove();
                    AgreementLoad(result.oList);
                }
            });
        }
        else                                         //If CustId!=0 Get DeliveryOrder Details against That Customer                     
...
function CloseEnquiry() {
    ...
    $('#Customer').val('')
    $('#CustomerId').val(0);
    $('#FromDateAgreement').val(CurDate);
    $('#ToDateAgreement').val(CurDate);
...
function CustomerEnquiryGets(result) {
    ...
    for (var n = 0; n < result.length; n++) {
        ...
        if (result[n].Location == 1) { if (result[n].Bin_A != '') { bins = bins + result[n].Bin_A; } }
        else if (result[n].Location == 2) { if (result[n].Bin_B != '') { bins = bins + result[n].Bin_B; } }
        else if (result[n].Location == 3) { if (result[n].Bin_C != '') { bins = bins + result[n].Bin_C; } }
        else if (result[n].Location == 4) { if (result[n].Bin_D != '') { bins = bins + result[n].Bin_D; } }
        else if (result[n].Location == 5) { if (result[n].Bin_E != '') { bins = bins + result[n].Bin_E; } }
        else if (result[n].Location == 6) { if (result[n].Bin_F != '') { bins = bins + result[n].Bin_F; } }
        else if (result[n].Location == 7) { if (result[n].Bin_G != '') { bins = bins + result[n].Bin_G; } }
        else if (result[n].Locations == 8) { if (result[n].Bin_H != '') { bins = bins + result[n].Bin_H; } }
        ...
        var ProdRow1 = "<tr onclick=GetPrdtId(" + result[n].ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                  "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center'  id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                  "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + id + "</td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'enqno' + id + " style='display:none' value='" + result[n].EnquiryNo + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + result[n].ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + result[n].ProductCode + "' data-toggle='tooltip' title='" + result[n].ProductCode + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + result[n].ProductDescr + "' data-toggle='tooltip' title='" + result[n].ProductDescr + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:4%'><select  id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + result[n].ProductId + ",0)'  onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                  ...
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxamnt' + id + " value=" + parseFloat(result[n].FCTaxAmount).toFixed(Decimal) + "  style='display:none'><input typ='text' style='background-color:white;height:30px' class='form-control text-center'  id=" + 'txttaxamnt' + id + " value=" + parseFloat(result[n].TaxAmount).toFixed(Decimal) + " disabled=''></td>" +
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfcamnt' + id + " value=" + parseFloat(result[n].FCAmount).toFixed(Decimal) + "  style='display:none'><input typ='text' class='form-control text-center' style='background-color:white;height:30px' disabled='' id=" + 'txtamnt' + id + " value=" + parseFloat(result[n].Amount).toFixed(Decimal) + "></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + parseFloat(result[n].AvgCost * result[n].ProdQty).toFixed(Decimal) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + parseFloat(result[n].AvgCost).toFixed(Decimal) + " style='background-color:white;height:30px'></td>" +
                   "<td class='jsgrid-cell jsgrid-align-center' style='width:3%'><select style='background-color:white;height:30px'  id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                  "<td style='display:none' id=" + 'Bin' + id + ">" + bins + "</td>" +
                  "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + result[n].BelowCostFlag + " ></td>" +
                  "</tr>";
        $('#tblsalesinvoice').append(ProdRow1);
        $('#select_unit' + id).val(result[n].UnitId);
        $('#select_tax' + id).val(result[n].TaxId);
...
function ShowItemGet(result) {
    ...
    for (var l = 0; l < result.length; l++) {
        ...
        if (Location == 1) { if (result[l].Bin_A != '') { bins = bins + result[l].Bin_A; } }
        else if (Location == 2) { if (result[l].Bin_B != '') { bins = bins + result[l].Bin_B; } }
        else if (Location == 3) { if (result[l].Bin_C != '') { bins = bins + result[l].Bin_C; } }
        else if (Location == 4) { if (result[l].Bin_D != '') { bins = bins + result[l].Bin_D; } }
        else if (Location == 5) { if (result[l].Bin_E != '') { bins = bins + result[l].Bin_E; } }
        else if (Location == 6) { if (result[l].Bin_F != '') { bins = bins + result[l].Bin_F; } }
        else if (Location == 7) { if (result[l].Bin_G != '') { bins = bins + result[l].Bin_G; } }
        else if (Location == 8) { if (result[l].Bin_H != '') { bins = bins + result[l].Bin_H; } }
       ...
       '<td id=' + 'enqnoRow' + slno + '>' + result[l].EnquiryNo + '<input type="hidden" id="enqno"' + slno + '" value=' + result[l].EnquiryNo + '></td>' +
        ...
        '<td id=' + 'total' + slno + '>' + parseFloat(result[l].Amount).toFixed(Decimal) + '<input type="hidden" id="total_' + slno + '" value=' + result[l].Amount + '><input type="hidden" id="fctotal_' + slno + '" value=' + result[l].FCAmount + '><input type="hidden" id="binenq' + slno + '" value=' + bins + '><input type="hidden" id="BCost2_' + slno + '" value=' + result[l].AreaId + '></td></tr>'; 
    }
...
function QuotationCustLoad(result) {
    disable_datatable('tblQtncust');
    var responseText = "<thead><tr><th style='width:90px;'><input type='checkbox' style='zoom:1.5;' checked id= 'SlNoHdCheckCust0' 'custom-control-input cz-bg-image-display' onchange='selectallcust5()'>&nbsp;&nbsp;&nbsp;Select</th><th>Quotation No</th><th>Customer</th><th>Phone No</th><th>Invoice Date</th><th>TRN Number</th><th>Salesman</th><th>Area</th><th>Currency</th><th style=display:none></th><th style=display:none></th><th></th></tr>" +
        "<tr><th  style='width:90px;'>Select</th><th>Quotation No</th><th>Customer</th><th>Phone No</th><th>Invoice Date</th><th>TRN Number</th><th>Salesman</th><th>Area</th><th>Currency</th><th style=display:none></th><th style=display:none></th><th>Details</th></tr></thead><tbody>";
    for (var l = 0; l < result.length; l++) {
        var slno = parseInt(l + 1);
        responseText += '<tr id=' + "row" + slno + '>' +
...
function ShowItemGetQtn(result) {
    ...
    for (var l = 0; l < result.length; l++) {
        ...
        if (Location1 == 1) { if (result[l].Bin_A != '') { bins = bins + result[l].Bin_A; } }
        else if (Location1 == 2) { if (result[l].Bin_B != '') { bins = bins + result[l].Bin_B; } }
        else if (Location1 == 3) { if (result[l].Bin_C != '') { bins = bins + result[l].Bin_C; } }
        else if (Location1 == 4) { if (result[l].Bin_D != '') { bins = bins + result[l].Bin_D; } }
        else if (Location1 == 5) { if (result[l].Bin_E != '') { bins = bins + result[l].Bin_E; } }
        else if (Location1 == 6) { if (result[l].Bin_F != '') { bins = bins + result[l].Bin_F; } }
        else if (Location1 == 7) { if (result[l].Bin_G != '') { bins = bins + result[l].Bin_G; } }
        else if (Location1 == 8) { if (result[l].Bin_H != '') { bins = bins + result[l].Bin_H; } }
       ...
       '<td id=' + 'qtnnoRow' + slno + '>' + result[l].QuotationNo + '<input type="hidden" id="enqno"' + slno + '" value=' + result[l].QuotationNo + '></td>' +
        ...
        '<td style=display:none;><input type="text" style="display:none;" id= ' + 'taxableamt' + slno + ' value= ' + result[l].TaxableAmount + '><input type="text" style="display:none;" id= ' + 'fctaxableamt' + slno + ' value= ' + result[l].FCTaxableAmount + '></td>' +
        '<td id=' + 'taxamt' + slno + '>' + parseFloat(result[l].TaxAmount).toFixed(Decimal) + '</td><input type="hidden" id="taxamt_' + slno + '" value=' + result[l].TaxAmount + '><input type="hidden" id="fctaxamt_' + slno + '" value=' + result[l].FCTaxAmount + '>' +
        '<td id=' + 'total' + slno + '>' + parseFloat(result[l].Amount).toFixed(Decimal) + '<input type="hidden" id="total_' + slno + '" value=' + result[l].Amount + '><input type="hidden" id="fctotal_' + slno + '" value=' + result[l].FCAmount + '><input type="hidden" id="binqtn' + slno + '" value=' + bins + '><input type="hidden" id="BCost3_' + slno + '" value=' + result[l].AreaId + '></td></tr>';
    }
...
function QtnEntryGets(result) {
    ...
    for (var n = 0; n < result.length; n++) {
        ...
        else if (result[n].Location == 8) { if (result[n].Bin_H != '') { bins = bins + result[n].Bin_H; } }
        ...
        var ProdRow1 = "<tr onclick=GetPrdtId(" + result[n].ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                  "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                  "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'qutnnum' + id + " style='display:none' value='" + result[n].QuotationNo + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + result[n].ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + result[n].ProductCode + "' data-toggle='tooltip' title='" + result[n].ProductCode + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + result[n].ProductDescr + "' data-toggle='tooltip' title='" + result[n].ProductDescr + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:4%'><select  id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control'  onchange ='GetBin(" + id + "," + result[n].ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text'  class='form-control text-center' id=" + 'txtquantity' + id + " value=" + result[n].ProdQty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + parseInt($('#txtstocktotloseqty0').val()) + " style='display:none'></td>" +
...
function SalesOrderLoad(result) {
    ...
    for (var l = 0; l < result.length; l++) {
        var slno = parseInt(l + 1);
        responseText += '<tr id=' + "row" + slno + '>' +
            '<td ><input type="checkbox" style="zoom:1.5;" name="CheckRevision" id= ' + 'SlNoCheckRevisionso' + slno + ' ></td>' +
...
function SalesOrderCustLoad(result) {
    disable_datatable('tblSalesOrdercust');
    var responseText = "<thead><tr><th><input type='checkbox' style='zoom:1.5;' checked id= 'SlNoHdCheckCustso0' 'custom-control-input cz-bg-image-display' onchange='selectallcust4()'>&nbsp;&nbsp;&nbsp;Select</th><th>Order No</th><th>Customer</th><th>Address</th><th>Date</th><th>Salesman</th><th>Area</th><th>Currency</th><th style='display:none'></th></tr>" +
    ...
    for (var l = 0; l < result.length; l++) {
        var slno = parseInt(l + 1);
        responseText += '<tr id=' + "row" + slno + '>' +
            '<td ><input type="checkbox" style="zoom:1.5;" checked name="Checkcust" id= ' + 'SlNoHdCheckCustso' + slno + ' ></td>' +
...
function selectallcust4() {
    ...
    for (var h = 1; h <= rowCount + 1; h++) {
        if (document.getElementById("SlNoHdCheckCustso" + h) != null) {
            document.getElementById("SlNoHdCheckCustso" + h).checked = flag;
        }
    }
}
...
function EditSalesOrder() {
    ...
    if (flg != 1) {
        ...
        $('#Warningpopup').fadeOut();
        for (m = 1; m <= row; m++) {
            if ($("#SlNoCheckRevisionso" + m).is(":checked")) {
                var data = {};
...
function SalesOrderGets(result) {
    ...
    for (var n = 0; n < result.length; n++) {
        ...
        if (result[n].LocId == 1) { if (result[n].Bin_A != '') { bins = bins + result[n].Bin_A; } }
        else if (result[n].LocId == 2) { if (result[n].Bin_B != '') { bins = bins + result[n].Bin_B; } }
        else if (result[n].LocId == 3) { if (result[n].Bin_C != '') { bins = bins + result[n].Bin_C; } }
        else if (result[n].LocId == 4) { if (result[n].Bin_D != '') { bins = bins + result[n].Bin_D; } }
        else if (result[n].LocId == 5) { if (result[n].Bin_E != '') { bins = bins + result[n].Bin_E; } }
        else if (result[n].LocId == 6) { if (result[n].Bin_F != '') { bins = bins + result[n].Bin_F; } }
        else if (result[n].LocId == 7) { if (result[n].Bin_G != '') { bins = bins + result[n].Bin_G; } }
        else if (result[n].LocId == 8) { if (result[n].Bin_H != '') { bins = bins + result[n].Bin_H; } }
        ...
        var ProdRow1 = "<tr onclick=GetPrdtId(" + result[n].ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                  "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                  "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'slordsubid' + id + " style='display:none' value='" + result[n].SalesOrderSubId + "' /><input type='text' id=" + 'slordeno' + id + " style='display:none' value='" + result[n].OrderNo + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + result[n].ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + result[n].ProductCode + "' data-toggle='tooltip' title='" + result[n].ProductCode + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + result[n].ProductDescr + "' data-toggle='tooltip' title='" + result[n].ProductDescr + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'   onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:4%'><select id=" + 'select_location' + id + " value=" + result[n].LocnId + " style='background-color:white;height:30px'  class='form-control' onchange='GetBin(" + id + "," + result[n].ProductId + ",0)'  onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text'  class='form-control text-center' id=" + 'txtquantity' + id + " value=" + result[n].ProdQty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + parseInt($('#txtstocktotloseqty0').val()) + " style='display:none'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:3%'> <input type='text' id=" + 'txtfcrate' + id + " value=" + parseFloat(result[n].FcProdRate).toFixed(Decimal) + "  style='display:none'><input type='text'  class='form-control text-center' id=" + 'txtrate' + id + " value=" + parseFloat(result[n].ProdRate).toFixed(Decimal) + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'r'," + id + ") onfocusout=focusoutgrid('r'," + id + ") onfocusin=focusingrid('r'," + id + ")></td>" +
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + parseFloat(result[n].FcProdDisc).toFixed(Decimal) + "  style='display:none'><input type='text'  id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + parseFloat(result[n].ProdDisc).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxableamnt' + id + " value=" + parseFloat(result[n].FCTaxableAmount).toFixed(Decimal) + "  style='display:none'><input type='text' disabled='' class='form-control text-center' style='background-color:white;height:30px' id=" + 'txttaxableamnt' + id + " value=" + parseFloat(result[n].TaxableAmount).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")'></td>" +
...
function ShowItemGetSalesOrder(result) {
    ...
    for (var l = 0; l < result.length; l++) {
        ...
        if (result[l].LocnId == 1) { if (result[l].Bin_A != '') { bins = bins + result[l].Bin_A; } }
        else if (result[l].LocnId == 2) { if (result[l].Bin_B != '') { bins = bins + result[l].Bin_B; } }
        else if (result[l].LocnId == 3) { if (result[l].Bin_C != '') { bins = bins + result[l].Bin_C; } }
        else if (result[l].LocnId == 4) { if (result[l].Bin_D != '') { bins = bins + result[l].Bin_D; } }
        else if (result[l].LocnId == 5) { if (result[l].Bin_E != '') { bins = bins + result[l].Bin_E; } }
        else if (result[l].LocnId == 6) { if (result[l].Bin_F != '') { bins = bins + result[l].Bin_F; } }
        else if (result[l].LocnId == 7) { if (result[l].Bin_G != '') { bins = bins + result[l].Bin_G; } }
        else if (result[l].LocnId == 8) { if (result[l].Bin_H != '') { bins = bins + result[l].Bin_H; } }
       ...
       '<td id=' + 'qtnnoRow' + slno + '>' + result[l].OrderNo + '<input type="hidden" id="enqno"' + slno + '" value=' + result[l].OrderNo + '></td>' +
        ...
        '<td style=display:none;><input type="text" style="display:none;" id= ' + 'taxableamt' + slno + ' value= ' + result[l].TaxableAmount + '><input type="text" style="display:none;" id= ' + 'fctaxableamt' + slno + ' value= ' + result[l].FCTaxableAmount + '></td>' +
        '<td id=' + 'taxamt' + slno + '>' + parseFloat(result[l].TaxAmount).toFixed(Decimal) + '</td><input type="hidden" id="taxamt_' + slno + '" value=' + result[l].TaxAmount + '><input type="hidden" id="fctaxamt_' + slno + '" value=' + result[l].FCTaxAmount + '>' +
        '<td id=' + 'total' + slno + '>' + parseFloat(result[l].Amount).toFixed(Decimal) + '<input type="hidden" id="total_' + slno + '" value=' + result[l].Amount + '><input type="hidden" id="fctotal_' + slno + '" value=' + result[l].FCAmount + '><input type="hidden" id="binsor' + slno + '" value=' + bins + '><input type="hidden" id="BCost4_' + slno + '" value=' + result[l].AreaId + '></td></tr>';
    }
...
function SalesInvGets(result) {
    ...
    for (var n = 0; n < result.length; n++) {
        ...
        var ProdRow1 = "<tr onclick=GetPrdtId(" + result[n].ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                  "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                  "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + result[n].ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + result[n].ProductCode + "' data-toggle='tooltip' title='" + result[n].ProductCode + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + result[n].ProductDescr + "' data-toggle='tooltip' title='" + result[n].ProductDescr + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:4%'><select id=" + 'select_location' + id + " value=" + result[n].LocnId + "  style='background-color:white;height:30px'  class='form-control' onchange ='GetBin(" + id + "," + result[n].ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text'  class='form-control text-center' id=" + 'txtquantity' + id + " value=" + result[n].ProdQty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + parseInt($('#txtstocktotloseqty0').val()) + " style='display:none'></td>" +
...
function ShowItemGetSalesInvoice(result) {
    ...
    for (var l = 0; l < result.length; l++) {
       ...
       '<td id=' + 'billnoRow' + slno + '>' + result[l].BillSlNo + '<input type="hidden" id=' + 'billnumber' + slno + ' value=' + result[l].BillSlNo + '></td>' +
        ...
        '<td style=display:none;><input type="text" style="display:none;" id= ' + 'taxableamt' + slno + ' value= ' + result[l].TaxableAmount + '><input type="text" style="display:none;" id= ' + 'fctaxableamt' + slno + ' value= ' + result[l].FCTaxableAmount + '></td>' +
        '<td id=' + 'taxamt' + slno + '>' + parseFloat(result[l].TaxAmount).toFixed(Decimal) + '</td><input type="hidden" id="taxamt_' + slno + '" value=' + result[l].TaxAmount + '><input type="hidden" id="fctaxamt_' + slno + '" value=' + result[l].FCTaxAmount + '>' +
        '<td id=' + 'total' + slno + '>' + parseFloat(result[l].Amount).toFixed(Decimal) + '<input type="hidden" id="total_' + slno + '" value=' + result[l].Amount + '><input type="hidden" id="fctotal_' + slno + '" value=' + result[l].FCAmount + '><input type="hidden" id="BCost5_' + slno + '" value=' + result[l].AreaId + '></td></tr>';
    }
...
function DeliveryOrderGets(result) {
    ...
    for (var n = 0; n < result.length; n++) {
        ...
        var ProdRow1 = "<tr onclick=GetPrdtId(" + result[n].ProductId + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                  "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                  "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'delvsubid' + id + " style='display:none' value='" + result[n].DeliveryOrderSubId + "' /><input type='text' id=" + 'delvno' + id + " style='display:none' value='" + result[n].DeliveryOrderNo + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + result[n].ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + result[n].ProductCode + "' data-toggle='tooltip' title='" + result[n].ProductCode + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + result[n].ProductDescr + "' data-toggle='tooltip' title='" + result[n].ProductDescr + "'></td>" +
                  "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                  "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:4%'><select id=" + 'select_location' + id + " value=" + result[n].LocnId + " style='background-color:white;height:30px' class='form-control' onchange ='GetBin(" + id + "," + result[n].ProductId + ",0)' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                 "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text' class='form-control text-center' id=" + 'txtquantity' + id + " value=" + result[n].ProdQty + " style='background-color:white;height:30px' onkeyup='amountcalculation(" + id + ")' onkeypress=isNumberInt(event,this) onkeydown=Focusnextgrid(event,'q'," + id + ") onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + parseInt($('#txtstocktotloseqty0').val()) + " style='display:none'></td>" +
...
function ShowItemGetDeliveryOrder(result) {
    ...
    for (var l = 0; l < result.length; l++) {
       ...
       '<td id=' + 'delvordsubid' + slno + ' style=display:none;>' + result[l].DeliveryOrderSubId + '</td>' +
        ...
        '<td style=display:none;><input type="text" style="display:none;" id= ' + 'taxableamt' + slno + ' value= ' + result[l].TaxableAmount + '><input type="text" style="display:none;" id= ' + 'fctaxableamt' + slno + ' value= ' + result[l].FCTaxableAmount + '></td>' +
        '<td id=' + 'taxamt' + slno + '>' + parseFloat(result[l].TaxAmount).toFixed(Decimal) + '</td><input type="hidden" id="taxamt_' + slno + '" value=' + result[l].TaxAmount + '><input type="hidden" id="fctaxamt_' + slno + '" value=' + result[l].FCTaxAmount + '>' +
        '<td id=' + 'total' + slno + '>' + parseFloat(result[l].Amount).toFixed(Decimal) + '<input type="hidden" id="total_' + slno + '" value=' + result[l].Amount + '><input type="hidden" id="fctotal_' + slno + '" value=' + result[l].FCAmount + '><input type="hidden" id="bindelv' + slno + '" value=' + bins + '><input type="hidden" id="BCost6_' + slno + '" value=' + result[l].AreaId + '></td></tr>'; 
    }
...
function ShowItemGetAgreement(result) {
    $('#AgreementDiv').hide();
    $('#DeliveryOrderdivsub').show();
    disable_datatable('tblDeliveryOrdersub');
    var responseText = "<thead><tr><th style='width:90px;'> <input type='checkbox' style='zoom:1.5;' checked id= 'SlNoCheckSoItem0' 'custom-control-input cz-bg-image-display' onchange='selectallprdtdo()'>&nbsp;&nbsp;&nbsp;Select</th><th>DO No</th><th style='display:none'></th><th style='display:none'></th><th>Product Code</th><th>Description</th><th>Unit</th><th>Quantity</th><th>Rate</th><th style='display:none'></th><th style='display:none'></th><th style='display:none'></th><th style='display:none'></th><th style='display:none'></th><th>Tax Amount</th><th>Amount</th></tr>" +
...
function DeliveryOrderCustLoad(result) {
    disable_datatable('tblDeliveryOrdercust');
    var responseText = "<thead><tr><th style='width:90px;'><input type='checkbox' style='zoom:1.5;' checked id= 'SlNoHdCheckCustdo0' 'custom-control-input cz-bg-image-display' onchange='selectallcust3()'>&nbsp;&nbsp;&nbsp;Select</th><th>DO No</th><th>Customer</th><th>Address</th><th>Date</th><th>Salesman</th><th>Area</th><th>Currency</th><th style='display:none'></th><th style='display:none'></th></tr>" +
    ...
    for (var l = 0; l < result.length; l++) {
        var slno = parseInt(l + 1);
        responseText += '<tr id=' + "row" + slno + '>' +
            '<td ><input type="checkbox" style="zoom:1.5;" checked name="Checkcust" id= ' + 'SlNoHdCheckCustdo' + slno + ' ></td>' +
...
//List  DeliveryOrder Details against a customer in Popup 
function AgreementLoad(result) {

    disable_datatable('tblAgreement');
    var responseText = "<thead><tr><th style='width:90px;'></th><th>Agreement#</th><th>Customer</th><th>Vehicle#</th><th>Vehicle Description</th><th>License#</th><th>Start Date</th><th>End Date</th></tr>" +
                              "<tr><th style='width:90px;'>Select</th><th>Agreement#</th><th>Customer</th><th>Vehicle#</th><th>Vehicle Description</th><th>License#</th><th>Start Date</th><th>End Date</th></tr></thead><tbody>";
    for (var l = 0; l < result.length; l++) {
        var slno = parseInt(l + 1);
        var FromDate = GetFormattedDate(result[l].StartDate);
        var ToDate = GetFormattedDate(result[l].EndDate)
        var date1 = new Date(FromDate);
        var date2 = new Date(ToDate);
        var timeDiff = date2.getTime() - date1.getTime();
        var diffDays = (timeDiff / (1000 * 3600 * 24)) + 1;
       // $('#txtquantity0').val(diffDays + 1);

       
        responseText += '<tr id=' + "row" + slno + '>' +
            '<td ><input type="checkbox" style="zoom:1.5;" name="CheckAgr" id= ' + 'SlNoCheckAgreement' + slno + ' ></td>' +
           '<td id=' + 'AgreementNo' + slno + '>' + result[l].AgreementNo + '</td>' +
           '<td id=' + 'Customer' + slno + '>' + result[l].CustomerName + '<input type=hidden id=' + 'CId' + slno + ' value=' + result[l].CustomerId + '></td>' +
           '<td id=' + 'VechicleNo' + slno + '>' + result[l].VechicleNo + '<input type=hidden id=' + 'VechicleId' + slno + ' value='+result[l].ItemId+'></td>' +
           '<td id=' + 'VechicleDesc' + slno + '>' + result[l].VechicleDesc + '</td>' +
           '<td id=' + 'LicenseNo' + slno + '>' + result[l].LicenseNo + '</td>' +
           '<td id=' + 'SDate' + slno + '>' + result[l].StartDate + '<input type=hidden id=' + 'Daysdiff' + slno + ' value=' + (diffDays) + '></td>' +
           '<td id=' + 'EDate' + slno + '>' + result[l].EndDate + '<input type=hidden id=' + 'DLPrice' + slno + ' value=' + result[l].DailyPrice + '>'+
           '<input type=hidden id=' + 'WLPrice' + slno + ' value=' + result[l].WeeklyPrice + '>'+
           '<input type=hidden id=' + 'MLPrice' + slno + ' value=' + result[l].MonthlyPrice + '>'+
           '<input type=hidden id=' + 'ALPrice' + slno + ' value=' + result[l].AnnualPrice + '>'+
           '<input type=hidden id=' + 'Address' + slno + ' value=' + result[l].Address + '>' +
           '<input type=hidden id=' + 'Phone' + slno + ' value=' + result[l].PhoneNo + '>' +
           '<input type=hidden id=' + 'EmailId' + slno + ' value=' + result[l].Email + '></td>' +
           '</tr>';
      
    }
    $('#tblAgreement').html(responseText + '</tbody>');
    datatableWithsearch('tblAgreement', 'Multiple');
    $('#RowGet15').val(result.length);
}

//Selecting checkbox for Delivery Order Customer List
function selectallcust3() {
    var rowCount = $('#RowGet10').val();
    var flag = $("#SlNoHdCheckCustdo0").is(":checked")
    for (var h = 1; h <= rowCount + 1; h++) {
        if (document.getElementById("SlNoHdCheckCustdo" + h) != null) {
            document.getElementById("SlNoHdCheckCustdo" + h).checked = flag;
        }
    }
}
...
function SearchAgreement(flag) {
    ...
    if (flag == 1)          //Search
    {
        ...
        $("#Enquirypopup").css("margin-top", '-50px');
        $('#Enquirypopup').show();
        $('#Enquiryheader').text('Agreeement Details');
        $('#SalesOrderdivcust').hide();
        $('#Qtndiv').hide();
        $('#Qtndivcust').hide();
        $('#Qtndivsub').hide();
        ...
        $('#DeliveryOrderdivsub').hide();
        $('#AgreementDiv').show();
        if ($('#txtCustId').val() != 0 && $('#txtCustId').val() != '') {
            $('#CustomerId').val($('#txtCustId').val());
        }
        else
        {
            $('#CustomerId').val()
        ...
        var data = {};
        data.FromDate = $('#FromDateAgreement').val();
        data.EndDate = $('#ToDateAgreement').val();
        ...
        $.ajax({
            ...
            success: function (result) {
                if (result.oList.length == 0) {
                    $('#tblAgreement').html("<b><center><span class='label label-danger'>No records found</span></center></b>");
                }
                else {
                    AgreementLoad(result.oList);
                }
...
function formrefresh() {
    ...
    // else {
       ...
       // $('#select_location0').prop('disabled', 'true');
        ...
        $("#txtotp,#otpremarks,#SalesDepartmentId,#SalesDepartment").val('');
        $("#cancelotp,#cancelotpremarks").val('');
        totalproducts();
  ...
  //  }
        ...
        closeautomobile();
        clearrow(1);
        $('#CurrentTimeSales').val('');

        $('#txtlgrgname').val('');
        $('#txtlgrgadr').val('');
        $('#PhoneNo').val('');

        $('#salesviewpopup,#btnviewsales').hide();
...
function Defaultfocus() {
    if ($('#areadiv').is(":visible")) {
        ...
        $('#txtcustomer').focus();
        //if ((copyflag == 1) && !($('#SalesDocument').is(":visible"))) {
...
function amountcalculation(id) {
    ...
    var taxrate = parseFloat($('#txttaxpercent'+id).val() || 0).toFixed(Decimal);
    var taxamount = ((parseFloat(taxableamount||0).toFixed(Decimal) * parseFloat(taxrate||0).toFixed(Decimal)) / 100);

    var totalamount = parseFloat(taxableamount.toFixed(Decimal)) + parseFloat(taxamount.toFixed(Decimal));
    $('#LineAvgCost' + id).val(LineAvgCost.toFixed(Decimal));
    $('#txtamnt' + id).val(parseFloat(totalamount || 0).toFixed(Decimal));
    $('#txttaxableamnt' + id).val(parseFloat(taxableamount || 0).toFixed(Decimal));
    $('#txttaxamnt' + id).val(parseFloat(taxamount||0).toFixed(Decimal));
...
function productaddconfirm() {
    ...
    if ($.trim($("#txtproduct0").val()) == '') {
    ...
    else if (($("#PrdtId0").val() != 0) && (qtyflag == 1) && (Negativebill == 'NO') && ($("#select_location0").find("option:selected").attr("name") == 0)) {
        warningshow('Not enough stock!', 'txtproduct0'); 
    }
        ...
        warningshow('Please Enter The Days', 'txtquantity0');
        $('#txtquantity0').select();
    }
    else if ($("#txtquantity0").val() > (parseInt($('#txtstocktotloseqty0').val()) - pdtsumqty1) && (Negativebill == 'NO') && ($("#select_location0").find("option:selected").attr("name") == 0)) {
        warningshow('Available Quantity is ' + (parseInt($('#txtstocktotloseqty0').val()) - pdtsumqty1), 'txtquantity0');
        $('#txtquantity0').select();
    }
    else if ((($("#txtrate0").val() == 0) || ($("#txtrate0").val() == '')) && ($("#select_unit0 :selected").text().toLowerCase() != 'foc')) {
        warningshow('Please Enter The Rate', 'txtrate0');
        $('#txtrate0').select();
    }
    else if ( ($("#select_unit0 :selected").text().toLowerCase() != 'foc') && (parseFloat($("#txtrate0").val()) < parseFloat($('#AvgCost0').val())) && (BelowCost == 'NO') && ($('#BelowCostFlag0').val()==0)) {  
        warningshow('Rate must be greater than' + $('#AvgCost0').val(), 'txtrate0');
        $('#txtrate0').select();
    }
    else if (($("#select_unit0 :selected").text().toLowerCase() != 'foc') && ($("#txtamnt0").val() == 0)) {
...
function productadd()
{
    ...
    var ProdRow1 = "<tr onclick=GetPrdtId(" + $("#PrdtId0").val() + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")'  id=" + 'row' + id + " class='jsgrid-row'>" +
        "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +         
        "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
        "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + $("#PrdtId0").val() + "' /><input type='text' style='display:none;height:30px' id=" + 'Otherdescription' + id + " value='" + $("#Otherdescription0").val() + "'><input type='text' style='display:none;height:30px' id=" + 'MRP' + id + " value='" + $("#MRP0").val() + "'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + $("#txtproduct0").val() + "' data-toggle='tooltip' title='" + $("#txtproduct0").val() + "'></td>" +
        "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + $("#ProductDesc0").val() + "' data-toggle='tooltip' title='" + $("#ProductDesc0").val() + "'></td>" +

        "<td class='jsgrid-cell jsgrid-align-center' style='width:2%'><input type='text' name='prdaddqty' class='form-control text-center' id=" + 'txtquantity' + id + " value=" + parseInt($('#txtquantity0').val()) + " style='background-color:white;height:30px' onkeyup='RentCalculation(" + id + "),amountcalculation(" + id + ")' onkeydown=Focusnextgrid(event,'q'," + id + ") onkeypress=isNumberInt(event,this) onfocusout=focusoutgrid('q'," + id + ") onfocusin=focusingrid('q'," + id + ")><input type='text' class='form-control text-center' id=" + 'txtstocktotloseqty' + id + " value=" + parseInt($('#txtstocktotloseqty0').val()) + " style='display:none'></td>" +
        ...
        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + parseFloat($('#txtfcdiscount0').val()).toFixed(Decimal) + "  style='display:none'><input type='text' id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + parseFloat($('#txtdiscount0').val() || 0).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
        ...
        "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value=" + ($('#txttaxpercent0').val() || 0) + " onkeyup='amountcalculation(" + id + ")'></td>" +
        ...
        "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px' id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
        "<td style='display:none' id=" + 'Bin' + id + ">" + bins + "</td>" +
        "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BelowCostFlag0').val()+ " ></td>" + 
        "</tr>";
...
function JobAdd() {
    ...
    else if (($('#unit_job :selected').text().toLowerCase() != 'foc') && ($.trim($('#txtrate_job').val()) == '')) {
    ...
    //}
        ...
        var prodjob = "<tr onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
            ...
            "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='0' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + $("#productjob").val() + "' data-toggle='tooltip' title='" + $("#productjob").val() + "'></td>" +
            "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='JOB' data-toggle='tooltip' title='JOB'></td>" +
            "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select  id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
            "<td class='jsgrid-cell jsgrid-align-center' style='width:4%;'><select style='background-color:white;height:30px'  id=" + 'select_location' + id + " class='form-control' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
            ...
            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + parseFloat($('#fctxtdisc_job').val()).toFixed(Decimal) + "  style='display:none'><input type='text'  id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + parseFloat($('#discount_job').val() || 0).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
            ...
            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value='" + $('#taxpercentage_job').val() + "' onkeyup='amountcalculation(" + id + ")'></td>" +
...
function changeunitlist(TId, selectObject, flg) {
        //Multiple Item list   
        var value = selectObject.value;
        var unitsname = $(selectObject).find("option:selected").attr("name");
        if (unitsname.toLowerCase() == 'foc') {
...
function changeunitlistAuto(TId, selectObject) {  
        //Auto grid
        var value = selectObject.value;
        var unitsname = $(selectObject).find("option:selected").attr("name");
        if (unitsname.toLowerCase() == 'foc') {
            foc = 1;
            $('#autoprrate' + TId).val(0);
            autogridamountcalculation(TId);
            autoCheckme(TId);
        }
        else {
            foc = 0;
...
function updaterow(id) {
    ...
    else if (($("#select_unit" + id + ' :selected').text().toLowerCase() != 'foc') && (($('#txtrate' + id).val() == 0) || ($('#txtrate' + id).val() == ''))) {
    ...
    else if (($("#select_unit" + id + ' :selected').text().toLowerCase() != 'foc') && ($("#txtamnt" + id).val() == 0)) {
    ...
    else if (($("#select_unit" + id + ' :selected').text().toLowerCase() != 'foc') && (BelowCost == 'NO') && ($('#PrdtId' + id).val() != 0) && (($('#BelowCostFlag' + id).val()) == 0) && ($('#AvgCost' + id).val() != 0) && (parseFloat($('#txtrate' + id).val()) < parseFloat($('#AvgCost' + id).val()))) {
    ...
    //else if (($("#select_unit" + id).val()||0) == 0) {
...
function RentCalculation(Id)
{
    var Price = 0;
    if ($('#txtquantity' + Id).val() <= 7) {
        Price = Price + ($('#DPrice').val());
    }
    else if ($('#txtquantity' + Id).val() >= 7 && $('#txtquantity' + Id).val() <= 14) {
        Price = Price + ($('#WPrice').val());
    }
    else if ($('#txtquantity' + Id).val() >= 15 && $('#txtquantity' + Id).val() <= 30) {
        Price = Price + ($('#MPrice').val());
    }
    else if ($('#txtquantity' + Id).val() >= 31) {
        Price = Price + ($('#APrice').val());
    }
    $('#txtrate' + Id).val(parseFloat(Price || 0).toFixed(Decimal));
  
}


function RentCalculationGrid(Id) {
    if ($('#txtquantity' + Id).val() <= 7) {
       // Price = Price + ($('#DLPrice' + Id).val());
        $('#txtrate' + Id).val(parseFloat($('#DPriceNew' + Id).val() || 0).toFixed(Decimal));
    }
    else if ($('#txtquantity' + Id).val() >= 7 && $('#txtquantity' + Id).val() <= 14) {
        $('#txtrate' + Id).val(parseFloat($('#WPriceNew' + Id).val() || 0).toFixed(Decimal));
    }
    else if ($('#txtquantity' + Id).val() >= 15 && $('#txtquantity' + Id).val() <= 30) {
        $('#txtrate' + Id).val(parseFloat($('#MPriceNew' + Id).val() || 0).toFixed(Decimal));
    }
    else if ($('#txtquantity' + Id).val() >= 31) {
        $('#txtrate' + Id).val(parseFloat($('#APriceNew' + Id).val() || 0).toFixed(Decimal));
    }
...
function copyrefresh() {
    ...
    $('#txtlgrgname').val('');
    $('#txtlgrgadr').val('');
    $('#PhoneNo,#SalesDepartmentId,#SalesDepartment').val('');
...
function ConfirmboxResult(Result, status, rowid) {
    ...
    else if (Result == 'true' && status == 'Quotation') {
       SaveQuotation(); 
    }
    else if (Result == 'true' && status == 'SalesFiles') {
        OKUploadSalesFiles(); 
    }
...
function ConfirmboxResultSales(Result, status, rowid)
{  
    if (Result == 'true' && status == 'Retry') {
        $('#confirmOksales').prop("disabled", true);
        var data = {};
        data.id = $('#txtBillseriesId').val(); 
        data.BillType = 'Sales Invoice';
        $.ajax({
            type: "POST",
            ...
            success: function (result) {
                ...
                $('#txtBillSlNo').val(result.oList[0].CurrentNo);
                savesalesconfirm();
            }
        });     
    }
    else
        $('#confirmsales').fadeOut();
...
function BillCancel() {
    ...
    $.ajax({
        type: "POST",
        url: "../SalesInvoice/SalesInvoiceRentCarDelete",
        data: data,
        success: function (result) {
            TaxClear();
            for (var i = 0; i <= result.oList.length; i++) {
...
function GoEditInv(flg)
{
    ...
    else if(flg == 1)    //Delete
    {
        ...
        warningshow('Bill NO : ' + $('#txtBillseriesId').find("option:selected").text() + ' - ' + $('#txtBillSlNocopy').val() + ' is From Department - ' + $('#SalesDepartment').val());
    }
...
function Showalerts(Status, billsrs, billsrlno) {
    ...
    if (Status == 1) {
        ...
        $('#confirmOksales').prop("disabled",false);

        $('#confirmsales').show();
        $('#confirmOksales').focus();
        $('#Confirmflagsales').val('Retry'); $('#ConfirmRowIdsales').val(0);
        $('#confirmmessagesales').text('Bill No : ' + billsrs + '-' + billsrlno + ' already exists.. Please Contact Admin or Retry!');
        ...
        swal('Bill No : ' + billsrs + '-' + billsrlno, "Cancelled", "error");
        $('.swal-button swal-button--confirm').focus();
        Tbldelete();
        copyrefresh();
    }
        ...
        formrefresh();
        swal('Quotation Number : ' + billsrlno + ' saved successfully', "", "success"); 
        $('.swal-button swal-button--confirm').focus();
    }
}
    ...
    if (result != 0) {
        ...
        for (var l = 0; l < result.length; l++) {
            ...
            if ($('#select_location0').val() == 1) { if (result[l].Bin_A != '') { bins = bins + result[l].Bin_A; } }
                ...
                var responseText =
                    '<tr onclick="GetPrdtId(' + result[l].ItemId + ",'" + result[l].Description + "','" + result[l].ItemCode + "'," + 4 + '),Getproddetailsauto(' + slno + ')"  id="autorow' + slno + '"><td style="width:90px;" ><input name="autoCheckprdtlist" onchange=autoclearcheck(' + slno + ') type="checkbox" id= ' + 'autoSlNoHeadCheckgrid' + slno + '  class="form-control" style="align:center"></td>' +
                    ...
                    '<td style="text-align:center;" ><select  style="height:30px;" class=form-control id=' + 'autoItemunitgrid' + slno + ' onchange=changeunitlistAuto(' + slno + ',this) onkeydown=autoFocusnext(event,' + slno + ',"u")>' + UnitSelect + '</select></td>' +
                     '<td style="text-align:center;" ><select  style="height:30px;" class=form-control id=' + 'autoItemLocngrid' + slno + ' onchange=GetBin(' + slno + ',' + result[l].ItemId + ',2),autoLocationqtycheck(' + slno + ') onkeydown=autoFocusnext(event,' + slno + ',"l") >' + LocnSelect + '</select></td>' +
                    ...
                    '<td style="display:none" ><input type="hidden" id="BCost7_' + slno + '" value=' + result[l].MultiPriceId + '></td>' +                      
                   '</tr>';
...
function autoclearcheck(Id) {
     ...
     if (($("#autoSlNoHeadCheckgrid" + Id).prop('checked')))  
     {
         ...
         if (($('#autoqtypr' + Id).val() != '') && ((($('#autoprrate' + Id).val() != '') && ($('#autoprdamnt' + Id).val() != 0)) || ($('#autoItemunitgrid' + Id + ' :selected').text().toLowerCase() == 'foc'))) {
    ...
    var flag = $("#autoSlNoHeadCheckgrid0").is(":checked") 
        for (var h = 1; h <= rowCount + 1; h++) {
            if (document.getElementById("autoSlNoHeadCheckgrid" + h) != null) {
                if (($('#autoqtypr' + h).val() != '') && ((($('#autoprrate' + h).val() != '') && ($('#autoprdamnt' + h).val() != 0)) || ($('#autoItemunitgrid' + h + ' :selected').text().toLowerCase() == 'foc'))) {
...
function autocheckratestock(id) {
   // if ($("#autoSlNoHeadCheckgrid" + id).is(":checked")) {
    if (($('#autoItemunitgrid' + id + ' :selected').text().toLowerCase() != 'foc') && (BelowCost == 'NO') && ($('#BCost7_' + j).val() == 0) && ($('#autopravgcost' + id).val() != 0) && (parseFloat($('#autoprrate' + id).val()) < parseFloat($('#autopravgcost' + id).val()))) {
...
function autoaddgridproducts() {
    ...
    for (j = 1; j <= cnt ; j++) {
        if ($("#autoSlNoHeadCheckgrid" + j).is(":checked")) {
            if (($('#autoItemunitgrid' + j + ' :selected').text().toLowerCase() != 'foc') && (BelowCost == 'NO') && ($('#BCost7_' + j).val() == 0) && ($('#autopravgcost' + j).val() != 0) && (parseFloat($('#autoprrate' + j).val()) < parseFloat($('#autopravgcost' + j).val()))) {
                rateflg = 1;
                break;
            }
            else
        ...
        if (autoProdarray.length <= 0) {
            ...
            for (var b = 0; b < autoProdarray.length; b++) {
                ...
                if ($("#autoSlNoHeadCheckgrid" + m).is(":checked")) {
                    ...
                    //    return false;
                    //}
                     if ($("#autoqtypr" + m).val() == '' || 0) {
                        warningshow('Please Enter The Quantity', 'autoqtypr' + m);
                        $('#autoqtypr' + m).select();
                        return false;
                    }
                    else if ((($("#autoprrate" + m).val() == '') || ($("#autoprrate" + m).val() == 0)) && ($('#autoItemunitgrid' + m + ' :selected').text().toLowerCase() != 'foc')) {
                    ...
                    else if (($("#autoprdamnt" + m).val() == '' || $("#autoprdamnt" + m).val() == 0) && ($('#autoItemunitgrid' + m + ' :selected').text().toLowerCase() != 'foc')) {
                        ...
                        var ProdRows = "<tr onclick=GetPrdtId(" + $('#autoItemIdgrid' + m).val() + ",'" + desc + "','" + code + "'," + 2 + ") onfocusout='updaterow(" + id + ")' id=" + 'row' + id + " class='jsgrid-row'>" +
                            "<td id= 'col13_" + id + "' class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:1%'><input class='jsgrid-button jsgrid-delete-button jsgrid-align-center' id='btnrodelt' type='button' onclick='rowdelete(" + id + ")' title='Delete'></td>" +
                            "<td id=" + 'td' + id + " class='jsgrid-cell' style='width:2%;text-align:center'>" + slno + "</td>" +
                            "<td class='jsgrid-cell jsgrid-align-right' style='width:4%;text-align:center'><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + $('#autoItemIdgrid' + m).val() + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + $('#autoItemcodegrid' + m).val() + "'  data-toggle='tooltip' title='" + $('#autoItemcodegrid' + m).val() + "'></td>" +
                            "<td class='jsgrid-cell jsgrid-align-right' style='width:13%;text-align:center'><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'ProductDesc' + id + " value='" + $('#autoItemdescgrid' + m).text() + "' data-toggle='tooltip' title='" + $('#autoItemdescgrid' + m).text() + "'></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)'  onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:4%;'><select style='background-color:white;height:30px'  id=" + 'select_location' + id + " class='form-control' onchange ='GetBin(" + slno + "," + $('#autoItemIdgrid' + m).val() + ",0),Locationqtycheckmain(" + id + ")' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                            ...
                            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'txtfcdiscount' + id + " value=" + parseFloat($('#autoprdfcdiscount' + m).val()).toFixed(Decimal) + "  style='display:none'><input type='text' id=" + 'txtdiscount' + id + " class='form-control text-center' style='background-color:white;height:30px' value=" + parseFloat($('#autoprdisc' + m).val() || 0).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")' onkeypress=isNumber(event,this) onkeydown=Focusnextgrid(event,'d'," + id + ") onfocusout=focusoutgrid('d'," + id + ") onfocusin=focusingrid('d'," + id + ")></td>" +
                            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxableamnt' + id + " value=" + parseFloat($('#autoprdfctaxableamnt' + m).val()).toFixed(Decimal) + "  style='display:none'><input type='text' disabled='' class='form-control text-center' style='background-color:white;height:30px' id=" + 'txttaxableamnt' + id + " value=" + parseFloat($('#autoprdtaxableamnt' + m).val()).toFixed(Decimal) + " onkeyup='amountcalculation(" + id + ")'></td>" +
                            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:22px;display:none'><input typ='text' disabled='' style='background-color:white;height:30px' class='form-control text-center' id=" + 'txttaxpercent' + id + " value=" + $('#autoItemtaxgrid' + m).find("option:selected").attr("name") + " onkeyup='amountcalculation(" + id + ")'></td>" +
                            "<td class='jsgrid-cell jsgrid-control-field jsgrid-align-center' style='width:3%'><input type='text' id=" + 'txtfctaxamnt' + id + " value=" + parseFloat($('#autoprdfctaxamnt' + m).val()).toFixed(Decimal) + "  style='display:none'><input typ='text' style='background-color:white;height:30px' class='form-control text-center'  id=" + 'txttaxamnt' + id + " value=" + parseFloat($('#autoprdtaxamnt' + m).val()).toFixed(Decimal) + " disabled=''></td>" +
                            ...
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:30px;display:none'><input type='text' id=" + 'LineAvgCost' + id + " value=" + parseFloat($('#autoprLineAvgCost' + m).val()).toFixed(Decimal) + " style='display:none'> <input type='text' disabled='' class='form-control text-center' id=" + 'AvgCost' + id + " value=" + parseFloat($('#autopravgcost' + m).val()).toFixed(Decimal) + " style='background-color:white;height:30px'></td>" +
                            "<td class='jsgrid-cell jsgrid-align-center' style='width:3%;'><select style='background-color:white;height:30px' id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                            "<td style='display:none' id=" + 'Bin' + id + ">" + bins + "</td>" +
                            "<td style='display:none'><input type='text'  id=" + 'BelowCostFlag' + id + " value=" + $('#BCost7_'+m).val() + " ></td>" + 
                            "</tr>";
                        $('#tblsalesinvoice').append(ProdRows);
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.oList.length==1) { 
                ...
                $('#duemsg').text('');
                $('#duecheckdiv').show();
                $('#duemsg').append('<tr><td><h2> Payment( ' + (result.oList[0].GrandTotal).toFixed(Decimal) + ' ) for </br>Bill Number ' + result.oList[0].BillDescription + ' - ' + result.oList[0].BillSlNo + '</br> is Overdue on ' + result.oList[0].DueDate + '</h2></tr></td>'); 
                $('#btndue').focus(); 
            }
            ...
            {              
                ...
                for (var c = 0 ; c < result.oList.length ; c++) 
                    $('#duemsg').append('<tr class="jsgrid-row" style="border:1px solid"><td class="jsgrid-cell jsgrid-control-field jsgrid-align-center"><h4>' + result.oList[c].BillDescription + ' - ' + result.oList[c].BillSlNo + ' </h4></td>' +                      
                        '<td class="jsgrid-cell jsgrid-control-field jsgrid-align-center"><h4>' + result.oList[c].DueDate + '</h4></td>' +
                        '<td class="jsgrid-cell jsgrid-control-field jsgrid-align-center"><h4>' + (result.oList[c].GrandTotal).toFixed(Decimal) + '</h4></td></tr>');
