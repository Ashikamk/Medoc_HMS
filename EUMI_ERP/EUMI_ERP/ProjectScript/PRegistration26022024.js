...
function PrintRegistration() {
    ...
    myWindow.document.write('<table width=100% ><tr ><td width=10% align=left >MR#&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#RegNo').val() + '</td> <td align=right width=10%>Bill No.&#160; : </td><td colspn=2 width=20% >' + $('#RegNo').val() + '</td> </tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#PName').val() + '</td>  <td align=right width=10%>Date &#160;&#160;&#160;&#160;&#160;&#160;: </td><td  colspn=2 width=20% >' + $('#RegDate').val() + '</td>  </tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td><td align=right width=10%>Age/Sex : </td><td colspn=2 width=20% >' + Age + '</td></tr>');
