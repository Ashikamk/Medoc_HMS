...
$(document).ready(function () {
    ...
    $('#ChequeNo,#ChequeDtFrom,#ChequeDtTo,#voucherdt').daterangepicker({
                ...
                if ($('#UserDetsss').text() == result[l].Description) {
                    ...
                    responseText +=
                       ...
                       '<td class= "jsgrid-cell jsgrid-align-center" style="width:2%"><input type="checkbox" id= ' + 'SlNoCheck' + slno + ' onclick=SumChange(' + slno + ')></td>' +
                        ...
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:6%"><input type="text" value=' + result[l].CurrencyRate + '  id=' + 'cardrAmount' + slno + ' class="form-control" ></td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:6%"><input type="text" value=' + result[l].CurrencyRate + '  id=' + 'UPIrAmount' + slno + ' class="form-control" ></td>' +
