...
function AddTestConfirm() {
    ...
    var ProdRow1 = "<tr id=" + 'Row' + id + " class='jsgrid-row TsRw' onclick='EditRow(" + id + ")' onfocusout=updaterow(" + id + ")>" +
        ...
        "<td class='jsgrid-cell jsgrid-align-left' style='width:10%'><input type='text' id='TestName" + id + "' value='" + $('#BillDate').val() + "'  class='form-control TestName' style='height:30px' ></td>" +
        ...
        "<td class='jsgrid-cell jsgrid-align-left' style='width:40%'><input type='text'  id='Testremarks" + id + "' value='" + $('#Testremarks0').val() + "' class='form-control' style='height:30px;background-color:white' ></td>" +
    ...
    if (result.length > 0) {
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            var ProdRow1 = "<tr id=" + 'Row' + id + " class='jsgrid-row TsRw' onclick='EditRow(" + id + ")' onfocusout=updaterow(" + id + ")>" +
                ...
                "<td class='jsgrid-cell p-1  jsgrid-align-left' style='width:10%'><input type='text' id='TestName" + id + "' value='" + result[i].DischargeDate + "'  class='form-control TestName'  style='height:30px' ></td>" +
                ...
                "<td class='jsgrid-cell jsgrid-align-left' style='width:40%'><input type='text'  id='Testremarks" + id + "' value='" + result[i].Department + "' class='form-control rdonl' style='height:30px;background-color:white' ></td>" +
...
function SaveAndUpdateConfirm(flg) {
    ...
    for (var k = 1; k <= Count; k++) {
        ...
        var Department = $('#Testremarks' + k).val();
        var PQty = $('#PQty' + k).val();
