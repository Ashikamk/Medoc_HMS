...
!(function (r) {
	...
	function t(t, e, n, o) {
		function a(r, t) {
			return (
				(r -= o), (t -= o), 0 > r || r >= c || 0 > t || t >= c ? !1 : f.isDark(r, t)
			);
		}
		function i(r, t, e, n) {
			var o = u.isDark,
	...
	function n(r, t, e) {
		...
		var i = a.measureText(e.label).width,
			...
			v = 0.01;
		1 === e.mode
			? r.addBlank(0, l - v, n, s + v)
			: r.addBlank(c - v, l - v, g + v, s + v),
	...
	function o(r, t, e) {
		var n = e.size,
			...
			s = 0.01;
		3 === e.mode
			? r.addBlank(0, c - s, n, g + s)
			: r.addBlank(f - s, c - s, l + s, g + s),
	...
	function a(r, t, e) {
		w(e.background).is("img")
			...
			: e.background &&
			  ((t.fillStyle = e.background), t.fillRect(e.left, e.top, e.size, e.size));
		var a = e.mode;
	...
	function l(r, t, e) {
		var n,
			...
			f = i;
		for (
			e.radius > 0 && e.radius <= 0.5 && (f = c), t.beginPath(), n = 0;
			a > n;
			n += 1
		)
			for (o = 0; a > o; o += 1) {
	...
	function s(r) {
	    var t = w("<canvas/>").attr("width", r.size).attr("height", r.size).attr("id", "QRDIV");
		return g(t, r);
	}
	function v(r) {
		...
		var r = (function () {
			function r(t, e) {
				...
				return (
					...
					(o.mod = function (t) {
						...
						for (
							var e = i.glog(o.getAt(0)) - i.glog(t.getAt(0)),
			...
			var t = function (t, e) {
				var o = 236,
					...
					k = function (r, t) {
						for (
							var e = (g << 3) | t, n = a.getBCHTypeInfo(e), o = 0;
							15 > o;
							o += 1
						) {
							var i = !r && 1 == ((n >> o) & 1);
					...
					C = function (t, e) {
						...
						for (var y = new Array(m), T = 0, s = 0; o > s; s += 1)
							for (var c = 0; c < e.length; c += 1)
								s < u[c].length && ((y[T] = u[c][s]), (T += 1));
						for (var s = 0; i > s; s += 1)
							for (var c = 0; c < e.length; c += 1)
								s < f[c].length && ((y[T] = f[c][s]), (T += 1));
						return y;
					},
					D = function (r, t, e) {
						...
						if (c.getLengthInBits() > 8 * s)
							throw new Error(
								"code length overflow. (" + c.getLengthInBits() + ">" + 8 * s + ")"
							);
						for (
							c.getLengthInBits() + 4 <= 8 * s && c.put(0, 4);
			...
			var e = {
					...
					return (
						(e.getRSBlocks = function (r, e) {
							...
							for (var a = n.length / 3, i = new Array(), u = 0; a > u; u += 1)
								for (
									var f = n[3 * u + 0], c = n[3 * u + 1], l = n[3 * u + 2], g = 0;
									f > g;
									g += 1
								)
									i.push(t(c, l));
				...
				v = function (r, t) {
					...
					var i = function (r) {
						...
						u = function (r) {
							for (
								var t = 1 << r, e = (1 << r) + 1, n = r + 1, a = f(), u = 0;
								t > u;
								u += 1
							)
							...
							return (
								g.write(a.indexOf(v), n), g.write(e, n), g.flush(), c.toByteArray()
							);
						},
						f = function () {
							var r = {},
