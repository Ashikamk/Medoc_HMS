...
{
    public class ADataImportOtherBillsController : Controller
    {
        ...
        [HttpPost]
        public string BilldataInserted(HttpPostedFileBase filename)
        {
            try
            {
                string dirpath = "";
        ...
        int ConvertToDataTable(long stockistId)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    dsDataSet = obj.ProductFileUpload(dt, dbName);
                    //message.Visible = true;
