...
function PrintthisBillHospitalSales(Type, Rowlen, Flag) {
    ...
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Bill No:' + BillNo + Space).substring(0, 55) + ('Date   :' + $('#HSalesDate').val() + Space).substring(0, 25) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
