    ...
    if (parseInt($('.MRow').length) == 0) { warningshow('Please Select Medicines', 'Medicine0'); }
        ...
        for (var k = 1; k <= parseInt(ACount); k++) {
            ...
            if ($('#Medicine' + Id).length != 0) {
                ...
                ProdRow += medname + '   ' + Dosage + Daily + Days + Coma;
                console.log(ProdRow)
            }
        }
...
function SaveAndUpdate(flag) {
    ...
    var x = $('#Allergies').val() + '$$' + $('#icd10').val() + '$$' + $('#MedPrevious').val() + '$$' + $('#emergencycase').val() + '$$' + $('#Clubbing').val() + '$$' + $('#Temperature2').val() + '$$' + $('#Oedema').val() + '$$' + $('#Pulse').val() + '$$' + $('#Pulse2').val() + '$$' + $('#Temperature').val() + '$$' + $('#Pallor').val() + '$$' + $('#Cavity').val() + '$$' + $('#Resp').val() + '$$' + $('#Resp2').val() + '$$' + $('#Cyanosis').val() + '$$' + $('#Icterus').val() + '$$' + $('#SPO22').val() + '$$' + $('#SPO2').val();
