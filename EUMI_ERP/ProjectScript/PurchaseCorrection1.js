                    ...
                    if (data.length) {
                        response($.map(data, function (item) {
                            return ({
                                ...
                                headers: ["Batch", "Bill#", "Bill Date", "Location", "Expiry", "Stock"]
                            })
                        }));
                    }
                    else {
...
function OKProductAdd() {
    ...
    var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
       ...
       '<td width="13%"><input id="Product_' + Id + '" value="' + $.trim($("#Product_0").val()) + '" onkeyup="LoadProduct(' + Id + ')" class="form-control smallTextbox borderno" autocomplete="off" /></td>' +

       '<td width="5%"><input id="Batch_' + Id + '" value="' + $.trim($("#Batch_0").val()) + '" onkeyup="LoadBatch(' + Id + ')" class="form-control smallTextbox borderno batch" autocomplete="off" /></td>' +

       '<td width="5%"><input id="NewBatch_' + Id + '" value="' + $.trim($("#NewBatch_0").val()) + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'NewBatch_\', \'NewBatch_\', \'Expiry_\', ' + Id + ', \'MTr_\')" /></td>' +

       '<td width="5%"><input id="Expiry_' + Id + '" value="' + $.trim($("#Expiry_0").val()) + '" class="form-control smallTextbox borderno text-center" onkeypress="isNumberDate(event, this)" onkeyup="ExpiryDate(\'Expiry_' + Id + '\')" onkeydown="FocusNext(event, \'NewBatch_\', \'Expiry_\', \'SR_\', ' + Id + ', \'MTr_\')" /></td>' +

       '<td width="5%"><input id="SR_' + Id + '" value="' + parseFloat($("#SR_0").val() || 0).toFixed(Decimal) + '" class="form-control smallTextbox borderno text-right"  onkeypress="isNumber(event,this)" onkeydown="FocusNext(event, \'Expiry_\', \'SR_\', \'MRP_\', ' + Id + ', \'MTr_\')" /></td>' +

       '<td width="5%"><input id="MRP_' + Id + '" value="' + parseFloat($("#MRP_0").val() || 0).toFixed(Decimal) + '" class="form-control smallTextbox borderno text-right"  onkeypress="isNumber(event,this)" onkeydown="FocusNext(event, \'SR_\', \'MRP_\', \'StockType_\', ' + Id + ', \'MTr_\')" /></td>' +

       '<td width="9%"><div class="input-group m-0"><select type="text" id="StockType_' + Id + '" class="form-control smallTextbox borderno" autocomplete="off"  onchange="CalcStock(' + Id + ')"  onkeydown="FocusNext(event, \'MRP_\', \'StockType_\', \'Quantity_\', ' + Id + ', \'MTr_\')"><option value="0">Select</option><option value="1">Add</option><option value="2">Less</option></select>' +
         '<input type="text" id="Quantity_' + Id + '"  value="' + parseInt($("#Quantity_0").val() || 0) + '" class="form-control smallTextbox denull input-group-append borderno text-center"  onkeyup="CalcStock(' + Id + ')"  onkeypress="isNumberInt(event,this)"  onkeydown="FocusNext(event, \'StockType_\', \'Quantity_\', \'Reason_\', ' + Id + ', \'MTr_\')"  /></div></td>' +

       '<td width="5%"><input id="NStock_' + Id + '" value="' + parseInt($("#NStock_0").val() || 0) + '" class="form-control smallTextbox borderno text-center bg-white" disabled /></td>' +
...
function GetPurchaseCorrection(result) {
    ...
    for (var i = 0; i < result.length; i++) {
        ...
        var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
              ...
              '<td width="9%"><div class="input-group m-0"><select type="text" id="StockType_' + Id + '" class="form-control smallTextbox borderno" autocomplete="off"  onchange="CalcStock(' + Id + ')"  onkeydown="FocusNext(event, \'MRP_\', \'StockType_\', \'Quantity_\', ' + Id + ', \'MTr_\')"><option value="0">Select</option><option value="1">Add</option><option value="2">Less</option></select>' +
                '<input type="text" id="Quantity_' + Id + '"  value="' + parseFloat(result[i].Quantity || 0) + '" class="form-control smallTextbox denull input-group-append borderno text-center"  onkeyup="CalcStock(' + Id + ')"  onkeypress="isNumberInt(event,this)"  onkeydown="FocusNext(event, \'StockType_\', \'Quantity_\', \'Reason_\', ' + Id + ', \'MTr_\')"  /></div></td>' +

              '<td width="5%" data-toggle="tooltip" data-placement="top" data-original-title="Old Stock : ' + result[i].Loose + '"><input id="NStock_' + Id + '" value="' + parseFloat(result[i].Free || 0) + '" class="form-control smallTextbox borderno text-center bg-white" disabled /></td>' +
