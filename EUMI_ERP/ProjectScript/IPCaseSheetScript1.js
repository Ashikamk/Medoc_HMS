...
function SubDetailsSave(status, CaseSheetId) {
    ...
    for (var k = 1; k <= MedCount; k++) {
        ...
        var MedicineId = $('#MedicineId' + k).val();
...
function AddMedicineListPrev(result)      //flg-0 : Add Medicine during List
{
    ...
    for (var i = 0; i < result.length; i++) {
        if (i == 0) {
            ...
            '<input type="text" class="form-control brdles" id="PMedicine_' + Id + '"  value="' + result[i].Medicine + '" onfocus="LoadMedicinePrev(' + Id + ')" onfocusout=UpdatePrevMedicineRow(' + Id + ',0)  />' +
...
function AddPrevMedicineRow(flg)      //flg-0 : Add Medicine
{
    if (flg == 0) {
        ...
        var MedRow =
            ...
            '<td class="" style="width: 47%;">' +
            '<input type="text" class="form-control brdles" id="PMedicine_' + Id + '"  value="" onfocus="LoadMedicinePrev(' + Id + ')" onfocusout=UpdatePrevMedicineRow(' + Id + ',0) />' +
...
function MedicineFocus() {
    $('.mdclass').keydown(function (e) {
        ...
        if (key == 13) {                                                        //Enter
            ...
            else if (Name == 'medname') { $('#Daily' + Id).focus(); }
...
function AddMedicineRow(flg)      //flg-0 : Add Medicine
{
    if (flg == 0) {
        ...
        '<td class="" style="width: 47%;">' +
        '<input type="text" class="form-control mdclass  brdles" id="Medicine' + Id + '"  name="medname"  onfocus="LoadMedicine(' + Id + ')" onfocusout=UpdateMedicineRow(' + Id + ',0) />' +
...
function AddMedicineList(result)      //flg-0 : Add Medicine during List
{
    ...
    for (var i = 0; i < result.length; i++) {
        ...
        if (i == 0) {
            ...
            '<td class="jsgrid-align-center" style="width: 8%;" id="Mslno' + Id + '">' + SlNo + '</td>' +
            '<td class="" style="width: 47%;">' +
            '<input type="text" class="form-control brdles" id="Medicine' + Id + '"  value="' + result[i].Medicine + '" onfocus="LoadMedicine(' + Id + ')" onfocusout=UpdateMedicineRow(' + Id + ',0) />' +
