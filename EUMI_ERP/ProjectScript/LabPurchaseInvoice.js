...
$(document).ready(function () {
    ...
    $('#MRP_0').keydown(function (e) {
        ...
        if (key == 13) {
            e.preventDefault();
            $("#TaxId_0").focus().select();

        }
    });


    $('#TaxId_0').keydown(function (e) {
        var key = e.charCode ? e.charCode : e.keyCode ? e.keyCode : 0;
        if (key == 13) {
            e.preventDefault();
            $("#DiscountPer_0").focus().select();
...
function OKProductAdd() {
    ...
    var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
        ...
        '<td width="10%"><input id="Product_' + Id + '" value="' + $.trim($("#Product_0").val()) + '" onkeyup="LoadProduct(' + Id + ')" class="form-control smallTextbox borderno" /></td>' +
        '<td width="3%"><input id="Batch_' + Id + '" value="' + $.trim($("#Batch_0").val()) + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Expiry_' + Id + '" value="' + $.trim($("#Expiry_0").val()) + '" class="form-control text-center smallTextbox borderno"  onkeypress="isNumberDate(event, this)" onkeyup="ExpiryDate(\'Expiry_' + Id + '\')" onkeydown="FocusNext(event, \'Batch_\', \'Expiry_\', \'Pack_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Pack_' + Id + '" value="' + parseInt($("#Pack_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Expiry_\', \'Pack_\', \'Qty_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Qty_' + Id + '" value="' + parseInt($("#Qty_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Pack_\', \'Qty_\', \'Free_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Free_' + Id + '" value="' + parseInt($("#Free_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Qty_\', \'Free_\', \'Loose_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td style=display:none width="5%"><input id="Loose_' + Id + '" value="' + parseInt($("#Loose_0").val() || 0) + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Free_\', \'Loose_\', \'Rate_\', ' + Id + ',\'MTr_\')" /></td>' +

        '<td width="3%"><input id="Rate_' + Id + '" value="' + parseFloat($("#Rate_0").val() || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Loose_\', \'Rate_\', \'TaxId_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><select id="TaxId_' + Id + '" class="form-control smallTextbox borderno" onchange="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Rate_\', \'TaxId_\', \'DiscountPer_\', ' + Id + ',\'MTr_\')">' + TaxSelect + '</select></td>' +
        '<td width="4%"><input id="amoutwithdis_' + Id + '" value="0" class="form-control text-right smallTextbox dedisa borderno bg-white" disabled onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Free_\', \'Loose_\', \'Rate_\', ' + Id + ',\'MTr_\')" /></td>' +

        '<td width="3%"><input id="SR_' + Id + '" value="' + parseFloat($("#SR_0").val() || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeydown="FocusNext(event, \'Discount_\', \'SR_\', \'MRP_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="MRP_' + Id + '" value="' + parseFloat($("#MRP_0").val() || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeydown="FocusNext(event, \'SR_\', \'MRP_\', \'Margin_\', ' + Id + ',\'MTr_\')" /></td>' +



        '<td width="3%"><input id="DiscountPer_' + Id + '" value="' + parseFloat($("#DiscountPer_0").val() || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeyup="CalcDiscRow(' + Id + ',1,1)" onkeydown="FocusNext(event, \'TaxId_\', \'DiscountPer_\', \'Discount_\', ' + Id + ',\'MTr_\')" /></td>' +
        '<td width="3%"><input id="Discount_' + Id + '" value="' + parseFloat($("#Discount_0").val() || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeyup="CalcDiscRow(' + Id + ',0,1)" onkeydown="FocusNext(event, \'DiscountPer_\', \'Discount_\', \'SR_\', ' + Id + ',\'MTr_\')" /></td>' +
        ...
        '<td width="5%"><input id="Margin_' + Id + '" value="' + parseFloat($("#Margin_0").val() || 0).toFixed(Decimal) + '"   class="form-control text-center smallTextbox borderno" onkeyup="CalcSellingPriceWithMargin(' + Id + ')" onkeypress="isNumber(event, this)" onkeydown="FocusNext(event, \'MRP_\', \'Margin_\', \'\', ' + Id + ',\'MTr_\')"   /></td>' +
        ...
        '<td width="5%"><input id="OtherCost_' + Id + '" value="' + parseFloat(0).toFixed(Decimal) + '" class="form-control text-right smallTextbox dedisa borderno bg-white" disabled /></td>' +
...
function CalcAmount(Id) {
    ...
    var BDis = parseFloat($('#Discountpercent').val() || 0)
    $("#amoutwithdis_" + Id).val(Number(BaseAmount).toFixed(Decimal));

    calProfitpercentage(Id)
...
function CalcTotal() {
    ...
    TaxSubAmountCalc(0);
    marginrounofcalculation()
    othercostchange()

}


function marginrounofcalculation() {
    //var margin diff
    var txttotal = parseFloat($('#FCTextTotal').text() || 0);
    var txtinvototal = parseFloat($('#FCInvoiceTotal').val() || 0);
    var LDiff = parseFloat(txtinvototal - txttotal);
    $('#FCdiff').val((LDiff).toFixed(2));
}
...
function LoadProduct(Id) {
    ...
    $("#Product_" + Id).autocomplete({
        ...
        source: function (request, response) {
            ...
            data.UserId = ERPUserId;
            $.ajax({
                url: '../Pharmacy/HMS_LabPurchaseProductSearch',
                type: "POST",
                data: data,
                dataType: "json",
                success: function (data) {
                    ...
                    response($.map(data, function (item) {
                        return ({
                            ColCount: '-20ph',
                            label: item.ItemCode + (item.Description ? ' - ' + item.Description : ''),
                            label1: item.Model1,
...
function Itemwisediscountcalcul() {
    debugger;
    var BillAmt = 0;
    var BillDis = 0;
    var DisAmount = 0;
    ...
    for (var i = 1; i <= GridLength; i++) {
        if ($('#Product_' + i).val() != undefined) {
            BillAmt = parseFloat($('#FCAmt_' + i).val() || 0);
            billdisC = parseFloat($('#Discountpercent').val() || 0);
            Disiamount = parseFloat(BillAmt - parseFloat((BillAmt * billdisC / 100)) || 0).toFixed(2);
            $('#amoutwithdis_' + i).val(Disiamount);
        }
    }
    ...
    for (var i = 1; i <= GridLength; i++) {
        ...
        if ($('#Product_' + i).val() != undefined) {
            ...
            oArray.push({
                ...
                'Terms': 0,
                'DueDate': '',
                'LPO_No': $('#otrcost2').val() + '##' + $('#otrcost1').val() + '##' + $('#otrcost').val(),
                'JobNo': 0,
                'Area': 0,
                'ShipDate': '',
                'Flag': $("#TempSlNo").val(),
...
function TryLoadInvoice(SlNo, Value) {
    ...
    $.ajax({
        type: "POST",
        url: "../Pharmacy/HMS_LabPurchaseGetandGets",
        data: data,
        success: function (result) {
            if (result.length > 0) {
                // Found a valid Stock invoice — show it
                $('#PINo_A').val(SlNo);
                formrefresh(1);
                PurchaseGets(result);
                $('#btnnew').focus();
                ...
                // Empty (probably a Medicine invoice) — skip to next one automatically
    ...
    if (result.length > 0) {
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
                ...
                '<td width="3%"><input id="Qty_' + Id + '" value="' + result[i].Quantity + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Pack_\', \'Qty_\', \'Free_\', ' + Id + ',\'MTr_\')" /></td>' +


                '<td width="3%"><input id="Free_' + Id + '" value="' + result[i].Free + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Qty_\', \'Free_\', \'Loose_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td style=display:none width="5%"><input id="Loose_' + Id + '" value="' + result[i].Loose + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Free_\', \'Loose_\', \'Rate_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Rate_' + Id + '" value="' + parseFloat(result[i].FCRate || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Loose_\', \'Rate_\', \'TaxId_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><select id="TaxId_' + Id + '" class="form-control smallTextbox borderno" onchange="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Rate_\', \'TaxId_\', \'DiscountPer_\', ' + Id + ',\'MTr_\')">' + TaxSelect + '</select></td>' +

                '<td width="4%"><input id="amoutwithdis_' + Id + '" value="0" class="form-control text-right smallTextbox dedisa borderno bg-white" disabled onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Free_\', \'Loose_\', \'Rate_\', ' + Id + ',\'MTr_\')" /></td>' +

                '<td width="3%"><input id="SR_' + Id + '" value="' + parseFloat(result[i].SellingRate || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeydown="FocusNext(event, \'Discount_\', \'SR_\', \'MRP_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="MRP_' + Id + '" value="' + parseFloat(result[i].MRP || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeydown="FocusNext(event, \'SR_\', \'MRP_\', \'Margin_\', ' + Id + ',\'MTr_\')" /></td>' +


                '<td width="3%"><input id="Discount_' + Id + '" value="' + parseFloat(result[i].FCDiscount || 0).toFixed(Decimal) + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeyup="CalcDiscRow(' + Id + ',0,1)" onkeydown="FocusNext(event, \'DiscountPer_\', \'Discount_\', \'SR_\', ' + Id + ',\'MTr_\')" /></td>' +


                '<td width="3%"><input id="DiscountPer_' + Id + '" value="' + DiscPer + '" class="form-control text-right smallTextbox borderno" onkeypress="isNumber(event, this)" onkeyup="CalcDiscRow(' + Id + ',1,1)" onkeydown="FocusNext(event, \'TaxId_\', \'DiscountPer_\', \'Discount_\', ' + Id + ',\'MTr_\')" /></td>' +
                ...
                '<td width="5%"><input id="FCTax_' + Id + '" value="0" class="form-control text-right smallTextbox dedisa borderno bg-white" disabled /></td>' +
                '<td width="5%"><input id="FCAmt_' + Id + '" value="0" class="form-control text-right smallTextbox dedisa borderno bg-white" disabled /></td>' +
                '<td width="5%"><input id="Margin_' + Id + '" value="' + parseFloat(result[i].Margin || 0).toFixed(Decimal) + '"  class="form-control text-center smallTextbox borderno" onkeyup="CalcSellingPriceWithMargin(' + Id + ')" onkeypress="isNumber(event, this)" onkeydown="FocusNext(event, \'MRP_\', \'Margin_\', \'\', ' + Id + ',\'MTr_\')" /></td>' +
    ...
    if (result.length > 0) {
        ...
        for (var i = 0; i < result.length; i++) {
            ...
            var ProductRow = '<tr id="MTr_' + Id + '" onfocusout="UpdateRow(' + Id + ')">' +
                '<td width="2%" align="center"><input class="jsgrid-button jsgrid-delete-button" type="button" onclick="DeleteRow(' + Id + ')" title="Delete" autocomplete="off"></td>' +
                '<td width="2%" align="center" id="MTd_' + Id + '">' + Id + '</td>' +
                '<td width="10%"><input id="Product_' + Id + '" value="' + result[i].ItemCode + '" onkeyup="LoadProduct(' + Id + ')" class="form-control smallTextbox borderno" /></td>' +
                '<td width="3%"><input id="Batch_' + Id + '" value="' + result[i].Batch + '" class="form-control smallTextbox borderno" onkeydown="FocusNext(event, \'\', \'Batch_\', \'Expiry_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Expiry_' + Id + '" value="' + result[i].Expiry + '" class="form-control text-center smallTextbox borderno"  onkeypress="isNumberDate(event, this)" onkeyup="ExpiryDate(\'Expiry_' + Id + '\')" onkeydown="FocusNext(event, \'Batch_\', \'Expiry_\', \'Pack_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Pack_' + Id + '" value="' + result[i].Pack + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Expiry_\', \'Pack_\', \'Qty_\', ' + Id + ',\'MTr_\')" /></td>' +
                '<td width="3%"><input id="Qty_' + Id + '" value="' + result[i].Quantity + '" class="form-control text-center smallTextbox borderno" onkeypress="isNumberInt(event, this)" onkeyup="CalcAmt(),ResetBillDiscount()" onkeydown="FocusNext(event, \'Pack_\', \'Qty_\', \'Free_\', ' + Id + ',\'MTr_\')" /></td>' +
    ...
    if ($('#ProductId_0').val() != 0) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                var ProdRow = "<thead><tr><th>Invoice No</th><th>Date</th><th>Supplier</th><th>Supp_No</th><th>Quantity</th><th>Cost</th><th>AvgCost</th><th>Location</th><th>Currency</th><th>Department</th><th>Sel Rate</th><th>MRP</th></tr>" +
                    "<tr><th>Invoice No</th><th>Date </th><th>Supplier</th><th>Supp_No</th><th>Quantity</th><th>Cost</th><th>AvgCost</th><th>Location</th><th>Currency </th><th>Department</th><th>Sel Rate</th><th>MRP</th></tr></thead><tbody>";
                var Qty = 0;
