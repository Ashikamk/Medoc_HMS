...
function LoadIPAdvancedetails(result) {
    ...
    for (var i = 0; i < result.length; i++) {
        ...
        if (result[i].Date == 'TOTAL') {
            ...
            $('#printpaydetails').text('Total Receved Amount :'  + result[i].RecAmount + '                 Total Bill Amount   ' + result[i].billAmount)
            ...
            if (result[i].BillType == 'AF') {
                ...
                var ProdEditRow = "<tr class='jsgrid-row Billtr' id='Brow_" + id + "'>" +
                   ...
                   /* "<td class='jsgrid-cell p-1 GridBRow' id='BillDate_" + id + "'  style= 'width:50px;' >" + result[i].Date + "</td>" +*/
                    "<td class='jsgrid-cell p-1 GridBRow'   style= 'width:50px;display:none' >  <input id='Ippdays" + id + "' type=hidden value=" + result[i].IPNumber + ">     <input id='IppId" + id + "' type=hidden value=" + result[i]. BillSeries+">   ROOM SERVICE</td>" +
                    "<td class='jsgrid-cell p-1 GridBRow' id='Ippname" + id + "'  colspan=4 style= 'width:15%;' >" + result[i].Paytype + "</td>" +
    ...
    if (result.length != 0) {
        ...
        for (var n = 0; n < result.length; n++) {
            ...
            ProdRow += "<tr class='jsgrid-row' ondblclick='ngOnDestroy(),copyrefresh(2),GetBillDetails(" + result[n].BillYear + ", " + result[n].BillNo + ", " + result[n].DeptId + ");'>" +
                ...
                "<button class='btn white btn-round btn-xs' type='button' style='background-color:#FF9800;font-size:smaller;margin:0' onclick='ngOnDestroy(),copyrefresh(2),GetBillDetails(" + result[n].BillNo + ", " + result[n].DeptId + ");' data-toggle='tooltip' data-placement='top' data-original-title=View><i class='ft-eye'></i></button>" +
                "</td>" +
...
function SaveAndUpdate(flg) {
    ...
    else if (parseFloat($('#GrandTotal').text()||0) <= 0) {
    ...
    for (var k = 1; k <= Count; k++) {
        ...
        if (TestId != undefined) {
            oArray.push({
                ...
                'SurgeryDate': SurgeryDate + '#' + a + '#' + b + '#' + c + '#' + AdAmount + '#' + Billamount + '#' + BILLYR,
                'Remarks': Remarks
            })
        }
        //console.log(oArray)
