...
function ShowCaseSheetGet(result, Flag) {
    ...
    if (result[0].SendSMS == 'YES') { $('#SendSMS').prop('checked', true) } else { $('#SendSMS').prop('checked', false) }
    ...
    for (var i = 0; i < result.length; i++) {
        ...
        if (result[i].IPNumber != 0) {
            ...
            var Visit = '<tr class="jsgrid-header-row VRow" style=' + AAAA + ' >' +
                       ...
                       '<td onclick=CallIPCaseLoad(' + result[i].IPNumber + ') class="jsgrid-align-center" style="width: 10%;cursor:pointer"><input type=text readonly class="form-control" style="background-color:white;border:none" value="' + result[i].RevisitId + '" ></td>' +
                       '<td onclick=CallIPCaseLoad(' + result[i].IPNumber + ') class="" style="width: 15%;cursor:pointer"><input type=text readonly class="form-control ' + scls + '" style="background-color:white;border:none" value="' + TDate + '" ></td>' +
                       ...
                       '<td onclick=CallIPCaseLoad(' + result[i].IPNumber + ') class="" style="width: 42%;cursor:pointer"><input type=text readonly class="form-control" style="background-color:white;border:none" value="' + result[i].DoctorName + '" ></td>' +
        ...
        else
        {
            var Visit = '<tr class="jsgrid-header-row VRow"  >' +
                     ...
                     '<td onclick=CallCaseLoad(' + result[i].DoctorId + ',2,' + slno + ') class="jsgrid-align-center" style="width: 10%;cursor:pointer"><input type=text readonly class="form-control" style="background-color:white;border:none" value="' + result[i].RevisitId + '" ></td>' +
                     '<td onclick=CallCaseLoad(' + result[i].DoctorId + ',2,' + slno + ') class="" style="width: 15%;cursor:pointer"><input type=text readonly class="form-control ' + scls + '" style="background-color:white;border:none" value="' + TDate + '" ></td>' +
                     ...
                     '<td onclick=CallCaseLoad(' + result[i].DoctorId + ',2,' + slno + ') class="" style="width: 42%;cursor:pointer"><input type=text readonly class="form-control" style="background-color:white;border:none" value="' + result[i].DoctorName + '" ></td>' +
                     '<td class="" style="width: 5%;cursor:pointer" align=center>' +
...
function PrevVisitDetails(result, Flag) {
    ...
    if (result.length > 0) {
        ...
        Head = Head + '<span class="mx-2">,Review Date : </span>';
...
function AddMedicineRow(flg)      //flg-0 : Add Medicine
{
    if (flg == 0) {
        ...
        '<td class="" style="width: 20%;"><input type="text" class="form-control mdclass brdles"  name="Notes" id="mednote' + Id + '" /></td>' +
