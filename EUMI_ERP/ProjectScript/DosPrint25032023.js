...
function PrintthisBillHospitalSales(Type, Rowlen, Flag) {
   ...
   // Line += '<tr><td>' + Leftalign + '</td><td>' + ("            " + Space).substring(0, 15) + 'DLNO:KL-KLM-155472,KL-KLM-155473                              </td></tr>'
    ...
    Line += '<tr><td>' + Leftalign + '</td><td>' + ("MR No  :" + $('#HRegNo').val() + Space).substring(0, 50) + (' Bill No:' + BillNo + Space).substring(0, 18) +'</td></tr>'
    Line += '<tr><td>' + Leftalign + '</td><td>' + ("Patient:" + $('#HPatient').val() + Space).substring(0, 50) + (' Date   :' + $('#HSalesDate').val() + Space).substring(0, 19) + ' '+  h + ':' + m + '</td></tr>'
    Line += '<tr><td>' + Leftalign + '</td><td>' + ("Doctor :" + Doctor + Space).substring(0, 50) + (' User   :' +BUSER + Space).substring(0, 18)  +' </td></tr>'
...
function PrintthisBillHospitalSales11(Type, Rowlen, Flag) {
    ...
    Line += '<tr><td align=center>' + Break + '</td></tr>'
    Leftalign = '';
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Bill No:' + BillNo + Space).substring(0, 40) + ('Date   :' + $('#HSalesDate').val() + Space).substring(0, 20) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'

    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Patient:' + $('#HPatient').val() + Space).substring(0, 40) + ("Doctor :" + Doctor + Space).substring(0, 30) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'

    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('MR No# :' + $('#HRegNo').val() + Space).substring(0, 40) + ("OP NO# :" + $('#HOpNo').val() + Space).substring(0, 30) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
     Line += '<tr><td>' + Break + '</td></tr>'
    //Header with bold
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(15) + '</td><td>Item                        MRP       Rate    Qty     Amount' + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'             //'MRP       Taxable      Tax     ':31  chars
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(15) + '</td><td>Batch                       Exp' + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'             //'MRP       Taxable      Tax     ':31  chars
    ...
    for (var i = 1; i <= Rowlen; i++) {
        ...
        if ($.trim($('#Product' + Id).val()) != undefined && $.trim($('#Product' + Id).val()) != 'undefined' && $.trim($('#Product' + Id).val()) != ' ' && $.trim($('#Product' + Id).val()).length > 0) {
            ...
            Line += '<tr><td>' + Leftalign + '</td><td>' + String.fromCharCode(27) + String.fromCharCode(15) + (Descr + Space).substring(0, 24) + "   " + PACKRATE.substring(PACKRATE.length - 7, PACKRATE.length) + "   " + Rate + "    " + Qty.substring(Qty.length - 3, Qty.length) + "   " + Amnt + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>';  //+ Mrp.substring(Mrp.length - 10, Mrp.length) + " " + Taxable.substring(Taxable.length - 10, Taxable.length) + " " + Tax.substring(Tax.length - 10, Tax.length) + " "
            Line += '<tr><td>' + Leftalign + '</td><td>' + String.fromCharCode(27) + String.fromCharCode(15) + (Batch + Space).substring(0, 24) + "      " + Exp.substring(0, 12) +  String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>';  //+ Mrp.substring(Mrp.length - 10, Mrp.length) + " " + Taxable.substring(Taxable.length - 10, Taxable.length) + " " + Tax.substring(Tax.length - 10, Tax.length) + " "
    ...
    if (Gstno != ' ') {
        ...
        if ($('#hiddensplittaxable_5').val() != 0) {
            Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ' 5%      ' + Taxable5.substring(Taxable5.length - 7, Taxable5.length) + '       ' + CGST5.substring(CGST5.length - 7, CGST5.length) + '    ' + CGST5.substring(CGST5.length - 7, CGST5.length) + '    ' + Tax5.substring(Tax5.length - 10, Tax5.length) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
        }
        if ($('#splittaxable_12').val() != 0) {
            Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + '12%      ' + Taxable12.substring(Taxable12.length - 7, Taxable12.length) + '       ' + CGST12.substring(CGST12.length - 7, CGST12.length) + '    ' + CGST12.substring(CGST12.length - 7, CGST12.length) + '    ' + Tax12.substring(Tax12.length - 10, Tax12.length) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
        }
        if ($('#splittaxable_18').val() != 0) {
            Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + '18%      ' + Taxable18.substring(Taxable18.length - 7, Taxable18.length) + '       ' + CGST18.substring(CGST18.length - 7, CGST18.length) + '    ' + CGST18.substring(CGST18.length - 7, CGST18.length) + '    ' + Tax18.substring(Tax18.length - 10, Tax18.length) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
        }
        if ($('#splittaxable_28').val() != 0) {
            Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + '28%      ' + Taxable28.substring(Taxable28.length - 7, Taxable28.length) + '       ' + CGST28.substring(CGST28.length - 7, CGST28.length) + '    ' + CGST28.substring(CGST28.length - 7, CGST28.length) + '    ' + Tax28.substring(Tax28.length - 10, Tax28.length) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
        }
    }
    Line += '<tr><td>' + Break + '</td></tr>'
