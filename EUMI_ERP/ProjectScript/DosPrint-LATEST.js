...
function PrintthisBillHospitalSalesReturn(Type, Rowlen, Flag) {
    ...
    var AmountinWords = withDecimal1($('#BaseTextTotal').text())
    ...
    Address = Space.substring(0, Head2Length) + Address
    PhoneNo = Space.substring(0, Head3Length) + PhoneNo
    Gstno = Space.substring(0, Head4Length) + Gstno
    Add2 = Space.substring(0, Head5Length) + Fax

    var HLeftalign = "         ";
    Line = "<tr><th></th></tr>";
    Line += '<tr><td>' + String.fromCharCode(27) + String.fromCharCode(69) + '</td></tr>'   //bold on
    Line += '<tr><td align=center>' + HLeftalign + Hosp + '       </td></tr>'
    Line += '<tr><td align=center>' + HLeftalign + Address + '   </td></tr>'
    if (Add2 != '') {
        // Line += '<tr><td align=center>  ' + HLeftalign + Add2 + '   </td></tr>'
    }

    // Line += '<tr><td align=center>        VARAPUZHA ,PH-0484 2516313</td></tr>'
    Line += '<tr><td align=center>' + HLeftalign + PhoneNo + '   </td></tr>'
    //Line += '<tr><td align=center>' + HLeftalign + Gstno + '   </td></tr>'
    Line += '<tr><td>' + HLeftalign + String.fromCharCode(27) + String.fromCharCode(70) + '</td></tr>'//bold off
    Line += '<tr><td align=center>' + Break + '</td></tr>'
    Leftalign = ' ';
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Reg No :' + $('#HRegNo').val() + Space).substring(0, 55) + ('Op No  :' + $('#HOpNo').val() + Space).substring(0, 25) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'

    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Return No:' + BillNo + Space).substring(0, 55) + ('Date   :' + $('#HSalesDate').val() + Space).substring(0, 25) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ("Patient:" + $('#HPatient').val() + Space).substring(0, 55) + ("Doctor :" + Doctor + Space).substring(0, 23) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
    Line += '<tr><td>' + Break + '</td></tr>'
    //Header with bold
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(15) + '</td><td>Item                              Batch            Exp      Qty      Rate      Amount' + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'             //'MRP       Taxable      Tax     ':31  chars
    Line += '<tr><td>' + Break + '</td></tr>'
    ...
    for (var i = 1; i <= Rowlen; i++) {
        ...
        if ($.trim($('#Product' + Id).val()) != undefined && $.trim($('#Product' + Id).val()) != 'undefined' && $.trim($('#Product' + Id).val()) != ' ' && $.trim($('#Product' + Id).val()).length > 0) {
            ...
            Line += '<tr><td>' + Leftalign + '</td><td>' + String.fromCharCode(27) + String.fromCharCode(15) + (Descr + Space).substring(0, 35) + " " + (Batch + Space).substring(0, 15) + " " + Exp.substring(0, 10) + Qty.substring(Qty.length - 3, Qty.length) + "    " + Rate + "  " + Amnt + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>';  //+ Mrp.substring(Mrp.length - 10, Mrp.length) + " " + Taxable.substring(Taxable.length - 10, Taxable.length) + " " + Tax.substring(Tax.length - 10, Tax.length) + " "
    ...
    Line += '<tr><td>' + Break + '</td></tr>'
    var TotalLine1 = '                                                        Total :' + ($('#BaseTextTotal').text());
    ...
    { Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + 'CGST 2.5%  on ' + $('#hiddensplittaxable_5').val() + '  ' + $('#CGST_5').val() + '   SGST 2.5% on ' + $('#hiddensplittaxable_5').val() + ' ' + $('#CGST_5').val() + String.fromCharCode(27) + String.fromCharCode(15) + '</td></tr>' }
    if ($('#splittaxable_12').val() != 0)
    { Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + 'CGST 6.0%  on ' + $('#hiddensplittaxable_12').val() + '  ' + $('#CGST_12').val() + '   SGST 6.0% on ' + $('#hiddensplittaxable_12').val() + ' ' + $('#CGST_12').val() + String.fromCharCode(27) + String.fromCharCode(15) + '</td></tr>' }
    if ($('#splittaxable_18').val() != 0)
    { Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + 'CGST 9.0%  on ' + $('#hiddensplittaxable_18').val() + '  ' + $('#CGST_18').val() + '   SGST 9.0% on ' + $('#hiddensplittaxable_18').val() + ' ' + $('#CGST_18').val() + String.fromCharCode(27) + String.fromCharCode(15) + '</td></tr>' }
    if ($('#splittaxable_28').val() != 0)
    { Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + 'CGST14.0%  on ' + $('#hiddensplittaxable_28').val() + '  ' + $('#CGST_28').val() + '   SGST14.0% on ' + $('#hiddensplittaxable_28').val() + ' ' + $('#CGST_28').val() + String.fromCharCode(27) + String.fromCharCode(15) + '</td></tr>' }

    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(69) + (AmountinWords).substr(0, 100) + String.fromCharCode(27) + String.fromCharCode(70) + '</td></tr>'
    ...
    PrintDosPrintHospitalSales('printbill');
...
function PrintthisBillHospitalSales(Type, Rowlen, Flag) {
    ...
    Line += '<tr><td align=center>' + Break + '</td></tr>'
    Leftalign = ' ';
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Reg No :' + $('#HRegNo').val() + Space).substring(0, 50) + ('Op No  :' + $('#HOpNo').val() + Space).substring(0, 30) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'

    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ('Bill No:' + BillNo + Space).substring(0, 50) + ('Date   :' + $('#HSalesDate').val() + Space).substring(0, 30) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(15) + ("Patient:" + $('#HPatient').val() + Space).substring(0, 50) + ("Doctor :" + Doctor + Space).substring(0, 30) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'
    Line += '<tr><td>' + Break + '</td></tr>'
    //Header with bold
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(15) + '</td><td>Item                              Batch            Exp      Qty      Rate      Amount' + String.fromCharCode(27) + String.fromCharCode(69) + String.fromCharCode(27) + String.fromCharCode(18) + '</td></tr>'             //'MRP       Taxable      Tax     ':31  chars
    Line += '<tr><td>' + Break + '</td></tr>'
    ...
    Line += '<tr><td>' + Break + '</td></tr>'
    var TotalLine1 = '                                                        Total :' + ($('#BaseTextTotalProc').text());
    Line += '<tr><td>' + Leftalign + String.fromCharCode(27) + String.fromCharCode(69) + TotalLine1 + String.fromCharCode(27) + String.fromCharCode(70) + '</td></tr>'
...
function PrintthisBillHospitalSales1(Type, Rowlen, Flag) {
    $('#DosPrinthms').html('');
    var Line = "";
...
function PrintthisBillHospitalSalesReturn1(Type, Rowlen, Flag) {
    ...
    PrintDosPrintHospitalSalesReturn('printbill'); 
}
...
function PrintthisBillLabDotmatrix(Rowlen, Type) {
    ...
    var OPNo = $.trim($('#RegNo').val()) + Space; var IPNo = $.trim($('#IpNo').val()) + Space;
    ...
    Line += '<tr><td>' + Leftalign + '</td><td>' + ("Reg No :" + OPNo + Space).substring(0, 22)                + '       ' + 'Bill No :' + BillNo + '</td></tr>'
    ...
    Line += '<tr><td>' + Leftalign+(AmountinWords + ' Only' + Leftalign).substr(0, Leftalign.length - 1) + String.fromCharCode(27) + "F" + '</td><td></td></tr>'
