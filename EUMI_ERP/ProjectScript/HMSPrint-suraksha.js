...
function PrintTestResult(Rowlen) {
    ...
    $(powerdby).css('height', 25); $(powerdby).css('width', 180);
   // myWindow.document.write('<span style="font-family: tahoma; font-size:10px;font-weight: bold;position:fixed;bottom:0"><table cellpadding=0 cellspacing=0><tr><td style="font-family: tahoma; font-size:10px;font-weight: bold;">Powered by</td></tr> <tr><td style="font-family: tahoma; font-size:10px;font-weight: bold;">' + (powerdby.outerHTML) + '</td></tr> </table></span>')
    ...
    myWindow.document.write('<table width=100%><tr><td height=96px></td></tr></table>');

    myWindow.document.write('<table style="font-family:tahoma;font-size:13px;" width=100%><tr><td width=150px></td><td width=450px>' + $("#PatientName").val() + '</td><td>' + $("#BillDate").val() + '</td></tr>   <tr><td></td><td>' + $("#Age").val() + ', ' + $("#Gender").val() + '</td><td>' + $("#ResultDate").val() + '</td></tr>  <tr><td></td><td>' + $("#Doctor option:selected").text() + '</td><td></td></tr>   <tr><td></td><td>' + $("#RegNumber").val()  + '</td><td></td></tr>  </table>');
    ...
    myWindow.document.write('<table width=100% style="border-collapse: collapse;font-family:tahoma;font-size:13px;"><tr>' +
        '<td class="p-0" style="width:45%;font-weight:bold;"></td>' +
        '<td class="p-0" style="width:25%;font-weight:bold;"></td>' +
        '<td class="p-0" style="width:30%;font-weight:bold;"></td><tr>');
    myWindow.document.write('<tr><td colspan=3 class="p-0" height="40" ></td><tr>');
