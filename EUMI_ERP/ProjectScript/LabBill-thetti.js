...
$(document).ready(function () {
    ...
    $("#btnemail").click(function (e) {
        var data = {};
            ...
            {
                type: "POST",
                url: "../Revisit/HMS_sentresultemail",
                data: data,
...
function GetViewList(result)
{
        ...
        if (result.length != 0) {
            ...
            for (var n = 0; n < result.length; n++) {
                ...
                ProdRow += "<tr class='jsgrid-row' ondblclick='ngOnDestroy(),copyrefresh(2),GetBillDetails(" + result[n].BillNo + ", " + result[n].DeptId + ");'>" +
...
function LoadBillSearch()
{
    $("#BillNoCopy").autocomplete({
        ...
        autoFocus: true,
        select: function (event, ui) {
            GetBillDetails(ui.item.BillNo, ui.item.DeptId);
        },
    });
}

function GetBillDetails(BillNo, DeptId)
{
    var data = {};
    data.BillNo = BillNo;
    data.DeptId = DeptId;
