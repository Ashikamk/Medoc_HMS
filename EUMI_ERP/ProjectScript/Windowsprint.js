...
function PrintthisBillHMSSales(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    $(GasLogo).css('height', 150); $(GasLogo).css('width', 300);
    ...
    myWindow.document.write('<table width=80% ><tr ><td width=100% align=left  style=color:#008000;font-weight:bold>' + (GasLogo.outerHTML) + '</td></tr>');
    //myWindow.document.write('</table>');
   ...
   //myWindow.document.write('<table  width=100% ><tr align=center><td style="font-size: 1.2em;">' + window.CompanySettingsArray.CompanyName + '</td></tr><tr><td  align=center style="font-size: 0.7em;">' + window.CompanySettingsArray.Address + '</td></tr><tr><td  align=center style="font-size: 0.7em;" colspan=6>' + window.CompanySettingsArray.Email + '</td></tr><tr><td  align=center style="font-size: 0.7em;border-bottom:0px solid black">' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
    ...
    myWindow.document.write('<table style="font-family:tahoma;font-size:80%;border-top:1px solid grey;border-left:1px solid grey;border-right:1px solid grey" width=100% ><tr ><td width=10% align=left >OP#</td><td colspan=4 align=left width=50%>' + $('#HOpNo').val() + '</td><td align=right width=10%>Bill No&#160;</td><td  colspn=2 width=20% >:' + SNo + '</td></tr>');
   ...
   // style = "font-family:tahoma;font-size:80%;
    HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td colspan=9 align=center width=28%>Product</td><td width=5% align=center>Qty.</td><td align=center width=5%>Rate</td><td align=center width=5%>Amount</td></tr>';

    myWindow.document.write('<table style="border-collapse:collapse;font-family:tahoma;font-size:80%;" frame="box" width=100% bordercolor="grey">' + HeaderRow);
    var slnm = 0;
    for (var i = 0; i <= Rowlen; i++) {
        var Id = parseInt(i + 1);
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr class=brtd2 ><td colspan=9 style="padding-left:5px">' + $('#Product' + Id).val() + '</td><td align=center style="padding-left:5px">' + $('#Quantity' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px">' + $('#Amount' + Id).val() + '</td></tr><tr class=brtd2><td colspan=9 style="padding-left:5px">' + $('#ProductDesc' + Id).val() + '       ' + $('#Expiry' + Id).val() + '</td><td></td><td align=right><del>' + $('#PurPrice' + Id).val() + '</del></td><td></td></tr>');
    ...
    for (var i = 1; i <= Prlen; i++) {
        ...
        if ($('#Procedure' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr class=brtd2 ><td colspan=9 style="padding-left:5px">' + $('#Procedure' + Id).val().substring(0, 20) + '</td><td></td><td></td><td></td><td></td><td align=right style="padding-right:5px">' + $('#ProcTot' + Id).val() + '</td></tr>');
    ...
    for (var a = 0; a <=2 ; a++) {
        ...
        myWindow.document.write('<tr class=brtd2 ><td colspan=9 style="padding-left:5px"></td><td style="padding-left:5px"></td><td style="padding-left:5px"></td><td align=center style="padding-left:5px"></td></tr>');
      }
    ...
    myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td colspan=9 font-size: 10px;" align=left style="font-weight:bold"></td><td style="font-family:tahoma;font-size: 13px;border-left:1px solid grey;" align=center colspan=2><b>Total</b></td><td style="font-family:tahoma; font-size: 13px;border-left:1px solid grey;"  align=right colspan=2><b>' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>');

    myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td align=center colspan=13 style="font-family:tahoma;font-size: 13px;"><b>YOUR  ' + $('#savingvalue').text() + '</b></td></tr>');
...
function PrintthisBillHMSSalesReturn(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    myWindow.document.write('<table  width=100% ><tr height=10px;><td style="font-family:tahoma;font-size:80%;">' + GSTINNO + '</td>  <td colspan=4 align=right style="font-family:tahoma;font-size:80%;"></td></tr><tr><td colspan=8 style="border-top:1px solid black;font-family:tahoma;font-size:80%;"></td></tr>');
    myWindow.document.write('<tr><td  style="font-family:tahoma;font-size:80%;width=35%;"><b>DEPARTMENT : PHARMACY</b></td>    <td width=40% style="font-family:tahoma;font-size:80%;align=center;" ><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;SALES RETURN BILL</b></td>     <td width=25% style="font-family:tahoma;font-size:80%;align=left;" ><b>&#160;&#160;&#160;BILLNO  : &#160;' + BillNo + '/' + PTYPE + '</b><td></tr>');
    myWindow.document.write('<tr><td colspan=8 style="border-top:1px solid black;"></td></tr></table>');
    var TypeText = '';
    TypeText += '<td >Paytype</td><td>:' + $('#PayType :selected').text() + '</td>';
    ...
    var HeaderRow = '';
    HeaderRow = ' <tr  style="font-family:tahoma;border:1px solid black;font-size:12px;"><td align=center width=3%>SLNO</td><td colspan=7 align=left width=20%>&#160;&#160;&#160;&#160;&#160;PRODUCT</td><td width=5% align=center>BATCH</td><td width=5% align=center>MFR</td><td width=5% align=center>EXPIRY</td><td width=5% align=center>QTY.</td><td align=right width=5%>MRP</td><td width=6% align=center>DIS RATE</td><td align=right width=5%>AMOUNT</td></tr>'
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#Product' + Id).length) {
            ...
            Rowcount += 1;
            line += 1;
            myWindow.document.write('<tr><td style="border-left:0px solid grey;font-size:11px;" align=center>' + $('#tdSl' + Id).text() + '</td><td colspan=7 style="padding-left:5px;font-size:11px;">&#160;&#160;&#160;&#160;&#160' + $('#Product' + Id).val() + '</td><td style="padding-left:5px;font-size:11px;">' + $('#ProductDesc' + Id).val() + '</td><td style="padding-left:5px;font-size:11px;">' + $('#Company' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Expiry' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Quantity' + Id).val() + '</td><td align=right style="padding-left:5px;font-size:11px;">' + $('#PurPrice' + Id).val() + '</td><td style="padding-right:5px;font-size:11px;" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px;font-size:11px;">' + $('#Amount' + Id).val() + '</td></tr>');
    ...
    for (var a = 0; a <= (10 - slnm); a++) {
        ...
        myWindow.document.write('<tr ><td style="border-left:0px solid grey;font-family:tahoma;font-size:12;" align=center>&#160;</td><td colspan=7 style="padding-left:5px;font-family:tahoma;font-size:12;"></td><td style="padding-left:5px;font-family:tahoma;font-size:12;"></td><td style="padding-left:5px;font-family:tahoma;font-size:12;"></td><td align=center style="padding-left:5px;font-family:tahoma;font-size:12;"></td><td style="padding-right:5px;font-family:tahoma;font-size:12;" align=right></td><td align=right style="padding-right:5px;font-family:tahoma;font-size:12;"></td><td align=right style="padding-right:5px;font-family:tahoma;font-size:12;"></td><td align=right style="padding-right:5px;font-family:tahoma;font-size:12;"></td></tr>');
    }
    ...
    myWindow.document.write('<table width=100% style="border-right: 1px solid grey;border-left: 1px solid grey;border-bottom: 1px solid grey;border-collapse:collapse;">');
    myWindow.document.write('<tr style="height:80px;">');
    myWindow.document.write('<td font-family:tahoma;font-size:12;" align=center><table><tr><td style="font-family:tahoma;font-size:12;">Prepared By:</td></tr><tr><td align=center style="font-family:tahoma;font-size:12;">' + $('#UserDetsss').text() + '</td></tr></table></td>');
    ...
    if (($('#Discount').val() != 0)) {
        myWindow.document.write('<td width=25%> <table width=100%><tr><td style="font-family:tahoma;font-size:12;" >Amount</td><td align=right style="font-family:tahoma;font-size:12;">          ' + $('#TotalTaxable').val() + '           </td></tr>         <tr><td style="font-family:tahoma;font-size:12;">Total Tax</td><td  align=right style="font-family:tahoma;font-size:12;">' + $('#TotlaTax').val() + '</td></tr>                <tr><td style="font-family:tahoma;font-size:12;">Discount</td><td   style="font-family:tahoma;font-size:12;" align=right>' + addCommas(parseFloat($('#Discount').val()).toFixed(Decimal)) + '</td></tr>      <tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>' + addCommas(parseFloat($('#BaseTextTotal').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
    }
    else {
        myWindow.document.write('<td width=25%> <table width=100%><tr><td style="font-family:tahoma;font-size:12;" >Amount</td><td align=right style="font-family:tahoma;font-size:12;">          ' + $('#TotalTaxable').val() + '           </td></tr>         <tr><td style="font-family:tahoma;font-size:12;">Total Tax</td><td  align=right style="font-family:tahoma;font-size:12;">' + $('#TotlaTax').val() + '</td></tr>               <tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>' + addCommas(parseFloat($('#BaseTextTotal').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
    }
    ...
    if (($('#TotRoundOff').val() != 0)) {
        myWindow.document.write('<tr height=25px;><td colspan=8 style="font-family:tahoma;font-size:12; border-top:1px solid grey;"><table width=100%><tr><td style="font-family:tahoma;font-size:12;"width=15%>Amount In words :</td><td style="font-family:tahoma;font-size:12;"width=61%><b> ' + AmountinWords + '</b></td><td style="font-family:tahoma;font-size:12;"width=15% align=left>RoundOff</td><td style="font-family:tahoma;font-size:12;" align=right width=9%>' + $('#TotalCess').val() + '</td></tr></table></tr>');
    }
    else {
        myWindow.document.write('<tr height=25px;><td colspan=12 style="font-family:tahoma;font-size:12; border-top:1px solid grey;">Amount In words :&#160;' + AmountinWords + '</td></tr>');
...
function PrintthisBillLabwithlettertheadIPB(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    myWindow.document.write('<table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:12px;font-weight: bold;position:fixed;bottom: 10px;" width=100%><tr><td align=center>SPECIALITY CONSULTATION, CASUALITY, PHARMACY, LABORATORY, ECG</td></tr><tr><td align=center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
