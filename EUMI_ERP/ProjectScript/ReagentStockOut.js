    ...
    if (result.length == 0) {
        ...
        for (var i = 0; i < result.length; i++) {
            if (result[i].BillType == 'STOCKOUT') {
                ...
                CurrentBillNo = result[i].CurrentNo;
            }
        }
    ...
    $("#Product" + Id).autocomplete({
        ...
        source: function (request, response) {
            ...
            if (($('#HLocation').val() || 0) == 0) {
                ...
                data.UserId = ERPUserId;
                $.ajax({
                    url: '../Pharmacy/HMS_ReagentProductSearch',
                    type: "POST",
                    data: data,
                    dataType: "json",
                    success: function (data) {
        ...
        autoFocus: true,
        select: function (event, ui) {
            $('#Product' + Id).val(ui.item.ItemCode);
    ...
    $("#ProductDesc" + Id).autocomplete({
        ...
        source: function (request, response) {
            ...
            if (($('#ProductId' + Id).val() || 0) == 0) {
                ...
                data.Flag = 0;
                $.ajax({
                    url: '../Hospital/HMS_LabBatchwiseItemDetailsGets',
                    type: "POST",
                    data: data,
                    dataType: "json",
                    success: function (data) {
...
function SaveAndUpdate(flg) {
    ...
    if (oArray != "") {
        ...
        if (flg == 1) {
            ...
            $.ajax({
                type: "POST",
                url: "../Hospital/HMS_SalesInvoiceInsert_StockOut",
                data: data,
                success: function (result) {
        ...
        else if (flg == 2)                                            //Update  
        {
            ...
            $.ajax({
                type: "POST",
                url: "../Hospital/HMS_SalesInvoiceUpdteStockOut",
                data: data,
                success: function (result) {
...
function DeleteBill(Flag) {      //Flag=0:Delete Contract  
    ...
    $.ajax({
        type: "POST",
        url: "../Hospital/HMS_SalesInvoiceDeletestockout",
        data: data,
        success: function (result) {
