...
$(document).ready(function () {
    ...
    if (usermenu1.indexOf("M267") != -1) {
        debugger;
        $('#ChequeNo1Radio').attr('disabled', false);
...
function SaveAndUpdate() {
    if ($('#BankAccount').val() == '') {
        warningshow('Please Select Account', 'BankAccount');
    }
    else if (parseInt($('#BankAccount').val()||0) == '0') {
        warningshow('Please Select Account', 'BankAccount');
    }
    else {
        ...
        for (var i = 1; i < Count; i++) {
            if ($("#SlNoCheck" + i).is(":checked")) {
                var VoucherTypeId = 0;
                var VoucherDate = $('#vdateet').val() // $('#LayouEOD').text();
                var VoucherNo = 0;
                var VType = 'C';
                ...
                var BankId = $('#BankAccountId').val();// $('#BankId' + i).text();
                var ChequeDtTo = $('#ChequeNo' + i).text();
                var ChequeDate = $('#ChequeDate' + i).text();
                var BillSerId = $('#UPIrAmount' + i).val()
            ...
            if ($("#mybills").prop("checked")) {
                ...
                if ($('#UserDetsss').text() == result[l].Description) {
                    ...
                    responseText +=
                        ...
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:5%"  data-toggle="tooltip" data-placement="top" data-original-title=' + result[l].BankName + '-' + result[l].VoucherNo + '&#160;&#160;Amount&#160;&#160;:' + parseFloat(result[l].BaseAmount).toFixed(decimal) + '&#160;&#160;MRNO&#160;&#160;:' + result[l].ChequeDtTo + '&#160;&#160;Patient&#160;&#160;:' + result[l].AccDescription + '&#160;&#160;Bill-By-' + result[l].Description + '  id=' + 'BankName' + slno + '>' + result[l].BankName + '</td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:6%" id=' + 'VoucherDate' + slno + '>' + result[l].VoucherDate + '</td>' +
                        ...
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:6%" ><input type="text" value=' + result[l].CurrencyId + ' id=' + 'cashrAmount' + slno + ' class="form-control"></td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:6%;display:none"><input type="text" value=' + result[l].CurrencyRate + '  id=' + 'cardrAmount' + slno + ' class="form-control" ></td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:6%;display:none"><input type="text" value=' + result[l].CurrencyRate + '  id=' + 'UPIrAmount' + slno + ' class="form-control" ></td>' +
                        ...
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:7%;color:red" id=' + 'FCAmount' + slno + '><b>' + parseFloat(result[l].FCAmount).toFixed(decimal) + '</b></td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" id=' + 'usernm' + slno + ' style="width:10%">' + result[l].Description + '</td>' +
                        ...
                        '<td class= "jsgrid-cell jsgrid-align-center" style="display:none" id=' + 'FCAmount' + slno + '>' + parseFloat(result[l].FCAmount).toFixed(decimal) + '</td>' +
                        ...
                        '<td class="jsgrid-align-center crspnt" style="width:2%" onclick=DeleteRow(0,' + slno + ')><i class="icon-trash"></i></td>' +
                        '</tr>';
                }
            ...
            if (result[l].BankName == $('#TransferDate').val()) {
                ...
                if ($("#mybills").prop("checked")) {
                    ...
                    responseText +=
                        ...
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:7%" id=' + 'FCAmount' + slno + '>' + result[l].FCAmount + '</td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" id=' + 'usernm' + slno + ' style="width:10%">' + result[l].Description + '</td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:5%;display:none" i id=' + 'VoucherTypePrefix' + slno + '>' + result[l].VoucherTypePrefix + '</td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:4%;display:none" id=' + 'AccCode' + slno + '>' + result[l].AccCode + '</td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:7%;display:none" id=' + 'AccId' + slno + '>' + result[l].AccId + '</td>' +
                        '<td class= "jsgrid-cell jsgrid-align-center" style="width:17%;display:none" id=' + 'Description' + slno + '>' + Desc + '</td>' +
                        '<td class= "recamountcss jsgrid-cell jsgrid-align-center" style="width:5%;display:none" id=' + 'RefNo' + slno + '>' + Ref + '</td>' +
