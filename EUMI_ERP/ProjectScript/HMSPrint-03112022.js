...
function PrintTestResult1(Rowlen) {
    ...
    var linecount = 0; var DeptFlag = 0;
    for (var i = 1; i <= Rowlen; i++) {
        ...
        if (Dept != CurrentDept) {
            ...
            if (DeptFlag == 0) {
                ...
                var TR = parseInt(40 - linecount)
               
                myWindow.document.write('<tr><td colspan=3 class="p-0" style=" border:0px solid black;"><table style="font-family:tahoma;"  width=100%><tr><td height=20px></td></tr><tr><td colspan=3 align=center>*****  END OF REPORT  *****</td></tr><tr><td height=20px colspan=3 align=center>&#160;</td></tr><tr><td align=left></td><td width=400px align=center></td><td align=center>&#160;Approved By</td></tr><tr><td align=left></td><td width=400px align=center></td><td align=center>&#160;' + (SignPrint.outerHTML) + ' </td></tr><tr><td align=left></td><td width=400px align=center></td><td align=center>&#160;' + $('#UserDetsss').text() + '<br>LAB TECHINCIAN </td></tr></table></td></tr>');
                var TR = parseInt(33 - linecount)
                
                for (var d = 0; d <= TR; d++) {
                   
                   // myWindow.document.write('<tr><td colspan=3 class="p-0" style=" border:0px solid black;">&#160;</td><tr>');
                }
                //linecount = 5;

                myWindow.document.write('<tr><td align=left colspan=3><table  style="" width=100%><tr><td width=60%><table style="font-family: tahoma; font-size:13px;font-weight: bold;">' +
                    '<tr><td>MR-No#</td><td> : </td><td>' + $("#RegNumber").val() + '</td></tr>' +
                    '<tr><td>Name</td><td> : </td><td>' + $("#PatientName").val() + '</td></tr>' +
                    '<tr><td>Spec_Collected</td><td> : </td><td>' + $("#BillDate").val() + '</td></tr>' +
                    '<tr><td>Doctor</td><td> : </td><td>' + $("#Doctor option:selected").text() + '</td></tr></table></td>');
                ...
                myWindow.document.write('<td  width=40% align="right"><table  style="font-family:tahoma; font-size:13px;font-weight: bold;">' +
                    ...
                    '<tr><td>Age & Sex</td><td> : </td><td>' + $("#Age").val() + ', ' + $("#Gender").val() + '</td></tr>' +
                    '<tr><td>Spec_Rcvd</td><td> : </td><td>' + $("#ResultDate").val() + '</td></tr>' +
                    '<tr><td>Date</td><td> : </td><td>' + $("#ResultDate").val() + ' ' + $("#ResultTime").val() + '</td></tr></table></td></tr></table></td></tr>');
...
function PrintTestResult(Rowlen) {
    ...
    if (LB == 1) {
        myWindow.document.write('<table style="font-family: tahoma;" width=100%><tr>' +
            '<tr><td style="font-size:22;font-weight:bold;" align=center>' + window.CompanySettingsArray.CompanyName + '</td></tr>' +
            '<tr><td style="font-size:18;font-weight: bold;" align=center>' + window.CompanySettingsArray.Address + '</td></tr>' +
            '<tr><td style="font-size:18;font-weight: bold;" align=center >' + window.CompanySettingsArray.Email + '</td></tr>' +
            '<tr><td style="font-size:18;font-weight: bold;" align=center>' + window.CompanySettingsArray.PhoneNo + '</td></tr>' +
            '<tr><td  style="' + BorderX + '"></td></tr>' +
            '</table>');
    }
    else if (LB == 2) {
