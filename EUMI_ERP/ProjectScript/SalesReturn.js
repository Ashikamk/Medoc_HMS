...
$(document).ready(function () {
            ...
            if (flg == 0) {
                ...
                if ($("#SlNoCheckSIItem" + m).is(":checked")) {
                    ...
                    var ProdRow1 = "<tr id=" + 'row' + id + " class='jsgrid-row' onfocusout='updaterow(" + id + ")'>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-right' style='width:75px;text-align:center'><input type='text' id=" + 'Bilseries' + id + " style='display:none' value='" + srsno + "' /><input type='text' id=" + 'Bilnumbr' + id + " style='display:none' value='" + srlno + "' /><input type='text' id=" + 'salesubid' + id + " style='display:none' value='" + slssubid + "' /><input type='text' id=" + 'PrdtId' + id + " style='display:none' value='" + ProductId + "' /><input type='text' style='height:30px;background-color:white' disabled='' class='form-control text-left' id=" + 'txtproduct' + id + " value='" + Productcode + "'></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px'><select disabled='' id=" + 'select_unit' + id + " style='background-color:white;height:30px' class='form-control' onchange='changeunit(" + id + ",this)' onkeydown=Focusnextgrid(event,'u'," + id + ") onfocusout=focusoutgrid('u'," + id + ") onfocusin=focusingrid('u'," + id + ")>" + UnitSelect + "</select></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:30px'><select style='background-color:white;height:30px' disabled='' id=" + 'select_tax' + id + " class='form-control' onchange='ChangeTax(" + id + ",this)' onkeydown=Focusnextgrid(event,'t'," + id + ") onfocusout=focusoutgrid('t'," + id + ") onfocusin=focusingrid('t'," + id + ")>" + TaxSelect + "</select></td>" +
                        ...
                        "<td class='jsgrid-cell jsgrid-align-center' style='width:40px'><select disabled='' id=" + 'select_location' + id + " style='background-color:white;height:30px' class='form-control' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
                        "</tr>";
    ...
    $("#btnprdtadd4").click(function (e) { 
        ...
        if ($('#tblSalesMainInvsub tr:last').attr('id')!=undefined)
            row = $('#tblSalesMainInvsub tr:last').attr('id').match(/\d+/)[0];
...
function viewsales()
{
    ...
    var Billsr = 0;
    var CurncyId = '';
    var row = (($('#tblSalesInv tr:last').attr('id').match(/\d+/)[0]) ||1);  
    var fl = 0;
    var SBlsrs = '';
...
function SalesInvGets(result,fl) {
...
function productadd() {
    ...
    if ($.trim($("#txtproduct0").val()) == '') {
        ...
        var ProdRow1 = "<tr id=" + 'row' + id + " class='jsgrid-row' onfocusout='updaterow(" + id + ")'>" +
            ...
            "<td class='jsgrid-cell jsgrid-align-center' style='width:40px'><select style='background-color:white;height:30px' disabled='' id=" + 'select_location' + id + " class='form-control' onkeydown=Focusnextgrid(event,'l'," + id + ") onfocusout=focusoutgrid('l'," + id + ") onfocusin=focusingrid('l'," + id + ")>" + LocnSelect + "</select></td>" +
            "</tr>";
        $('#tblsalesinvoice').append(ProdRow1);
