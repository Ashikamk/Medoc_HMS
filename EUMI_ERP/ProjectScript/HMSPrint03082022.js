...
function PrintTestResult(Rowlen) {
    ...
    myWindow.document.write('<table width=100% style="border-collapse: collapse;page-break-inside: avoid;font-family:tahoma;font-size:13px;"><tr>' +
    ...
    for (var i = 1; i <= Rowlen; i++) {
        ...
        if (linecount == linebr)//from layout
        {
            myWindow.document.write('<table width=100%><tr><td height=' + LROW + 'px></td></tr></table>');
            linecount = 0;
        }
    ...
    myWindow.document.write('<table style="font-family:tahoma;"  width=100%><tr><td height=20px></td></tr><tr><td colspan=3 align=center>*****  END OF REPORT  *****</td></tr>');
    myWindow.document.write('<tr><td height=20px colspan=3 align=center>&#160;</td></tr ><tr><td align=left></td><td width=400px align=center></td><td align=center>&#160;Approved By</td></tr ><tr><td align=left></td><td width=400px align=center></td><td align=center>&#160;' + (SignPrint.outerHTML) + ' </td></tr ><tr><td align=left></td><td width=400px align=center></td><td align=center>&#160;' + $('#UserDetsss').text() + '<br>LAB TECHINCIAN </td></tr></table > ');
