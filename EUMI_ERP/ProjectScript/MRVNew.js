...
function Productadd() {
    ...
    if (Product == "") {
        ...
        var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'>" +
            "<td id='edit_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;' ><input class='jsgrid-button jsgrid-edit-button' type='button' title='Edit' onclick='Editrow(" + id + ")'><input class='jsgrid-button jsgrid-delete-button'  type= button onclick='DeleteRow(" + id + ")'  title= Delete ></td>" +
            "<td id='update_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;display:none' ><input class='jsgrid-button jsgrid-update-button' type='button' title='Update' onclick='UpdateRow(" + id + ")'><input class='jsgrid-button jsgrid-cancel-edit-button' type='button' title='Cancel edit' onclick='CancelEdit(" + id + ")'></td>" +
            "<td id='td_" + id + "' class='jsgrid-cell'  style= 'width:3%;text-align:center' >"
            + no + "<input type='hidden' id='sl_" + id + "' value=" + id + "></td>" +
            "<td id='col_2' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:10%;' ><input type='hidden' id='OrderId_" + id + "' value='0'><input type='hidden' id='OrderSubId_" + id + "' value='0'><input type='hidden' id='productId_" + id + "' value='" +
            ...
            Product + "'></td>" +
            "<td id='col_x' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:20%;' ><input type='text' class='form-control' disabled style='height:30px;background-color:white'  id='productdesc_" + id + "' value='" +
            $("#productdesc_0").val() + "'></td>" +
            "<td id='col_3' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' > <select id='locn_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
            LocationSelect + "</select></td>" +
            "<td id='col_4' class='jsgrid-cell'  style='width:6%;display:none;' > <select id='unit_" + id + "' onchange='CheckFOC(" + id + ",this)' class='form-control' disabled style='height:30px;background-color:white' >" +
            ...
            parseInt($("#quantity_0").val()) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumberInt(event,this)' ></td>" +
            ...
            "<td id='col_13' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:300px;display:none;' ><input type='hidden' id='jobcodeid_" + id + "' value='"
...
function CheckEditInvoce(Flag) {
    if ($.trim($('#otp').val()) == '') {
        ...
        var Operation = '';
        if (Flag == 0)
            Operation = 'MRV Edit- OTP , MRV No : ' + $("#purchaseinvoiceno").val();
        else if (Flag == 1)
            Operation = 'MRV Delete- OTP , MRV No : ' + $("#purchaseinvoiceno").val();
...
function MRVGets(result) {
    closewarning();
    if (result.length > 0) {
        var Appendperformano = "";
        var AppendLPO = "";


        var Transfer = ''; var TransferNo = [];

        for (var n = 0; n < result.length; n++) {

            if (parseInt(result[n].PerformaNos || 0) != 0) {
                Transfer = 'Performa# - '
                var item = parseInt(result[n].PerformaNos || 0);
                if (TransferNo.indexOf(item) == -1) {
                    TransferNo.push(item);
                }
                $("#TransferNo").css("opacity", '100');
            }
            else if ($.trim(result[n].LPO) != '') {
                Transfer = 'Order# - '
                var item = $.trim(result[n].LPO);
                if (TransferNo.indexOf(item) == -1) {
                    TransferNo.push(item);
                }
                $("#TransferNo").css("opacity", '100');               
            ...
            var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'>" +
               ...
               "<td id='col_x' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:20%;' ><input type='text' class='form-control' style='height:30px;background-color:white' disabled id='productdesc_" + id + "' value='" +
               result[n].ItemDescription + "'></td>" +
               "<td id='col_3' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;' > <select id='locn_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
               LocationSelect + "</select></td>" +
               "<td id='col_4' class='jsgrid-cell'  style='width:6%;display:none;' > <select id='unit_" + id + "' onchange='CheckFOC(" + id + ",this)' class='form-control' disabled style='height:30px;background-color:white' >" +
               UnitSelect + "</select><input type='hidden' id='txtunit_" + id + "' class='form-control' /></td>" +
               "<td id='col_5' class= 'jsgrid-cell jsgrid-align-center'  style='width:5%;' ><input type='text' id='quantity_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='" +
               ...
               "<td id='col_7' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;display:none;' ><input type='text' id='discount_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
               parseFloat(result[n].Discount).toFixed(Decimal) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumber(event,this)'></td>" +
               "<td id='col_8' class='jsgrid-cell jsgrid-align-center'  style='width:6%;' ><input type='text' id='txttaxable_" + id + "' class='form-control' style='height:30px;background-color:white'  value='" +
               parseFloat(result[n].TaxableAmount).toFixed(Decimal) + "' disabled></td>" +
               "<td id='col_9' class='jsgrid-cell jsgrid-align-center'  style='width:6%;display:none;' > <select  class='form-control' disabled style='height:30px;background-color:white' id='tax_" + id + "' onchange='ChangeTax(" + id + ",this)' >" +
               TaxSelect + "</select><input type='hidden' id='taxpercentage_" + id + "' value=" +
               parseFloat(result[n].TaxRate).toFixed(Decimal) + "></td>" +
               "<td id='col_10' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;' ><input type='text' id='txttax_" + id + "' class='form-control' style='height:30px;background-color:white' disabled value='" +
               parseFloat(result[n].TaxAmount).toFixed(Decimal) + "'></td>" +
               "<td id='col_11' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;' ><input type='hidden' id='txtsubtotal_" + id + "' value=''><input type='text' id='amount_" + id + "' class='form-control' style='height:30px;background-color:white'  disabled value='" +
        ...
        $('#TransferNo').text(Transfer + TransferNo);

        $('#proddiv').animate({ scrollTop: 5000 }, 900);
        i = result.length + 1;
        $('#btndelete,#btnHistory').show();
    }
    else {
        CheckeDeleted();
    }
...
function formrefresh(RefreshFlag) {
    ...
    $('#jobid').val(0);
    $('#product_0').val('');
    $('#btndelete,#txthistory,#btnHistory,#PurchaseHis_Div').hide();
    $('#locn_0').val(ULocId);
    $('#unit').val(0);
    $('#quantity').val('');
    $('#txtrate').val('');
...
function ShowPerformaList(result) {
    ...
    var responseText = "<thead><tr><th style='width:3px;'>Sl#</th><th>Performa#</th><th>DO No</th><th style='text-align:center;'>Date</th><th style='width:6%;'>Supplier Code</th><th>Supplier</th><th>Fx.</th><th style='width:8%;'>Remarks</th><th  style='width:9%;'>Amount</th><th style='width:8%;text-align:center;'>Add</th></tr>" +
        "<tr><th  style='width:3px;'>SlNo</th><th>PerformaNo</th><th>DO No</th><th>Date</th><th style='width:6%;'>Code</th><th>Supplier</th><th>Currency</th><th style='width:8%;'>Remarks</th><th  style='width:10%;text-align:center;'>Amount</th><th style='width:9%;'> </th></tr></thead><tbody>"; // For Search
    for (var l = 0; l < result.length; l++) {
        var slno = parseInt(l + 1);
        responseText += '<tr id=' + "row" + slno + '>' +
           '<td style="width:3px;text-align:center;">' + slno + '</td>' +
...
function ShowPerformaSupplierList(result) {
    ...
    var responseText = "<thead><tr><th style='width:90px;'> <input type='checkbox' checked id= 'SlNoHeadCheck' 'custom-control-input cz-bg-image-display' onchange='SelectAllSupp()'>&nbsp;&nbsp;&nbsp;Select</th><th>Sl#</th><th>Performa#</th><th style='text-align:center;'>Order Date</th><th style='width:8%;'>Supplier Code</th><th>Supplier</th><th>Fx.</th><th style='width:8%;'>Remarks</th><th>Amount</th></tr>" +
        "<tr><th> </th><th>SlNo</th><th>PerformaNo</th><th>Date</th><th style='width:8%;'>Code</th><th>Supplier</th><th>Currency</th><th style='width:8%;'>Remarks</th><th>Amount</th></tr></thead><tbody>";
    for (var l = 0; l < result.length; l++) {
    ...
    for (var d = 0; d < result.length; d++) {
        if (result[d].Quantity > 0) {
            ...
            var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'><td id='edit_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;' ><input class='jsgrid-button jsgrid-edit-button' type='button' title='Edit' onclick='Editrow(" + id + ")'><input class='jsgrid-button jsgrid-delete-button'  type= button onclick='DeleteRow(" + id + ")'  title= Delete ></td><td id='update_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;display:none' ><input class='jsgrid-button jsgrid-update-button' type='button' title='Update' onclick='UpdateRow(" + id + ")'><input class='jsgrid-button jsgrid-cancel-edit-button' type='button' title='Cancel edit' onclick='CancelEdit(" + id + ")'></td><td id='td_" + id + "' class='jsgrid-cell'  style= 'width:3%;text-align:center' >"
                        + no + "<input type='hidden' id='sl_" + id + "' value=" + id + "></td><td id='col_2' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:10%;' ><input type='hidden' id='OrderIds_" + id + "' value='"
                        + result[d].PPNo + "'><input type='hidden' id='PerformaSubId_" + id + "' value='"
                        ...
                        result[d].ItemCode + "'></td><td id='col_x' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:20%;' ><input type='text' class='form-control' disabled style='height:30px;background-color:white'  id='productdesc_" + id + "' value='" +
                        result[d].ItemDescription + "'></td><td id='col_3' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' > <select id='locn_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
                        LocationSelect + "</select></td><td id='col_4' class='jsgrid-cell'  style='width:6%;display:none' > <select id='unit_" + id + "' onchange='CheckFOC(" + id + ",this)' class='form-control' disabled style='height:30px;background-color:white' >" +
                        ...
                        result[d].Qty + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumberInt(event,this)' ></td><td id='col_6' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;' ><input type='text' id='txtrate_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
                        ...
                        parseFloat(result[d].Discount).toFixed(Decimal) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumber(event,this)'></td><td id='col_8' class='jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' ><input type='text' id='txttaxable_" + id + "' class='form-control' style='height:30px;background-color:white'  value='" +
                        parseFloat(result[d].TaxableAmount).toFixed(Decimal) + "' disabled></td><td id='col_9' class='jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;display:none' > <select  class='form-control' disabled style='height:30px;background-color:white' id='tax_" + id + "' onchange='ChangeTax(" + id + ",this)' >" +
                        TaxSelect + "</select><input type='hidden' id='taxpercentage_" + id + "' value=" +
                        parseFloat(result[d].TaxRate) + "></td><td id='col_10' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' ><input type='text' id='txttax_" + id + "' class='form-control' style='height:30px;background-color:white' disabled value='" +
                        parseFloat(result[d].TaxAmount).toFixed(Decimal) + "'></td><td id='col_11' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' ><input type='hidden' id='txtsubtotal_" + id + "' value=''><input type='text' id='amount_" + id + "' class='form-control' style='height:30px;background-color:white'  disabled value='" +
                        parseFloat(result[d].TotalAmount).toFixed(Decimal) + "'><input type='hidden' id='baseamount_" + id + "' class='form-control'   disabled value=''><input type='hidden' id='basetaxableamount_" + id + "' class='form-control'   disabled value=''><input type='hidden' id='basetaxamount_" + id + "' class='form-control'   disabled value=''><input type='hidden' id='basediscount_" + id + "' class='form-control'   disabled value=''></td><td id='col_13' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:300px;display:none' ><input type='hidden' id='jobcodeid_" + id + "' value='"
...
function ShowPerformaItemGetOrder(result) {
    ...
    var responseText = "<thead><tr><th style='width:90px;'> <input type='checkbox'  checked  id= 'SlNoHeadOrderItem' onchange='SelectAllOrderItem()' 'custom-control-input cz-bg-image-display'>&nbsp;&nbsp;&nbsp;Select</th><th>PerformaNo</th><th>Product</th><th>Description</th><th>Unit</th><th>Quantity</th><th>Rate</th><th>Discount</th><th>Tax Amount</th><th>Amount</th></tr>" +
        "<tr><th> </th><th>PerformaNo</th><th>Product</th><th>Description</th><th>Unit</th><th>Quantity</th><th>Rate</th><th>Discount</th><th>Tax Amt.</th><th>Amount</th></tr></thead><tbody>";
    for (var l = 0; l < result.length; l++) {
        ...
        if ($("#SlNoCheckOrderItem" + m).is(":checked")) {
           ...
           // $('#PONo').val($('#showlpono_' + m).val());
            ...
            var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'><td id='edit_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;' ><input class='jsgrid-button jsgrid-edit-button' type='button' title='Edit' onclick='Editrow(" + id + ")'><input class='jsgrid-button jsgrid-delete-button'  type= button onclick='DeleteRow(" + id + ")'  title= Delete ></td><td id='update_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;display:none' ><input class='jsgrid-button jsgrid-update-button' type='button' title='Update' onclick='UpdateRow(" + id + ")'><input class='jsgrid-button jsgrid-cancel-edit-button' type='button' title='Cancel edit' onclick='CancelEdit(" + id + ")'></td><td id='td_" + id + "' class='jsgrid-cell'  style= 'width:3%;text-align:center' >"
                   ...
                   Product + "'></td><td id='col_x' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:20%;' ><input type='text' class='form-control' disabled style='height:30px;background-color:white'  id='productdesc_" + id + "' value='" +
                   Des + "'></td><td id='col_3' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' > <select id='locn_" + id + "' class='form-control' disabled style='height:30px;background-color:white' >" +
                   LocationSelect + "</select></td><td id='col_4' class='jsgrid-cell'  style='width:6%;display:none' > <select id='unit_" + id + "' onchange='CheckFOC(" + id + ",this)' class='form-control' disabled style='height:30px;background-color:white' >" +
                   UnitSelect + "</select><input type='hidden' id='txtunit_" + id + "' class='form-control' /></td><td id='col_5' class= 'jsgrid-cell jsgrid-align-center'  style='width:5%;' ><input type='text' id='quantity_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='" +
                   qty + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumberInt(event,this)' ><input type='hidden' id='demoqty_" + id + "' value='" + qty + "'></td><td id='col_6' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;' ><input type='text' id='txtrate_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
    ...
    for (var n = 0; n < result.length; n++) {
        if (result[n].Qty > 0) {
            ...
            var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'>" +
                ...
                "<td id='td_" + id + "' class='jsgrid-cell'  style= 'width:3%;text-align:center' >"
                        + no + "<input type='hidden' id='sl_" + id + "' value=" + id + "></td>" +
                        "<td id='col_2' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:10%;' ><input type='hidden' id='OrderId_" + id + "' value='"
                        ...
                        UnitSelect + "</select><input type='hidden' id='txtunit_" + id + "' class='form-control' /></td>" +
                        "<td id='col_5' class= 'jsgrid-cell jsgrid-align-center'  style='width:5%;' ><input type='text' id='quantity_" + id + "' class='form-control' disabled style='height:30px;background-color:white' value='" +
                        result[n].Qty + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumberInt(event,this)' ></td>" +
                        "<td id='col_6' class= 'jsgrid-cell jsgrid-align-center'  style='width:6%;' ><input type='text' id='txtrate_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
                        parseFloat(result[n].Rate).toFixed(Decimal) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumber(event,this)'><input type='hidden' id='baserate_" + id + "' class='form-control' value='' ></td>" +
                        "<td id='col_7' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;display:none;' ><input type='text' id='discount_" + id + "' class='form-control' disabled style='height:30px;background-color:white'  value='" +
                        parseFloat(result[n].Discount).toFixed(Decimal) + "' onkeyup='CalcAmount(" + id + ")' onkeypress='isNumber(event,this)'></td>" +
                        ...
                        "<td id='col_9' class='jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;display:none;' > <select  class='form-control' disabled style='height:30px;background-color:white' id='tax_" + id + "' onchange='ChangeTax(" + id + ",this)' >" +
                        TaxSelect + "</select><input type='hidden' id='taxpercentage_" + id + "' value=" +
                        parseFloat(result[n].TaxRate) + "></td>" +
                        "<td id='col_10' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:6%;' ><input type='text' id='txttax_" + id + "' class='form-control' style='height:30px;background-color:white' disabled value='" +
                        parseFloat(result[n].TaxAmount).toFixed(Decimal) + "'></td>" +
...
function OrderProductAdd() {
    ...
    for (m = 1; m <= row; m++) {
        if ($("#SlNoCheckOrderItem" + m).is(":checked")) {
            ...
            var ProdEditRow = "<tr class='jsgrid-row' id='row_" + id + "'><td id='edit_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;' ><input class='jsgrid-button jsgrid-edit-button' type='button' title='Edit' onclick='Editrow(" + id + ")'><input class='jsgrid-button jsgrid-delete-button'  type= button onclick='DeleteRow(" + id + ")'  title= Delete ></td><td id='update_" + id + "' class= 'jsgrid-cell jsgrid-control-field jsgrid-align-center'  style='width:3%;display:none' ><input class='jsgrid-button jsgrid-update-button' type='button' title='Update' onclick='UpdateRow(" + id + ")'><input class='jsgrid-button jsgrid-cancel-edit-button' type='button' title='Cancel edit' onclick='CancelEdit(" + id + ")'></td><td id='td_" + id + "' class='jsgrid-cell'  style= 'width:3%;text-align:center' >"
                   + no + "<input type='hidden' id='sl_" + id + "' value=" + id + "></td><td id='col_2' class= 'jsgrid-cell jsgrid-align-left'  style= 'width:10%;' ><input type='hidden' id='OrderId_" + id + "' value='"
...
function datatableWithsearch(tablename, Type) {
    ...
    $(a).each(function () {
        var title = $(this).text();
        if (title != ' ')
            if (title == 'Date' || title == 'Currency' || title == 'OrderNo'|| title == 'PerformaNo'|| title == 'SlNo' || title == 'InvoiceNo' || title == 'Code' || title == 'Reference' || title == 'Amount') {
