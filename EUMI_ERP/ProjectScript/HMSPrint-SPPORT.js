...
function PrintTestResult(Rowlen) {
    ...
    myWindow.document.write('<table width=100%><tr><td height=75px></td></tr></table>');
...
function PrintOPMedDescription(Rowlen, type, Flag) {
    if (type == 'HEADERPRINT') {
        ...
        myWindow.document.write(' <table width=100%>  <tr ><td height=60px ></td></tr></table>');

        myWindow.document.write(' <table style="font-size:70%;" width=100%>  <tr ><td width=10% align=left >Name &#160;&#160;:</td><td>' + $('#PrintPatientName').val() + '</td><td align=right width=10%></td><td  colspan=2></td><td align=right  width=20% style=font-weight:bold>OP No :</td><td colspn=2 width=20% style=font-weight:bold>' + $('#PrintPRegNo').val() + '</td></tr>');
        ...
        myWindow.document.write('<tr><td colspan=8 class="txbld1"> ' + Data + '</td></tr><tr><td colspan=8 class="txbld1"> Rx </td></tr></table>');


        myWindow.document.write('<table  style="border-collapse:collapse;font-size:70%;" frame="box" width=100% bordercolor="grey" ><tr class=violetbg><td style="border:1px solid grey;font-weight:bold" align=center width=50%>Medicine</td><td align=center style="border:1px solid grey;font-weight:bold" width=20%>Notes</td><td align=center style="border:1px solid grey;font-weight:bold" width=20%>Dosage</td><td align=center style="border:1px solid grey;font-weight:bold" width=10%>Days</td></tr>');
        ...
        for (var i = 0; i <= Rowlen; i++) {
            ...
            if ($('#PrintMedicine_' + Id).length && $.trim($('#PrintMedicine_' + Id).val()) != '') {
                ...
                myWindow.document.write('<tr ><td style="border:1px solid grey;">' + medname + ' </td><td style="border:1px solid grey;">' + Notes + '  </td><td align=center style="border:1px solid grey;">    ' + Dosage + '</td><td align=center style="border:1px solid grey;">' + Days + ' </td></tr>');
