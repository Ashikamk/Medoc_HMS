...
function GetUserDetails(result) {
    ...
    var UserDetails = '' + result[0].UserId + ':' + result[0].DeptId + ':' + result[0].LocationID + ':' + result[0].UserName + ':' + result[0].DepartmentName + ':' + result[0].UserMenu + ':' + result[0].EODDate + '';
     ...
     localStorage.setItem('nanana', UserDetails);
        ...
        //M171
        if (dashboard.indexOf("M390") != -1) {

            window.location = '../Revisit/ScanWorkSheet_D';
            localStorage.setItem('defaultdashboard', '../Revisit/ScanWorkSheet_D');

        }
        else if (dashboard.indexOf("M389") != -1) {

            window.location = '../Master/ScanRegistration';
            localStorage.setItem('defaultdashboard', '../Master/ScanRegistration');

        }
         else if (dashboard.indexOf("M383") != -1) {
            ...
            window.location = 'Master/SalesManDashboard';
            localStorage.setItem('defaultdashboard', 'Master/SalesManDashboard');
...
function GetComanyDetails(result) {
    ...
    if (result.length > 0) {
        ...
        var ComanyDetail = '' + result[0].CompanyId + '%' + result[0].CompanyCode + '%' + result[0].CompanyName + '%' + result[0].Address + '%' + result[0].PhoneNo + '%' + result[0].Email + '%' +
            ...
            result[0].QuotationPrint + '%' + result[0].PrintColor + '%' + result[0].EODType + '%' + result[0].CessType + '%' + result[0].LabBillPrint + '%' + result[0].IPBillPrint + '%' + result[0].TaxType + '%' + result[0].IPTaxZero + '%' + result[0].DischargePrint + '';
