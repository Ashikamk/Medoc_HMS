...
function PrintthisBillWindowsHMS(Flag, Rowlen, type,Bill)
{
    if (Flag == 'LABBILL') {
        ...
        { PrintthisBillLabwithtexthead(Rowlen, 0, 2, Bill) }
    ...
    else if (Flag == 'SALESQR') {
        if (type == 'COPY') { PrintthisBillHMSSalesQR(Rowlen, 0, 1) }
        else if (type == 'SAVE') { PrintthisBillHMSSalesQR(Rowlen, 1, 1) }
    }
    else if (Flag == 'SALESB2B') {
        if (type == 'COPY') { PrintthisBillHMSSalesB2B(Rowlen, 0, 1) }
        else if (type == 'SAVE') { PrintthisBillHMSSalesB2B(Rowlen, 1, 1) }
    }
    else if (Flag == 'SALESRETURN') {
        if (type == 'COPY')
...
function PrintthisBillHMSSalesB2B(Rowlen, flg, type) {
    ...
    var BillSSNo = $("#HBillSeries option:selected").text()  //$('#HBillSeries').text();
    var AmountinWords = WordwithDecimal($('#BaseTextTotalProc').text());
    var myWindow = window.open("", "", "width=1500,height=1500");

    //$(ComapnydivToPrintLab).css('height', 100); $(ComapnydivToPrintLab).css('width', 100);
    ...
    myWindow.document.write('<table  width=100%><tr height=20px></tr>' +

        '<tr><td width=100%><table width=100%>' +
        '<tr><td align=center style = "font-size: 1.2em;font-family:tahoma;"><b> ' + window.CompanySettingsArray.CompanyName + '</b></td ></tr>' +
        '<tr><td  align=center style="font-size: 0.9em;font-family:tahoma;"><b>' + window.CompanySettingsArray.Address + '</b></td></tr>' +
        '<tr><td align=center style="font-size: 0.9em;font-family:tahoma;" colspan=6><b>' + window.CompanySettingsArray.Email + '</b></td></tr>' +
        '<tr><td align=center style="font-size: 0.9em;border-bottom:0px solid black;font-family:tahoma;"><b>' + window.CompanySettingsArray.PhoneNo + '</b></td></tr>' +
        '<tr><td align=center style="font-size: 0.9em;border-bottom:0px solid black;font-family:tahoma;"><b>' + window.CompanySettingsArray.TRNNo + '</b></td></tr>' +
        '</table></td> ' +

        '</tr></table> ');

    var DD = $('#custaddress1').val().split('##');

    myWindow.document.write('<table style=" border-collapse: collapse;border:1px solid black;font-family:tahoma;" width="100%">' +
        '<tr><td style="border: 1px solid;font-family:tahoma;"width="50%"><b>Invoice To</b></td><td align="center" style="border: 1px solid;font-family:tahoma;"><b>Date</b></td><td align="center" style="border: 1px solid;font-family:tahoma;"><b>Invoice No</b></td></tr>' +
        '<tr><td rowspan="3" style="border: 1px solid;font-family:tahoma;"> <table style="font-family:tahoma;"><tr><td style="font-family:tahoma;">' + $('#HPatient').val() + '</td></tr><tr><td style="font-family:tahoma;">' + DD[0] + ',' + DD[1] + '</td></tr><tr><td style="font-family:tahoma;">' + DD[3] + '</td></tr></table>  </td><td align="center" style="border: 1px solid;style="font-family:tahoma;"">' + $('#HSalesDate').val() + '</td><td align="center" style="border: 1px solid;style="font-family:tahoma;"">' + BillSSNo + ' - ' + BillNo + '</td></tr>' +
        '<tr><td align="center" style="border: 1px solid;font-family:tahoma;"><b>Payment Terms</b></td><td align="center" colspan=2 style="border: 1px solid;font-family:tahoma;"><b>Created By</b></td></tr><tr><td align="center" style="border: 1px solid;font-family:tahoma;">' + $("#PayType option:selected").text() + '</td><td colspan=2  align="center"style="border: 1px solid;font-family:tahoma;">' + $("#UserDetsss").text() + '</td></tr>' +
        '</table>');

    myWindow.document.write(' <table border-collapse:collapse; border=1 rules=cols style="border:1px solid black;"width=100%>');
    myWindow.document.write('<tr  style="border:1px solid black;background-color:#D3D3D3;font-family:tahoma;font-size:12px;"><td align=center width=3%>SL#</td><td colspan=10 align=left width=25%>&#160;&#160;&#160;&#160;&#160;PRODUCT/BATCH</td><td align=center width=5%>HSN </td><td width=3% align=center>QTY.</td><td align=center width=5%>MRP</td><td align=center width=5%>RATE</td><td align=center width=8%>TAXABLE AMOUNT</td><td align=center width=5%>TAX%</td><td align=center width=8%>GST AMOUNT</td><td align=right width=5%>AMOUNT</td></tr>');

    myWindow.document.write('<tr><td colspan=20 "></td></tr>');
    var slnm = 0;
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 2;
            myWindow.document.write('<tr style="font-family:tahoma;font-size:12px;"><td style"font-size:10px;">&#160;&#160;' + $('#tdSl' + Id).text() + '</td><td colspan=10 style="padding-left:5px;font-size:13px;">' + $('#Product' + Id).val() + '</td><td style="padding-left:5px;font-size:13px;">' + $('#PHSNCode' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:13px;">' + $('#Quantity' + Id).val() + '</td><td align=right style="padding-left:5px;font-size:13px;">' + $('#PurPrice' + Id).val() + '</td><td style="padding-right:5px;font-size:13px;" align=right>' + parseFloat($('#TaxableAmt' + Id).val() / parseInt($('#Quantity' + Id).val())).toFixed(2) + '</td><td align=right style="padding-right:5px;font-size:13px;">' + $('#TaxableAmt' + Id).val() + '</td><td align=center style="padding-right:5px;font-size:13px;">' + $('#TaxPercent' + Id).val() + '</td><td align=right style="padding-right:5px;font-size:13px;">' + $('#TaxAmt' + Id).val() + '</td><td align=right style="padding-right:5px;font-size:13px;">' + $('#Amount' + Id).val() + '</td></tr>');
            myWindow.document.write('<tr style="font-family:tahoma;font-size:12px;"><td style"font-size:10px;"></td><td colspan=10 style="padding-left:5px;font-size:13px;">' + $('#ProductDesc' + Id).val() + '</td><td style="padding-left:5px;font-size:13px;"></td><td align=center style="padding-left:5px;font-size:13px;"></td><td align=right style="padding-left:5px;font-size:13px;"></td><td style="padding-right:5px;font-size:13px;" align=right></td><td align=right style="padding-right:5px;font-size:13px;"></td><td align=center style="padding-right:5px;font-size:13px;"></td><td align=right style="padding-right:5px;font-size:13px;"></td><td align=right style="padding-right:5px;font-size:13px;"></td></tr>');

        }
        if (Rowcount % 35 == 0) {
            Rowcount = 0;
            //  myWindow.document.write('<tr style=""><td height=250px colspan=10></td></tr>');
        }
    }
    for (var a = 1; a <= 30 - Rowcount; a++) {
        myWindow.document.write('<tr><td>&#160;&#160;</td> <td colspan=10></td> <td></td><td></td><td></td><td></td><td><td></td><td></td></tr>');
    }
    var Line = "";
    if ($('#hiddensplittaxable_0').val() != 0) {
        Line += '<tr><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#TaxGrpname0').text() + '</td><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittaxable_0').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittax_0').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#CGST_0').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#SGST_0').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#IGST_0').val() + '</td></tr>'
    }
    if ($('#hiddensplittaxable_5').val() != 0) {
        Line += '<tr><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#TaxGrpname5').text() + '</td><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittaxable_5').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittax_5').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#CGST_5').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#SGST_5').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#IGST_0').val() + '</td></tr>'
    }
    if ($('#splittaxable_12').val() != 0) {
        Line += '<tr><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#TaxGrpname12').text() + '</td><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittaxable_12').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittax_12').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#CGST_12').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#SGST_12').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#IGST_0').val() + '</td></tr>'
    }
    if ($('#splittaxable_18').val() != 0) {
        Line += '<tr><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#TaxGrpname18').text() + '</td><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittaxable_18').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittax_18').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#CGST_18').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#SGST_18').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#IGST_0').val() + '</td></tr>'
    }
    if ($('#splittaxable_28').val() != 0) {
        Line += '<tr><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#TaxGrpname28').text() + '</td><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittaxable_28').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#splittax_28').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#CGST_28').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#SGST_28').val() + '</td><td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">' + $('#IGST_0').val() + '</td></tr>'
    }

    myWindow.document.write('<table width=100% style="border-left:1px solid black;border-right:1px solid black;border-bottom:1px solid black;">');

    myWindow.document.write('<tr style="height:80px;">');
    myWindow.document.write('<td vertical-align: top; width=62.5% style="border-right:1px solid grey;">  <table width=100% style="border-collapse:collapse;"><tr><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">GST%</td><td width=16% style="font-family:tahoma;font-size:12;border:1px solid black;">TAXABLE</td>  <td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">GST</td> <td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">CGST</td> <td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">SGST</td> <td width=16% align=center style="font-family:tahoma;font-size:12;border:1px solid black;">IGST</td></tr>  <tr><td>' + Line + '<td></tr>  </table>  </td>');
    myWindow.document.write('<td width=37.5%  style=""> <table width=100%><tr><td style="font-family:tahoma;font-size:12;">Amount</td><td align=right style="font-family:tahoma;font-size:12;">          ' + $('#TotalTaxable').val() + '           </td></tr>         <tr><td style="font-family:tahoma;font-size:12;">Total Tax</td><td  align=right style="font-family:tahoma;font-size:12;">' + $('#TotlaTax').val() + '</td></tr>                <tr><td style="font-family:tahoma;font-size:12;">Discount</td><td   style="font-family:tahoma;font-size:12;" align=right>(-)&#160;' + addCommas(parseFloat($('#Discount').val()).toFixed(Decimal)) + '</td></tr>      <tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
    myWindow.document.write('</tr>');
    myWindow.document.write('<tr height=25px;><td colspan=12 style="font-family:tahoma;font-size:12; border-top:1px solid grey;">Amount In words :&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;<b>  ' + AmountinWords + '</b></td></tr>');
    myWindow.document.write('<table><tr><td></td></tr></table>');

    myWindow.document.write('<table style="border-collapse: collapse;border:1px solid black;font-family:tahoma;" width="100%"><tr><td>&#160;&#160;&#160;CASH :   ' + parseFloat($('#BAmount').val() || 0).toFixed(2) + '&#160;&#160;&#160;   CARD :   ' + parseFloat($('#SpecialFeeAmt').val() || 0).toFixed(2) + '&#160;&#160;&#160;   UPI :  ' + parseFloat($('#UPISpecialFeeAmt').val() || 0).toFixed(2) + '</td></tr></table>');

    myWindow.document.write('<table><tr><td></td></tr></table>');
    myWindow.document.write('<table style="border-collapse: collapse;border:1px solid black;font-family:tahoma;" width="100%"><td align=center  style="border: 1px solid;"width="50%"><table width=100%><tr><td align=center >Delivery Received in Good Condition</td></tr><tr><td align=center>&#160;</td></tr><tr><td align=center>Receiver Name & Signature</td></tr></table></td><td align=center style="border: 1px solid;"width="50%"><table width=100% style="font-family:tahoma;"><tr><td style="font-family:tahoma;font-size:10px;" align=center><b>' + window.CompanySettingsArray.CompanyName + '</b></td></tr><tr><td style="font-family:tahoma;font-size:10px;" align=center><b>' + window.CompanySettingsArray.Address + '</b></td></tr><tr><td align=center>&#160;</td></tr></table></td></tr></table>');
...
function PrintthisBillHMSSalesQR(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    //var divToPrintA = document.getElementById("QRCodes");
    //divToPrintA.style.width = "auto";
    //divToPrintA.style.height = "75px";
   ...
   // myWindow.document.write('<table width=100% ><tr><td width=100% align=center  style=color:#008000;font-weight:bold>' + (ComapnydivToPrintLab.outerHTML) + '</td></tr></table>');
     ...
     myWindow.document.write('<table  width=100% ><tr height=20px></tr>' +
        '<tr><td width=100%><table width=100%>' +
        '<tr><td align=center style = "font-size: 1.2em;font-family:tahoma;"> ' + window.CompanySettingsArray.CompanyName + '</td ></tr >' +
        '<tr><td  align=center style="font-size: 0.9em;font-family:tahoma;">' + window.CompanySettingsArray.Address + '</td></tr>' +
        '<tr><td align=center style="font-size: 0.9em;font-family:tahoma;" colspan=6>' + window.CompanySettingsArray.Email + '</td></tr >' +
        '<tr><td align=center style="font-size: 0.9em;border-bottom:0px solid black;font-family:tahoma;">' + window.CompanySettingsArray.PhoneNo + '</td></tr>' +
        '</table></td ></tr></table > ');

    var GSTIN=""
    if (window.CompanySettingsArray.TRNNo == '') {
      
    }
    else {
        GSTIN = 'GSTIN :' + window.CompanySettingsArray.TRNNo
    }


    myWindow.document.write('<table  width=100% ><tr height=10px;><td style="font-family:tahoma;font-size:80%;">' + GSTIN+'</td></tr><tr><td colspan=8 style="border-top:1px solid black;font-family:tahoma;font-size:80%;"></td></tr>');
    myWindow.document.write('<tr><td  style="font-family:tahoma;font-size:80%;width=35%;"><b>PHARMACY BILL</b></td>     <td width=35% style="font-family:tahoma;font-size:80%;align=right;" ><b>BILLNO : &#160;&#160;' + BillNo + '</b><td></tr>');
    ...
    myWindow.document.write('<td  width=8% style="font-family:tahoma;font-size:12;">MR/OP#</td><td  width=49% style="font-family:tahoma;font-size:12;">:' + $('#HRegNo').val() + '/' + $('#HOpNo').val() + '</td>   <td  width=10% style="font-family:tahoma;font-size:12;">Date</td><td  width=49% style="font-family:tahoma;font-size:12;">:' + $('#HSalesDate').val() + '</td>   </tr>   <tr><td  width=8% style="font-family:tahoma;font-size:12;">Patient</td><td  width=49% style="font-family:tahoma;font-size:12;">:' + $('#HPatient').val() + '</td></tr>');
    myWindow.document.write('<tr><td  width=10% style="font-family:tahoma;font-size:12;">Doctor</td><td  width=45% style="font-family:tahoma;font-size:12;">:' + $('#HDoctor :selected').text() + '</td></tr>');
    myWindow.document.write('<tr><td colspan=8 style="border-top:1px solid black;"></td></tr>');
    myWindow.document.write('</tr></table>');

    var HeaderRow = '';
    HeaderRow = '<tr  style="font-family:tahoma;border-bottom:0px solid grey;font-size:12px;"><td align=center width=3%>SLNO</td><td colspan=8 align=left width=20%>&#160;&#160;&#160;&#160;&#160;PRODUCT</td><td width=5% align=center>QTY.</td><td align=right width=5%>RATE</td><td align=right width=5%>AMOUNT</td></tr>';

    myWindow.document.write('<table style="border-collapse:collapse;font-size:70%;"  width=100% ">' + HeaderRow);
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr  ><td style="border-left:0px solid grey;font-size:11px;" align=center>' + $('#tdSl' + Id).text() + '</td><td colspan=8 style="padding-left:5px;font-size:11px;">' + $('#Product' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Quantity' + Id).val() + '</td><td style="padding-right:5px;font-size:11px;" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px;font-size:11px;">' + $('#Amount' + Id).val() + '</td></tr>');


            myWindow.document.write('<tr  ><td></td><td  colspan=12 style="padding-left:5px;font-size:11px;"> &#160; &#160; BATCH:' + $('#ProductDesc' + Id).val() + '   &#160;&#160;   EXP:' + $('#Expiry' + Id).val() + '</td></tr>');
    ...
    for (var i = 1; i <= Prlen; i++) {
        ...
        if ($('#Procedure' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr  ><td style="border-left:0px solid grey;font-size:11px;" align=center>' + slnm + '</td><td colspan=4 style="padding-left:5px;font-size:11px;">&#160;&#160;&#160;&#160;&#160' + $('#Procedure' + Id).val().substring(0, 20) + '</td><td style="padding-left:5px;font-size:10px;"></td><td align=center style="padding-left:5px;font-size:11px;"></td><td align=center style="padding-left:5px;font-size:10px;"></td><td align= style="padding-left:5px;font-size:10px;"></td><td align=center style="padding-left:5px;font-size:10px;"></td><td style="padding-right:5px;font-size:10px;" align=right></td><td align=right style="padding-right:5px;font-size:11px;">' + $('#ProcTot' + Id).val() + '</td></tr>');
        }
    }
    ...
    for (var a = 0; a <= (10 - slnm); a++) {
        ...
        myWindow.document.write('<tr ><td style="border-left:0px solid grey;font-family:tahoma;font-size:12;" align=center>&#160;</td><td colspan=5 style="padding-left:5px;font-family:tahoma;font-size:12;"></td><td style="padding-left:5px;font-family:tahoma;font-size:12;"></td><td style="padding-right:5px;font-family:tahoma;font-size:12;" align=right></td><td align=right style="padding-right:5px;font-family:tahoma;font-size:12;"></td><td align=right style="padding-right:5px;font-family:tahoma;font-size:12;"></td><td align=right style="padding-right:5px;font-family:tahoma;font-size:12;"></td></tr>');
    }

    var Line = "";
    if ($('#hiddensplittaxable_0').val() != 0) {

        Line += '<tr><td width=25% style="font-family:tahoma;font-size:12;">0%</td><td width=25% style="font-family:tahoma;font-size:12;">' + $('#splittaxable_0').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#CGST_0').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#SGST_0').val() + '</td></tr>'

    }
    if ($('#hiddensplittaxable_5').val() != 0) {


        Line += '<tr><td width=25% style="font-family:tahoma;font-size:12;">5%</td><td width=25% style="font-family:tahoma;font-size:12;">' + $('#splittaxable_5').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#CGST_5').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#SGST_5').val() + '</td></tr>'

    }
    if ($('#splittaxable_12').val() != 0) {


        Line += '<tr><td width=25% style="font-family:tahoma;font-size:12;">12%</td><td width=25% style="font-family:tahoma;font-size:12;">' + $('#splittaxable_12').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#CGST_12').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#SGST_12').val() + '</td></tr>'

    }
    if ($('#splittaxable_18').val() != 0) {


        Line += '<tr><td width=25% style="font-family:tahoma;font-size:12;">18%</td><td width=25% style="font-family:tahoma;font-size:12;">' + $('#splittaxable_18').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#CGST_18').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#SGST_18').val() + '</td></tr>'

    }
    if ($('#splittaxable_28').val() != 0) {


        Line += '<tr><td width=25% style="font-family:tahoma;font-size:12;">28%</td><td width=25% style="font-family:tahoma;font-size:12;">' + $('#splittaxable_28').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#CGST_28').val() + '</td><td width=25% align=center style="font-family:tahoma;font-size:12;">' + $('#SGST_28').val() + '</td></tr>'

    }

    myWindow.document.write('<table width=100% style="border:1px solid black;border-collapse:collapse;">');
    myWindow.document.write('<tr style="height:80px;">');
    //myWindow.document.write('<td   style="border-right:1px solid black;font-family:tahoma;font-size:12;" align=center><table><tr><td style="font-family:tahoma;font-size:12;">Prepared By:</td></tr><tr><td align=center style="font-family:tahoma;font-size:12;">' + Billuser + '</td></tr></table></td>');
    myWindow.document.write('<td width=50% style="border-right:1px solid grey;">  <table width=100%><tr><td width=25% style="font-family:tahoma;font-size:12;">GST%</td><td width=25% style="font-family:tahoma;font-size:12;">Taxable</td><td width=25% align=center style="font-family:tahoma;font-size:12;">CGST</td> <td width=25% align=center style="font-family:tahoma;font-size:12;">SGST</td></tr>  <tr><td>' + Line + '<td></tr>  </table>  </td>');
    ...
    if (($('#TotRoundOff').val() != 0)) {
        myWindow.document.write('<tr height=25px;><td colspan=8 style="font-family:tahoma;font-size:12; border-top:1px solid grey;"><table width=100%><tr><td style="font-family:tahoma;font-size:12;"width=61%><b> ' + AmountinWords + '</b></td><td style="font-family:tahoma;font-size:12;"width=15% align=left>RoundOff</td><td style="font-family:tahoma;font-size:12;" align=right width=9%>' + $('#TotRoundOff').val() + '</td></tr></table></tr></table><table><tr><td style="font-family:tahoma;font-size:11px;">Prepared By :' + Billuser + ' - ' + time +'</td></tr></table>');
    }
    else {
        myWindow.document.write('<tr height=25px;><td colspan=12 style="font-family:tahoma;font-size:12; border-top:1px solid grey;">' + AmountinWords + '</td></tr></table><table><tr><td style="font-family:tahoma;font-size:11px;">Prepared By :' + Billuser + ' - ' + time +'</td></tr></table>');
...
function PrintthisBillHMSSalesQR(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    myWindow.document.write('<table  width=100% ><tr height=10px;><td style="font-family:tahoma;font-size:80%;">GSTIN: 32ECMPS6299R1ZA</td></tr><tr><td colspan=8 style="border-top:1px solid black;font-family:tahoma;font-size:80%;"></td></tr>');
    myWindow.document.write('<tr><td  style="font-family:tahoma;font-size:80%;width=35%;"><b>DEPARTMENT : PHARMACY</b></td>    <td width=40% style="font-family:tahoma;font-size:80%;align=center;" ><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;CASHBILL</b></td>     <td width=25% style="font-family:tahoma;font-size:80%;align=left;" ><b>&#160;&#160;&#160;&#160;&#160;&#160;BILLNO &#160;&#160;&#160;&#160; : &#160;&#160;' + BillNo + '</b><td></tr>');
    myWindow.document.write('<tr><td colspan=8 style="border-top:1px solid black;"></td></tr></table>');
    var TypeText = '';
    TypeText += '<td >Paytype</td><td>:' + $('#PayType :selected').text() + '</td>';
    ...
    var HeaderRow = '';
    HeaderRow = '<tr  style="font-family:tahoma;border-bottom:0px solid grey;font-size:12px;"><td align=center width=3%>SLNO</td><td colspan=6 align=left width=20%>&#160;&#160;&#160;&#160;&#160;PRODUCT</td><td width=5% align=center>BATCH</td><td width=5% align=center>EXPIRY</td><td width=5% align=center>QTY.</td><td align=right width=5%>MRP</td><td align=center width=5%>DISC</td><td align=right width=5%>RATE</td><td align=right width=5%>AMOUNT</td></tr>';
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr  ><td style="border-left:0px solid grey;font-size:11px;" align=center>' + $('#tdSl' + Id).text() + '</td><td colspan=6 style="padding-left:5px;font-size:11px;">&#160;&#160;&#160;&#160;&#160' + $('#Product' + Id).val() + '</td><td style="padding-left:5px;font-size:11px;">' + $('#ProductDesc' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Expiry' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Quantity' + Id).val() + '</td><td align=right style="padding-left:5px;font-size:11px;">' + $('#PurPrice' + Id).val() + '</td><td align=center style="padding-left:5px;font-size:11px;">' + $('#Discount' + Id).val() + '</td><td style="padding-right:5px;font-size:11px;" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px;font-size:11px;">' + $('#Amount' + Id).val() + '</td></tr>');
    ...
    for (var i = 1; i <= Prlen; i++) {
        ...
        if ($('#Procedure' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr  ><td style="border-left:0px solid grey;font-size:11px;" align=center>' + slnm + '</td><td colspan=6 style="padding-left:5px;font-size:11px;">&#160;&#160;&#160;&#160;&#160' + $('#Procedure' + Id).val().substring(0, 20) + '</td><td style="padding-left:5px;font-size:10px;"></td><td align=center style="padding-left:5px;font-size:11px;"></td><td align=center style="padding-left:5px;font-size:10px;"></td><td align= style="padding-left:5px;font-size:10px;"></td><td align=center style="padding-left:5px;font-size:10px;"></td><td style="padding-right:5px;font-size:10px;" align=right></td><td align=right style="padding-right:5px;font-size:11px;">' + $('#ProcTot' + Id).val() + '</td></tr>');
        }
    }
    ...
    myWindow.document.write('<table width=100% style="border:1px solid black;border-collapse:collapse;">');
    myWindow.document.write('<tr style="height:80px;">');
    myWindow.document.write('<td v  style="border-right:1px solid black;font-family:tahoma;font-size:12;" align=center><table><tr><td style="font-family:tahoma;font-size:12;">Prepared By:</td></tr><tr><td align=center style="font-family:tahoma;font-size:12;">' + Billuser + '</td></tr></table></td>');
    myWindow.document.write('<td width=50% style="border-right:1px solid grey;">  <table width=100%><tr><td width=25% style="font-family:tahoma;font-size:12;">GST%</td><td width=25% style="font-family:tahoma;font-size:12;">Taxable</td><td width=25% align=center style="font-family:tahoma;font-size:12;">CGST</td> <td width=25% align=center style="font-family:tahoma;font-size:12;">SGST</td></tr>  <tr><td>' + Line + '<td></tr>  </table>  </td>');
    //myWindow.document.write('<td width=25%> <table width=100%><tr><td style="font-family:tahoma;font-size:12;" >Amount</td><td align=right style="font-family:tahoma;font-size:12;">          ' + $('#TotalTaxable').val() + '           </td></tr>         <tr><td style="font-family:tahoma;font-size:12;">Total Tax</td><td  align=right style="font-family:tahoma;font-size:12;">' + $('#TotlaTax').val() + '</td></tr>                <tr><td style="font-family:tahoma;font-size:12;">Discount</td><td   style="font-family:tahoma;font-size:12;" align=right>' + addCommas(parseFloat($('#Discount').val()).toFixed(Decimal)) + '</td></tr>      <tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
    if (($('#Discount').val() != 0)) {
        myWindow.document.write('<td width=25%> <table width=100%><tr><td style="font-family:tahoma;font-size:12;" >Amount</td><td align=right style="font-family:tahoma;font-size:12;">          ' + $('#TotalTaxable').val() + '           </td></tr>         <tr><td style="font-family:tahoma;font-size:12;">Total Tax</td><td  align=right style="font-family:tahoma;font-size:12;">' + $('#TotlaTax').val() + '</td></tr>                <tr><td style="font-family:tahoma;font-size:12;">Discount</td><td   style="font-family:tahoma;font-size:12;" align=right>' + addCommas(parseFloat($('#Discount').val()).toFixed(Decimal)) + '</td></tr>      <tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
...
//NO GST
function PrintthisBillHMSSalesQR1(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    //    '<tr><td width=30%>' + (ComapnydivToPrintLab.outerHTML) + '</td>' +
    ...
    myWindow.document.write('<table  width=100% ><tr height=10px;><td></td></tr><tr><td colspan=8 style="border-top:1px solid black;"></td></tr>');
    myWindow.document.write('<tr><td  style="font-family:tahoma;font-size:80%;width=35%;"><b>DEPARTMENT : PHARMACY</b></td>    <td width=40% style="font-family:tahoma;font-size:80%;align=center;" ><b>&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;&#160;CASHBILL</b></td>     <td width=25% style="font-family:tahoma;font-size:80%;align=left;" ><b>&#160;&#160;&#160;&#160;&#160;&#160;BILLNO &#160;&#160;&#160;&#160; : &#160;&#160;' + BillNo + '</b><td></tr>');
    myWindow.document.write('<tr><td colspan=8 style="border-top:1px solid black;"></td></tr></table>');
    var TypeText = '';
    TypeText += '<td >Paytype</td><td>:' + $('#PayType :selected').text() + '</td>';
    ...
    myWindow.document.write('<tr style="height:80px;">');
    myWindow.document.write('<td style="border-right:1px solid black;font-family:tahoma;font-size:12;" align=center><table><tr><td style="font-family:tahoma;font-size:12;">Prepared By:</td></tr><tr><td align=center style="font-family:tahoma;font-size:12;">' + Billuser + '</td></tr></table></td>');
    myWindow.document.write('<td width=50% style="border-right:1px solid grey;"><table width=100%><tr><td style="font-family:tahoma;font-size:12;"><center>24X7 EMERGENCY, SPECIALITY CONSULTATION, CASUALITY, PHARMACY, LABORATORY, XRAY, ECG</center> </td></tr> <tr style="font-family:tahoma;font-size:12;"><td> <b><center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo+'</center></b></td></tr></table> </td>');
    if (($('#Discount').val() != 0)) {
        var ST = parseFloat(parseFloat($('#BaseTextTotalProc').text()) + parseFloat($('#Discount').val())).toFixed(Decimal);
        myWindow.document.write('<td width=25%> <table width=100%><tr><td style="font-family:tahoma;font-size:12;">SubTotal</td><td align=right style="font-family:tahoma;font-size:12;"><b>' + ST + '</b></td></tr><tr><td style="font-family:tahoma;font-size:12;">Discount</td><td style="font-family:tahoma;font-size:12;" align=right><b>' + addCommas(parseFloat($('#Discount').val()).toFixed(Decimal)) + '</b></td></tr>      <tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>₹&#160;' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
    }
    else {

        myWindow.document.write('<td width=25%> <table width=100%><tr><td style="font-family:tahoma;font-size:12;">Net Amount</td><td  align=right style="font-family:tahoma;font-size:12;"><b>₹&#160;' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>                    </table>  </td>');
    }

    myWindow.document.write('</tr>');

    if (($('#TotRoundOff').val() != 0)) {
        myWindow.document.write('<tr height=25px;><td colspan=8 style="font-family:tahoma;font-size:12; border-top:1px solid grey;"><table width=100%><tr><td style="font-family:tahoma;font-size:12;"width=70%>Amount In words :&#160;&#160;&#160;<b>Rupees&#160;' + AmountinWords + '</b></td><td style="font-family:tahoma;font-size:12;"width=8% align=left>RoundOff</td><td style="font-family:tahoma;font-size:12;" align=right width=5%>' + $('#TotRoundOff').val() + '</td></tr></table></tr>');
    }
    else {
        myWindow.document.write('<tr height=25px;><td colspan=12 style="font-family:tahoma;font-size:12; border-top:1px solid grey;">Amount In words :&#160;&#160;&#160;<b>Rupees&#160;' + AmountinWords + '</b></td></tr>');
...
function PrintthisBillHMSSales(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
   // alert('')
    ...
    //myWindow.document.write('<table width=100% ><tr ><td height=56px></td></tr>');
    //myWindow.document.write('</table>');
   ...
   //myWindow.document.write('<table  width=100% ><tr align=center><td style="font-size: 1.2em;">' + window.CompanySettingsArray.CompanyName + '</td></tr><tr><td  align=center style="font-size: 0.7em;">' + window.CompanySettingsArray.Address + '</td></tr><tr><td  align=center style="font-size: 0.7em;" colspan=6>' + window.CompanySettingsArray.Email + '</td></tr><tr><td  align=center style="font-size: 0.7em;border-bottom:0px solid black">' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');

    var TypeText = '';
    TypeText += '<td align=right width=10%>Paytype</td><td colspn=2 width=20% >:' + $('#PayType :selected').text() + '</td>';

    myWindow.document.write('<table style="font-size:75%;border-top:1px solid grey;border-left:1px solid grey;border-right:1px solid grey" width=100% ><tr ><td width=10% align=left >OP#</td><td colspan=4 align=left width=50%>' + $('#HOpNo').val() + '</td><td align=right width=10%>Bill No&#160;</td><td  colspn=2 width=20% >:' + SNo + '</td></tr>');
    ...
    var HeaderRow = '';
    HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td align=center width=3%>Sl#</td><td colspan=6 align=center width=28%>Product</td><td width=5% align=center>Batch</td><td width=5% align=center>Expiry</td><td width=5% align=center>Qty.</td><td align=center width=5%>Rate</td><td align=center width=5%>Amount</td></tr>';
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#tdSl' + Id).text() + '</td><td colspan=6 style="padding-left:5px">' + $('#Product' + Id).val() + '</td><td style="padding-left:5px">' + $('#ProductDesc' + Id).val() + '</td><td align=center style="padding-left:5px">' + $('#Expiry' + Id).val() + '</td><td align=center style="padding-left:5px">' + $('#Quantity' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#SellPrice' + Id).val() + '</td><td align=right style="padding-right:5px">' + $('#Amount' + Id).val() + '</td></tr>');
    ...
    for (var i = 1; i <= Prlen; i++) {
        ...
        if ($('#Procedure' + Id).length) {
            slnm++;
            Rowcount += 1;
            myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + slnm + '</td><td colspan=6 style="padding-left:5px">' + $('#Procedure' + Id).val().substring(0, 20) + '</td><td></td><td></td><td></td><td></td><td align=right style="padding-right:5px">' + $('#ProcTot' + Id).val() + '</td></tr>');
    ...
    for (var a = 0; a <= (14 - slnm) ; a++) {
     
        myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>&#160;</td><td colspan=6 style="padding-left:5px"></td><td style="padding-left:5px"></td><td style="padding-left:5px"></td><td align=center style="padding-left:5px"></td><td style="padding-right:5px" align=right></td><td align=right style="padding-right:5px"></td></tr>');
      }
    ...
    if (parseFloat($('#Discount').val()) != 0) {
        ...
        var ST = parseFloat(parseFloat($('#BaseTextTotalProc').text()) + parseFloat($('#Discount').val())).toFixed(Decimal);
        myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td colspan=9 font-size: 13px;" align=left style="font-weight:bold"></td><td style="font-family:tahoma;font-size: 13px;border-left:1px solid grey;" align=center colspan=2><b>Sub Total</b></td><td style="font-family:tahoma; font-size: 13px;border-left:1px solid grey;"  align=right colspan=2><b>' + ST + '</b></td></tr>');
        myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td colspan=9 font-size: 13px;" align=left style="font-weight:bold"></td><td style="font-family:tahoma;font-size: 13px;border-left:1px solid grey;" align=center colspan=2><b>Dis</b></td><td style="font-family:tahoma; font-size: 13px;border-left:1px solid grey;"  align=right colspan=2><b>' + addCommas(parseFloat($('#Discount').val()).toFixed(Decimal)) + '</b></td></tr>');
...
function PrintthisBillHMSSalesshinewithdiscount(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    //myWindow.document.write('<table width=100% ><tr ><td height=0px></td></tr>');
    //myWindow.document.write('</table>');
    //myWindow.document.write('<table width=100% ><tr ><td style="font-size:175%;" align="center">SHINE HOSPITAL</td></tr>');
    //myWindow.document.write('<table width=100% ><tr ><td style="font-size:120%;" align="center">LABORATORY,ECG & PHARMACY</td></tr>');

    //myWindow.document.write('<table width=100% ><tr ><td style="font-size:100%;" align="center">MARUTHUMMOODU Ph:9995677799,9846915866</td></tr>');
    //myWindow.document.write('</table>');
    ...
    myWindow.document.write('<table style="font-size:50%;border-top:1px solid grey;border-left:1px solid black;border-right:1px solid black" width=100% ><tr ><td width=10% align=left >OP#</td><td colspan=4 align=left width=50%>' + $('#HOpNo').val() + '</td><td align=right width=10%>Bill No</td><td  colspn=2 width=20% >:' + SNo + '</td></tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=50%>' + $('#HPatient').val() + '</td><td align=right width=10%>Date </td><td colspn=2 width=20% >:' + $('#HSalesDate').val() + '</td></tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=50%>' + $('#HDoctor :selected').text() + '</td>' + TypeText + '</tr>');
    myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
    myWindow.document.write('</table>');
    ...
    var HeaderRow = '';
    HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td align=center width=3%>Sl#</td><td colspan=8 align=center width=28%>Product</td><td width=5% align=center>Qty.</td><td align=center width=5%>Amount</td><td align=center width=5%>Discount Amount</td></tr>';

    myWindow.document.write('<table style="border-collapse:collapse;font-size:70%;" frame="box" width=100% bordercolor="grey">' + HeaderRow);
    var slnm = 0;var MrpMAount=0
    for (var i = 0; i <= Rowlen; i++) { 
        var Id = parseInt(i + 1);
        if ($('#Product' + Id).length) {
            slnm++;
            Rowcount += 1;
            MrpMAount += (parseFloat($('#PurPrice' + Id).val()) * parseInt($('#Quantity' + Id).val()))

           // alert(MrpMAount)
            myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#tdSl' + Id).text() + '</td><td colspan=8 style="padding-left:5px">' + $('#Product' + Id).val() + '</td><td align=center style="padding-left:5px">' + $('#Quantity' + Id).val() + '</td><td style="padding-right:5px" align=right>' +(parseFloat( $('#PurPrice' + Id).val())*parseInt($('#Quantity' + Id).val())).toFixed(2)  + '</td><td align=right style="padding-right:5px">' + $('#Amount' + Id).val() + '</td></tr>');
    ...
    //myWindow.document.write(TaxRow);
     var Save=MrpMAount-parseFloat($('#BaseTextTotalProc').text());
    myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td colspan=9 style="font-family:tahoma;font-size: 13px;"><b>YOUR SAVINGS : ' + addCommas(parseFloat(Save).toFixed(Decimal)) + '</b></td><td style="font-family:tahoma;font-size: 13px;border-left:1px solid grey;" align=center colspan=1><b>Total</b></td><td style="font-family:tahoma; font-size: 13px;border-left:1px solid grey;"  align=right colspan=1><b>' + addCommas(parseFloat(MrpMAount).toFixed(Decimal)) + '</b></td><td style="font-family:tahoma; font-size: 13px;border-left:1px solid grey;"  align=right colspan=1><b>' + addCommas(parseFloat($('#BaseTextTotalProc').text()).toFixed(Decimal)) + '</b></td></tr>');
    myWindow.document.write('</table>');

   
    //myWindow.document.write('<table><tr></table>');
...
function PrintthisBillHMSSalesReturn1(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
...
function PrintthisBillHMSSalesReturn(Rowlen, flg, type)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB   -use Landscape mode
{
    ...
    myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=50%>' + $('#HPatient').val() + '</td><td align=right width=10%>Date&#160;&#160;&#160;&#160;&#160; </td><td colspn=2 width=20% >:' + $('#HSalesDate').val() + '</td></tr>');
    myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=50%>' + $('#HDoctor :selected').text() + '</td>' + TypeText + '</tr>');
    myWindow.document.write('<tr><td align=center  colspan=8><u><b>SALES RETURN<b></u></td></tr>');
    myWindow.document.write('</table>');
...
function PrintthisBillLabsugamhosp(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    if (type != 3) { $(ComapnydivToPrintLab).css('height', 130); $(ComapnydivToPrintLab).css('width', 700); }
    else if (type == 3) {
    ...
    myWindow.document.write('<style type="text/css"> #ttttr,#ttttr th,#ttttr td{ border: 1px solid black;border-collapse:collapse;}   .brdrgh{border-right:1px solid grey;} .blclr{color:#00838F} .brtd2 td{border-right:1px solid grey;} .brtd3 td{border-bottom:1px solid grey;} .txbld{font-weight:bold;font-size:20} .txbld1{font-size:15}  </style> <style type="text/css" media="print"> tfoot{display:table-footer-group;} </style> <style type="text/css" media="screen"> tfoot{ position: relative; display: block;} tr { page-break-inside: avoid }</style>');
    myWindow.document.write(PrintBG3);
    ...
    if (Bill == 'LB') {
        ...
        var billhead = "Service Bill"
    }
    else {
        var billhead = "IP BILL"
    }

    myWindow.document.write('<table width=100% ><tr ><td style="font-size:80%;font-family:tahoma;font-width:bold" align=center><u><b>' + billhead + '</b></u></td></tr>');
    myWindow.document.write('</table>');
    var TypeText = '';
    if (Bill == 'LB' || Bill == 'PB') {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-15px" width=100% ><tr ><td width=10% align=left >MR#&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#RegNo').val() + '</td><td width=10%>Date&#160;&#160;&#160;  </td><td  colspn=2 width=20% >:' + $('#BillDate').val() + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#Name').val() + '</td>                                                                        <td width=10%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>                                                            <td width=10%>Bill No</td><td colspn=2 width=20% >:' + SNo + '/' + $('#PayType option:selected').text() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');

    }
    else {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;" width=100% ><tr ><td width=10% align=left >MR#&#160;&#160; :</td><td colspan=4 align=left width=50%>' + $('#OpNo').val() + '</td><td align=left width=5%>Date </td><td  colspn=2 width=15% >:' + $('#BillDate').val() + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=50%>' + $('#Name').val() + '</td><td align=left width=5%>Age/Sex</td><td colspn=2 width=15% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=50%>' + $('#Doctor :selected').text() + '</td><td align=left width=5%>Admit </td><td colspn=2 width=15% >:' + $('#AdmitDate').val() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');

    }

    myWindow.document.write('<table id="ttttr" style=margin-top:-20px;border: 1px solid black; border-collapse: collapse;font-family:tahoma;  width=100%>');

    var HeaderRow = '';
    if (Bill == 'LB') {
        myWindow.document.write('<tr  style="font-size: 12px;" ><td style="font-family:tahoma;">Sl#</td><td  style="font-family:tahoma;"colspan=4  >TestName</td><td  style="font-family:tahoma;"colspan=3 >Charges</td><td style="font-family:tahoma;" align=right>Amount</td></tr>');
    }
    else {
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#TestName' + Id).length) {
            Rowcount += 1;
            if (Bill == 'LB') { myWindow.document.write('<tr><td style="font-family:tahoma;font-size:11px;">' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px;"  colspan=4>' + $('#TestName' + Id).val() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px;"  colspan=3> 1 X' + addCommas($('#TestAmount' + Id).val()) + '</td><td width=20% align=right style="padding-right:5px;font-family:tahoma;font-size: 11px;">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }

            else { myWindow.document.write('<tr ><td style=font-family:tahoma;font-size:11px>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px"  colspan=5>' + $('#TestCode' + Id).val() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px" align=center>' + $('#PQty' + Id).val() + '</td><td style="padding-right:5px;font-family:tahoma;font-size: 11px" align=right>' + $('#PRate' + Id).val() + '</td><td align=right style="padding-right:5px;font-family:tahoma;font-size: 11px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
    ...
    for (var a = 1; a <= (9 - Rowlen); a++) {
        if (Bill == 'LB') {
            myWindow.document.write('<tr><td>&#160;</td><td colspan=4>&#160;</td><td colspan=3>&#160;</td><td>&#160;</td></tr>');
        }
        else {
            myWindow.document.write('<tr><td>&#160;</td><td colspan=5>&#160;</td><td>&#160;</td><td>&#160;</td><td>&#160;</td></tr>');
    ...
    myWindow.document.write('<tr><td>This is a computer generated Bill.</td><td style="font-weight: bold;font-size: 14px;" align=right>Net Total  :</td><td style="font-weight: bold;font-size: 14px;" align=right >' + addCommas(parseFloat($('#GrandTotal').text()).toFixed(Decimal)) + '</td></tr>');
    //myWindow.document.write('<tr><td>.</td></tr></table>');


    //myWindow.document.write('<table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:12px;font-weight: bold;" width=100%><tr><td align=center>GENERAL CLINIC & CASUALTY,DERMATOLOGY,ORTHOPEDICS,PHYCHIATRY,</td></tr><tr><td align=center>PULMONOLOGY,ENT,OBSTETRICS & GYNECOLOGY OP ARE AVAILABLE</td></tr><tr><td align=center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
...
function PrintthisBillLab(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    $(ComapnydivToPrintLab).css('height',120); $(ComapnydivToPrintLab).css('width', 700);
    ...
    var Age = ($('#Age').val()).replace("Years", "Y") + '/' + Gen;
    myWindow.document.write('<style type="text/css">.brdrgh{border-right:1px solid grey;} .blclr{color:#00838F} .brtd2 td{border-right:1px solid grey;} .brtd3 td{border-bottom:1px solid grey;} .txbld{font-weight:bold;font-size:20} .txbld1{font-size:15}  </style> <style type="text/css" media="print"> tfoot{display:table-footer-group;} </style> <style type="text/css" media="screen"> tfoot{ position: relative; display: block;} tr { page-break-inside: avoid }</style>');
    myWindow.document.write(PrintBG3);
   ...
   //myWindow.document.write('<table style="font-family:tahoma;"  width=100% ><tr align=center><td style="font-size: 1.0em;"><B>' + window.CompanySettingsArray.CompanyName + '</B></td></tr><tr><td  align=center style="font-size: 1.0em;">' + window.CompanySettingsArray.Address + '</td></tr><tr><td  align=center style="font-size: 1.0em;" colspan=6>' + window.CompanySettingsArray.Email + '</td></tr><tr><td  align=center style="font-size: 1.0em;border-bottom:1px solid black">' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
    ...
    var powerdby = document.getElementById("printqrr");

    $(powerdby).css('height', 80); $(powerdby).css('width', 80);
   
    myWindow.document.write('<table width=100% ><tr ><td style="font-size:80%;font-family:tahoma;font-width:bold" align=center><u><b>' + billhead + '</b></u></td></tr>');
    myWindow.document.write('</table>');
    var TypeText = '';
    if (Bill == 'LB') {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-15px" width=100% ><tr ><td width=10% align=left >MR#&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#RegNo').val() + '</td><td width=10%>Date</td><td  colspn=2 width=20% >:' + $('#BillDate').val() + '</td>  <td  rowspan=4>' + (powerdby.outerHTML) +'</td>  </tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#Name').val() + '</td>                                                                                         <td width=10%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>                                                                             <td width=10%>Bill No</td><td colspn=2 width=20% >:' + SNo + '/' + $('#PayType option:selected').text() + '</td></tr>');

        myWindow.document.write('<tr><td>&#160;</td><td>&#160;</td><td>&#160;</td><td>&#160;</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');

    }
    else if (Bill == 'PB') {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-15px" width=100% >');
        myWindow.document.write('<tr><td width=10 % align=left > Bill#</td > <td colspan=4 align = left width = 60%> ' + SNo + '/' + $('#PayType option:selected').text() + '</td > <td width=6%>Date</td > <td colspn=2 width = 20% >: ' + $('#BillDate').val() + '</td >  <td  rowspan=5>' + (powerdby.outerHTML) +'</td></tr > ');
       // myWindow.document.write('<tr><td width=10 % align=left > MR#</td > <td colspan=4 align = left width = 60%> ' + $('#RegNo').val() + '</td ><td width=6%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr > ');
        myWindow.document.write('<tr><td width=10% align=left >Patient</td><td colspan=4 align=left width=60%>' + $('#Name').val() + '</td>   <td width=6%>MR No</td><td colspn=2 width=20% >:' + $('#RegNo').val() + '</td></tr>');
        myWindow.document.write('<tr><td width=10% align=left >Doctor</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>  <td width=6%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td>   </tr>');
        myWindow.document.write('<tr><td>&#160;</td><td>&#160;</td><td>&#160;</td><td>&#160;</td><td>&#160;</td><td>&#160;</td><td></td></tr>');
        myWindow.document.write('</table>');

    }
    else {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;" width=100% >');
        myWindow.document.write('<tr><td width=10 % align=left >Bill#</td ><td colspan=4 align = left width = 60%> ' + SNo + '/' + $('#PayType option:selected').text() + '</td > <td width=10%> Date</td > <td colspn=2 width = 20 % >: ' + $('#BillDate').val() + '</td >   <td  rowspan=4>' + (powerdby.outerHTML) +'</td> </tr > ');
        myWindow.document.write('<tr ><td width=10% align=left >MR No#</td><td colspan=4 align = left width = 50 %> ' + $('#RegNo').val() + '</td > <td align=left width=5%> IP# </td > <td colspn=2 width = 15 % >: ' + $('#IpNo').val() + '</td ></tr > ');
        myWindow.document.write('<tr ><td width=10% align=left >Patient</td><td colspan=4 align=left width=50%>' + $('#Name').val() + '</td><td align=left width=5%>Age/Sex</td><td colspn=2 width=15% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor</td><td colspan=4 align=left width=50%>' + $('#Doctor :selected').text() + '</td></tr>   <tr><td align=left width=5%>DOA </td><td colspn=2 width=15% >' + $('#AdmitDate').val() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');
    ...
    if (Bill == 'LB') {
        ...
        myWindow.document.write('<table style=margin-top:0px; border-collapse: collapse;font-family:tahoma;  width=100%>');
        myWindow.document.write('<tr  style="font-size: 12px;border-right:1px solid grey;border-bittom:1px solid grey;"><td style="border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;">Sl#</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" colspan=5  width=50%>Description</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" align=center >Qty</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" align=right >Rate</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;font-family:tahoma;" align=right>Amount</td></tr>');
    }
    ...
    myWindow.document.write('<tr><td>This is a computer generated Bill.</td><td style="font-weight: bold;font-size: 12px;" align=right>Net Total  :</td><td style="font-weight: bold;font-size: 14px;" align=right >' + addCommas(parseFloat($('#GrandTotal').text()).toFixed(Decimal)) + '</td></tr>');
    //myWindow.document.write('<tr><td>.</td></tr></table>');

    

    myWindow.document.write('<table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:10px;font-weight: bold;" width=100%><tr><td align=center>24x7 Emergency,Laboratory,X-RAY/ECG,ECHO,TMT,Ultrasound Scanning</td></tr><tr><td align=center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
    ...
    myWindow.document.write('<table style="font-family:tahoma;font-size:10px;" width=100%><tr><td align=left> Prepared by     -' + BUserNm + '-' + BBilltime+ '</td></tr></table>');
...
function PrintthisBillLabOrginal(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    var TypeText = '';
    if (Bill == 'LB' || Bill == 'PB') {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-15px" width=100% ><tr ><td width=10% align=left >MR#&#160;&#160; :</td><td colspan=4 align=left width=60%>' + $('#RegNo').val() + '</td><td width=10%>Date&#160;&#160;&#160;  </td><td  colspn=2 width=20% >:' + $('#BillDate').val() + ' ' + BBilltime + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#Name').val() + '</td>                                                                        <td width=10%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>                                                            <td width=10%>Bill No</td><td colspn=2 width=20% >:' + SNo + '/' + $('#PayType option:selected').text() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#TestName' + Id).length) {
            Rowcount += 1;
            if (Bill == 'LB') { myWindow.document.write('<tr><td style=font-family:tahoma;font-size:11px>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px"  colspan=7>' + $('#TestName' + Id).val() + '</td><td width=20% align=right style="padding-right:5px;font-family:tahoma;font-size: 11px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
            else { myWindow.document.write('<tr ><td style=font-family:tahoma;font-size:11px>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px"  colspan=5>' + $('#TestCode' + Id).val() + '</td><td style="padding-left:5px;font-family:tahoma;font-size: 11px" align=center>' + $('#PQty' + Id).val() + '</td><td style="padding-right:5px;font-family:tahoma;font-size: 11px" align=right>' + $('#PRate' + Id).val() + '</td><td align=right style="padding-right:5px;font-family:tahoma;font-size: 11px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
    ...
    myWindow.document.write('<table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:12px;font-weight: bold;" width=100%><tr><td align=center>24X7  EMERGENCY, SPECIALITY CONSULTATION, CASUALITY, PHARMACY, LABORATORY, XRAY, ECG</td></tr><tr><td align=center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');


    //myWindow.document.write('<table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:12px;font-weight: bold;" width=100%><tr><td align=center>General Medicine,Casuality,Pediatrics,Orthopedics,Pulmonology,Surgery,Neurology,Speech Therapy,Occupational Therapy, Psychological Counseling, Behaviour Therapy, IQ Test, Physiothreapy, Child Development & Early Intervention</td></tr><tr><td align=center>FOR OP BOOKING CALL-' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
    myWindow.document.write('<table style="font-family:tahoma;font-size:10px;" width=100%><tr><td align=left> Prepared by     -' + BUserNm + '</td></tr></table>');
...
function PrintthisBillLabwithletterthead(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
    ...
    myWindow.document.write('<table width=100% ><tr ><td style="font-size:120%;font-family:tahoma;font-width:bold" align=center><u><b>' + billhead + '</b></u></td></tr>');
    myWindow.document.write('</table>');
    var TypeText = '';
    if (Bill == 'LB' || Bill == 'PB')
    {
        var DT = $('#BillDate').val().substring(8, 10)

        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;margin-top:-35px" width=100% ><tr ><td width=10% align=left >MR No#</td><td colspan=4 align=left width=60%>' + $('#RegNo').val() + '/' + DT + '</td><td width=10%>Date&#160;&#160;&#160;  </td><td  colspn=2 width=20% >:' + $('#BillDate').val() + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Patient:</td><td colspan=4 align=left width=60%>' + $('#Name').val() + '</td>                                                                        <td width=10%>Age/Sex</td><td colspn=2 width=20% >:' + Age + '</td></tr>');
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=60%>' + $('#Doctor :selected').text() + '</td>                                                            <td width=10%>Bill No</td><td colspn=2 width=20% >:' + SNo +'/'+$('#PayType option:selected' ).text()+ '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');
    ...
    {
        myWindow.document.write('<table style="font-family:tahoma;font-size: 12px;" width=100% ><tr ><td width=10% align=left >OP#&#160;&#160; :</td><td colspan=4 align=left width=40%>' + $('#OpNo').val() + '</td><td align=right width=10%>Date&#160;&#160;&#160;&#160;  </td><td  colspn=2 width=20% >:' + $('#BillDate').val() + '</td></tr>');
        ...
        myWindow.document.write('<tr ><td width=10% align=left >Doctor:</td><td colspan=4 align=left width=40%>' + $('#Doctor :selected').text() + '</td><td align=right width=10%>Admit&#160;&#160;&#160; : </td><td colspn=2 width=20% >' + $('#AdmitDate').val() + '</td></tr>');
        myWindow.document.write('<tr><td  colspan=8>&#160;</td></tr>');
        myWindow.document.write('</table>');
        
    }

    myWindow.document.write('<table style=margin-top:-20px; border-collapse: collapse;  width=100%>');

    var HeaderRow = '';
    if (Bill == 'LB')
    {  
        myWindow.document.write('<tr  style="font-size: 12px;border-right:1px solid grey;border-bittom:1px solid grey;" ><td style="border-top:1px solid grey;border-bottom:1px solid grey;">Sl#</td><td  style="border-top:1px solid grey;border-bottom:1px solid grey;"colspan=7  >TestName</td><td style="border-top:1px solid grey;border-bottom:1px solid grey;" align=right>Amount</td></tr>');
     }
    else
    {
        myWindow.document.write('<tr  style="font-size: 12px;border-right:1px solid grey;border-bittom:1px solid grey;"><td style="border-top:1px solid grey;border-bottom:1px solid grey;">Sl#</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;" colspan=5  width=50%>Description</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;" align=center >Qty</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;" align=right >Rate</td><td style="font-size: 14px;border-top:1px solid grey;border-bottom:1px solid grey;" align=right>Amount</td></tr>');
    }
   ...
   // myWindow.document.write('<table style="border-collapse:collapse;font-size:70%;" frame="box" width=100% bordercolor="white">' + HeaderRow);
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#TestName' + Id).length) {
            Rowcount += 1;
            if (Bill == 'LB')
            { myWindow.document.write('<tr><td>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=7>' + $('#TestName' + Id).val() + '</td><td width=20% align=right style="padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
            else
            { myWindow.document.write('<tr ><td >' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=5>' + $('#TestCode' + Id).val() + '</td><td style="padding-left:5px" align=center>' + $('#PQty' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#PRate' + Id).val() + '</td><td align=right style="padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
    ...
    if (parseFloat($('#DiscAmt').val() || 0) != 0) {
        myWindow.document.write('<tr><td  style="font-weight: bold;font-size: 15px;" align=right>Total</td><td style="font-weight: bold;font-size: 15px;" align=right >' + addCommas(parseFloat($('#TotalAmt').text()).toFixed(Decimal)) + '</td></tr>');
        myWindow.document.write('<tr><td  style="font-weight: bold;font-size: 15px;" align=right>Discount</td><td style="font-weight: bold;font-size: 15px;" align=right >  ' + addCommas(parseFloat($('#DiscAmt').val()).toFixed(Decimal)) + '</td></tr>');

    }
    myWindow.document.write('<tr><td  style="font-weight: bold;font-size: 15px;" align=right>Net Amount</td><td style="font-weight: bold;font-size: 15px;" align=right >  ' + addCommas(parseFloat($('#GrandTotal').text()).toFixed(Decimal)) + '</td></tr>');
    myWindow.document.write('<tr><td>This is a computer generated Bill.<td></tr></table>');


    myWindow.document.write('<table style="font-family:tahoma;border-style: double;border-radious:5px;font-size:12px;font-weight: bold;" width=100%><tr><td align=center></td></tr><tr><td align=center></td></tr><tr><td align=center>FOR  BOOKING CALL-8089054919</td></tr></table>');

    myWindow.document.write('<table style="font-family:tahoma" width=100%><tr><td align=center> *****Thankyou for visiting us*****</td></tr></table>');
...
function PrintthisBillLabwithletterthead1(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
   ...
   // myWindow.document.write('<table  width=100% ><tr align=center><td style="font-size: 1.875em;">' + window.CompanySettingsArray.CompanyName + '</td></tr><tr><td  align=center style="font-size: 1.375em;">' + window.CompanySettingsArray.Address + '</td></tr><tr><td  align=center style="font-size: 1.375em;" colspan=6>' + window.CompanySettingsArray.Email + '</td></tr><tr><td  align=center style="font-size: 1.375em;border-bottom:1px solid black">' + window.CompanySettingsArray.PhoneNo + '</td></tr></table>');
    ...
    var HeaderRow = '';
    if (Bill == 'LB')
    { HeaderRow = '<tr class=violetbg style="border-bottom:1px solid grey"><td align=center>Sl#</td><td colspan=7 align=center >TestName</td><td align=right>Amount</td></tr>'; }
    else
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#TestName' + Id).length) {
            Rowcount += 1;
            if (Bill == 'LB')
            { myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=7>' + $('#TestName' + Id).val() + '</td><td width=20% align=right style="border-right:1px solid grey;padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
            else
            { myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=5>' + $('#TestCode' + Id).val() + '</td><td style="padding-left:5px" align=center>' + $('#PQty' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#PRate' + Id).val() + '</td><td align=right style="border-right:1px solid grey;padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
    ...
    myWindow.document.write('<tr style="border:1px solid grey;" class=violetbg><td colspan=8 font-size: 13px;" align=center style="font-weight:bold">' + AmountinWords + '</td><td style="font-family:tahoma; font-size: 10px;border-left:1px solid grey;font-weight:bold"  align=right >' + addCommas(parseFloat($('#GrandTotal').text()).toFixed(Decimal)) + '</td></tr>');
    myWindow.document.write('</table>');
...
function PrintthisBillLabwithtexthead(Rowlen, flg, type, Bill)             //type:1 - HALF   ,type:2 - FULL   ---------- Bill : PB,LB,IB
{
...
var billhead="IP BILL"
    ...
    for (var i = 0; i <= Rowlen; i++) {
        ...
        if ($('#TestName' + Id).length) {
            Rowcount += 1;
            if (Bill == 'LB')
            { myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=7>' + $('#TestName' + Id).val() + '</td><td align=right style="border-right:1px solid grey;padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
            else
            { myWindow.document.write('<tr class=brtd2 ><td style="border-left:1px solid grey;" align=center>' + $('#slrow' + Id).text() + '</td><td style="padding-left:5px"  colspan=5>' + $('#TestCode' + Id).val() + '</td><td style="padding-left:5px" align=center>' + $('#PQty' + Id).val() + '</td><td style="padding-right:5px" align=right>' + $('#PRate' + Id).val() + '</td><td align=right style="border-right:1px solid grey;padding-right:5px">' + addCommas($('#TestAmount' + Id).val()) + '</td></tr>'); }
...
function PrintthisPaymentEntryCopy(Rowlen) {
    ...
    myWindow.document.write('<table style="border-collapse: collapse;border-color:1px solid black" width="100%"><tr><td style="border:1px solid black;" rowspan=2 colspan=2 align=center>' + $('#VEDescription' + Rowlen).text() + '</td><td style="border:1px solid black" align=center>Amount</td></tr>');
    myWindow.document.write('<tr><td align=center style="border:1px solid black" >' + $('#Currency option:selected').text() + '</td></tr>');
    myWindow.document.write('<tr><td style="border-left:1px solid black">Invoice No.: ' + InvNo + '</td><td style="border-right:1px solid black" align:right</td><td align=right style="border-right:1px solid black">' + parseFloat($('#Amount').val() || 0).toFixed(Decimal) + '</td></tr>');

    if (($('#ChequeNo').val() != 0)) {
        myWindow.document.write('<tr><td style="border-left:1px solid black">Cheque No.: ' + $('#ChequeNo').val() + '</td><td style="border-right:1px solid black">Dated: ' + $('#ChequeDate').val() + '</td><td style="border-right:1px solid black" align=right></td></tr>');
    }

    myWindow.document.write('<tfoot><tr  style="border:1px solid black;"><td align="right" colspan=2 style="border-right:1px solid black;">Total</td><td style="border-right:1px solid black" align=right>' + parseFloat($('#Amount').val() || 0).toFixed(Decimal) + '</td></tr></tfoot></table>')
...
function PrintthisPaymentEntrysave(Rowlen) {
    ...
    myWindow.document.write('<table width=100%<tr><td>M/S:&nbsp;&nbsp;&nbsp;' + $('#AccountName').val() + '</td><td align=right >Date:' + $('#Amount').val() + '</td></tr></table>')
