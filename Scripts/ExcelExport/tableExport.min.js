...
(function (c) {
    c.fn.tableExport = function (m) {
        ...
        function P(b) { var d = []; c(b).find("thead").first().find("th").each(function (b, a) { void 0 !== c(a).attr("data-field") ? d[b] = c(a).attr("data-field") : d[b] = b.toString() }); return d } function L(b) {
            var d = "undefined" !== typeof b[0].cellIndex, a = "undefined" !== typeof b[0].rowIndex, h = d || a ? Ca(b) : b.is(":visible"), g = b.data("tableexport-display"); d && "none" !== g && "always" !== g && (b = c(b[0].parentNode), a = "undefined" !== typeof b[0].rowIndex, g = b.data("tableexport-display")); a && "none" !== g && "always" !== g && (g = b.closest("table").data("tableexport-display"));
            ...
            var h = !1; L(b) ? 0 <
            a.ignoreColumn.length && (-1 !== c.inArray(e, a.ignoreColumn) || -1 !== c.inArray(e - d, a.ignoreColumn) || Q.length > e && "undefined" !== typeof Q[e] && -1 !== c.inArray(Q[e], a.ignoreColumn)) && (h = !0) : h = !0; return h
        } function C(b, d, e, h, g) {
            if ("function" === typeof g) {
                var l = !1; "function" === typeof a.onIgnoreRow && (l = a.onIgnoreRow(c(b), e)); if (!1 === l && -1 === c.inArray(e, a.ignoreRow) && -1 === c.inArray(e - h, a.ignoreRow) && L(c(b))) {
                    var y = w(c(b), d), q = 0; y.each(function (b) {
                        var a = c(this), d, l = S(this), h = T(this); c.each(E, function () {
                            if (e >= this.s.r &&
                            e <= this.e.r && q >= this.s.c && q <= this.e.c) for (d = 0; d <= this.e.c - this.s.c; ++d) g(null, e, q++)
                        }); if (!1 === Da(a, y.length, b)) { if (h || l) l = l || 1, E.push({ s: { r: e, c: q }, e: { r: e + (h || 1) - 1, c: q + l - 1 } }); g(this, e, q++) } if (l) for (d = 0; d < l - 1; ++d) g(null, e, q++)
            ...
            if ("undefined" !== typeof c.images && (e = c.images[e], "undefined" !== typeof e)) {
                ...
                a.width / a.height, h = b.width, q = b.height, f = 19.049976 / 25.4, k = 0; l <= d ? (q = Math.min(b.height, a.height), h = a.width * q / a.height) : l > d && (h = Math.min(b.width, a.width), q = a.height * h / a.width); h *= f; q *= f; q < b.height && (k = (b.height - q) / 2); try { c.doc.addImage(e.src, b.textPos.x, b.y + k, h, q) } catch (Ia) { } b.textPos.x += h
            }
        } function oa(b, d) {
            ...
            else try { var e = b.output("blob"); saveAs(e, a.fileName + ".pdf") } catch (h) { fa(a.fileName + ".pdf", "data:application/pdf" + (d ? "" : ";base64") + ",", d ? b.output("blob") : b.output()) }
        } function pa(b, a, e) {
            var d = 0; "undefined" !== typeof e && (d = e.colspan); if (0 <= d) {
                for (var c = b.width, l = b.textPos.x, y = a.table.columns.indexOf(a.column), q = 1; q < d; q++) c += a.table.columns[y + q].width; 1 < d && ("right" === b.styles.halign ? l = b.textPos.x + c - b.width : "center" === b.styles.halign && (l = b.textPos.x + (c - b.width) / 2)); b.width = c; b.textPos.x = l; "undefined" !==
            ...
            function d(b) {
                if (b.url) if (b.src) {
                    var d = new Image; h = ++g; d.crossOrigin = "Anonymous"; d.onerror = d.onload = function () {
                        if (d.complete && (0 === d.src.indexOf("data:image/") && (d.width = b.width || d.width || 0, d.height = b.height || d.height || 0), d.width + d.height)) {
                            var c = document.createElement("canvas"), e = c.getContext("2d"); c.width = d.width; c.height = d.height; e.drawImage(d, 0, 0);
                            b.src = c.toDataURL("image/png")
                        } --g || a(h)
                    }; d.src = b.url
                } else { var e = c(b.url); e.length && (h = ++g, html2canvas(e[0]).then(function (d) { b.src = d.toDataURL("image/png"); --g || a(h) })) }
            } var h = 0, g = 0; if ("undefined" !== typeof b.images) for (var l in b.images) b.images.hasOwnProperty(l) && d(b.images[l]); (b = g) || (a(h), b = void 0); return b
        } function sa(b, d, e) {
            d.each(function () {
                if (c(this).is("div")) {
                    var d = aa(I(this, "background-color"), [255, 255, 255]), g = aa(I(this, "border-top-color"), [0, 0, 0]), l = ba(this, "border-top-width", a.jspdf.unit),
                    y = this.getBoundingClientRect(), q = this.offsetLeft * e.wScaleFactor, f = this.offsetTop * e.hScaleFactor, k = y.width * e.wScaleFactor; y = y.height * e.hScaleFactor; e.doc.setDrawColor.apply(void 0, g); e.doc.setFillColor.apply(void 0, d); e.doc.setLineWidth(l); e.doc.rect(b.x + q, b.y + f, k, y, l ? "FD" : "F")
            ...
            if ("function" === typeof e.onAutotableText) e.onAutotableText(e.doc, b, d); else {
                var h = b.textPos.x, g = b.textPos.y, l = {
                    halign: b.styles.halign,
                    valign: b.styles.valign
                }; if (d.length) {
                    for (d = d[0]; d.previousSibling;) d = d.previousSibling; for (var y = !1, q = !1; d;) {
                        var f = d.innerText || d.textContent || "", k = f.length && " " === f[0] ? " " : "", m = 1 < f.length && " " === f[f.length - 1] ? " " : ""; !0 !== a.preserve.leadingWS && (f = k + ha(f)); !0 !== a.preserve.trailingWS && (f = ia(f) + m); c(d).is("br") && (h = b.textPos.x, g += e.doc.internal.getFontSize()); c(d).is("b") ? y = !0 : c(d).is("i") && (q = !0); (y || q) && e.doc.setFontType(y && q ? "bolditalic" : y ? "bold" : "italic"); if (k = e.doc.getStringUnitWidth(f) * e.doc.internal.getFontSize()) {
                            "linebreak" ===
                            ...
                            e.doc.autoTableText(f, h, g, l); h += k
                        } if (y || q) c(d).is("b") ? y = !1 : c(d).is("i") && (q = !1), e.doc.setFontType(y || q ? y ? "bold" : "italic" : "normal"); d = d.nextSibling
                    } b.textPos.x = h; b.textPos.y = g
                } else e.doc.autoTableText(b.text, b.textPos.x, b.textPos.y, l)
            }
        } function ca(b, a, c) { return null == b ? "" : b.toString().replace(new RegExp(null == a ? "" : a.toString().replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1"), "g"), c) } function ha(b) { return null == b ? "" : b.toString().replace(/^\s+/, "") } function ia(b) {
            ...
            var h = ""; if (null !== b) {
                ...
                a.onCellHtmlData(g, d, e, l); else if ("" !== l) { var f = c.parseHTML(l), q = 0, k = 0; l = ""; c.each(f, function () { if (c(this).is("input")) l += g.find("input").eq(q++).val(); else if (c(this).is("select")) l += g.find("select option:selected").eq(k++).text(); else if (c(this).is("br")) l += "<br>"; else if ("undefined" === typeof c(this).html()) l += c(this).text(); else if (void 0 === jQuery().bootstrapTable || !0 !== c(this).hasClass("filterControl") && 0 === c(b).parents(".detail-view").length) l += c(this).html() }) } if (!0 === a.htmlContent) h = c.trim(l);
                    ...
                    a.type || "excel" === a.type && "xmlss" === a.mso.fileFormat || !1 === a.numbers.output) f = ja(h), !1 !== f && (h = Number(f)); else if (a.numbers.html.decimalMark !== a.numbers.output.decimalMark || a.numbers.html.thousandsSeparator !== a.numbers.output.thousandsSeparator) if (f = ja(h), !1 !== f) {
                        n = ("" + f.substr(0 > f ? 1 : 0)).split("."); 1 === n.length && (n[1] = ""); var p = 3 < n[0].length ? n[0].length % 3 : 0; h = (0 > f ? "-" : "") + (a.numbers.output.thousandsSeparator ? (p ? n[0].substr(0, p) + a.numbers.output.thousandsSeparator : "") + n[0].substr(p).replace(/(\d{3})(?=\d)/g,
                        "$1" + a.numbers.output.thousandsSeparator) : n[0]) + (n[1].length ? a.numbers.output.decimalMark + n[1] : "")
                    }
                } else h = l; !0 === a.escape && (h = escape(h)); "function" === typeof a.onCellData && (h = a.onCellData(g, d, e, h))
            } return h
        } function ua(b) { return 0 < b.length && !0 === a.preventInjection && 0 <= "=+-@".indexOf(b.charAt(0)) ? "'" + b : b } function Ga(b, a, c) { return a + "-" + c.toLowerCase() } function aa(b, a) { (b = /^rgb\((\d{1,3}),\s*(\d{1,3}),\s*(\d{1,3})\)$/.exec(b)) && (a = [parseInt(b[1]), parseInt(b[2]), parseInt(b[3])]); return a } function va(b) {
            var a =
        ...
        } function Ha(a) { for (var b = new ArrayBuffer(a.length), c = new Uint8Array(b), h = 0; h !== a.length; ++h) c[h] = a.charCodeAt(h) & 255; return b } function ra(a) { var b = 0, c; if (0 === a.length) return b; var h = 0; for (c = a.length; h < c; h++) { var g = a.charCodeAt(h); b = (b << 5) - b + g; b |= 0 } return b } function J(b, d, c, h, g, l) {
            var e = !0; "function" === typeof a.onBeforeSaveToFile && (e = a.onBeforeSaveToFile(b,
            d, c, h, g), "boolean" !== typeof e && (e = !0)); if (e) try { if (wa = new Blob([b], { type: c + ";charset=" + h }), saveAs(wa, d, !1 === l), "function" === typeof a.onAfterSaveToFile) a.onAfterSaveToFile(b, d) } catch (q) { fa(d, "data:" + c + (h.length ? ";charset=" + h : "") + (g.length ? ";" + g : "") + "," + (l ? "\ufeff" : ""), b) }
        } function fa(b, d, c) {
            ...
            var b, c = "", h = 0; if ("string" === typeof a) { a = a.replace(/\x0d\x0a/g, "\n"); var g = ""; for (b = 0; b < a.length; b++) { var l = a.charCodeAt(b); 128 > l ? g += String.fromCharCode(l) : (127 < l && 2048 > l ? g += String.fromCharCode(l >> 6 | 192) : (g += String.fromCharCode(l >> 12 | 224), g += String.fromCharCode(l >> 6 & 63 | 128)), g += String.fromCharCode(l & 63 | 128)) } a = g } for (; h < a.length;) {
                var f = a.charCodeAt(h++); g = a.charCodeAt(h++); b = a.charCodeAt(h++);
            ...
            }, preserve: { leadingWS: !1, trailingWS: !1 }, preventInjection: !0, tbodySelector: "tr", tfootSelector: "tr", theadSelector: "tr", tableName: "Table", type: "csv"
        }, K = {
            a0: [2383.94, 3370.39], a1: [1683.78, 2383.94], a2: [1190.55, 1683.78], a3: [841.89, 1190.55], a4: [595.28, 841.89], a5: [419.53, 595.28], a6: [297.64, 419.53], a7: [209.76, 297.64], a8: [147.4, 209.76], a9: [104.88, 147.4], a10: [73.7, 104.88], b0: [2834.65, 4008.19], b1: [2004.09, 2834.65], b2: [1417.32, 2004.09], b3: [1000.63, 1417.32], b4: [708.66, 1000.63],
        ...
        "txt" === a.type) {
            var M = "", W = 0; E = []; n = 0; var ka = function (b, d, e) {
                b.each(function () {
                    p = ""; C(this, d, n, e + b.length, function (b, c, d) {
                        var g = p, e = ""; if (null !== b) if (b = B(b, c, d), c = null === b || "" === b ? "" : b.toString(), "tsv" === a.type) b instanceof Date && b.toLocaleString(), e = ca(c, "\t", " "); else if (b instanceof Date) e = a.csvEnclosure + b.toLocaleString() + a.csvEnclosure; else if (e = ua(c), e = ca(e, a.csvEnclosure, a.csvEnclosure + a.csvEnclosure), 0 <= e.indexOf(a.csvSeparator) || /[\r\n ]/g.test(e)) e = a.csvEnclosure + e + a.csvEnclosure; p = g + (e +
                        ("tsv" === a.type ? "\t" : a.csvSeparator))
                    }); p = c.trim(p).substring(0, p.length - 1); 0 < p.length && (0 < M.length && (M += "\n"), M += p); n++
                }); return b.length
            }; W += ka(c(v).find("thead").first().find(a.theadSelector), "th,td", W); w(c(v), "tbody").each(function () { W += ka(w(c(this), a.tbodySelector), "td,th", W) }); a.tfootSelector.length && ka(c(v).find("tfoot").first().find(a.tfootSelector), "td,th", W); M += "\n"; if ("string" === a.outputMode) return M; if ("base64" === a.outputMode) return H(M); if ("window" === a.outputMode) {
                fa(!1, "data:text/" +
                ("csv" === a.type ? "csv" : "plain") + ";charset=utf-8,", M); return
            } J(M, a.fileName + "." + a.type, "text/" + ("csv" === a.type ? "csv" : "plain"), "utf-8", "", "csv" === a.type && a.csvUseBOM)
        } else if ("sql" === a.type) {
            n = 0; E = []; var A = "INSERT INTO `" + a.tableName + "` ("; r = u(c(v)); c(r).each(function () { C(this, "th,td", n, r.length, function (a, c, e) { A += "'" + B(a, c, e) + "'," }); n++; A = c.trim(A).substring(0, A.length - 1) }); A += ") VALUES "; t = x(c(v)); c(t).each(function () {
                p = ""; C(this, "td,th", n, r.length + t.length, function (a, c, e) { p += "'" + B(a, c, e) + "'," }); 3 <
                p.length && (A += "(" + p, A = c.trim(A).substring(0, A.length - 1), A += "),"); n++
            ...
            var U = []; E = []; r = u(c(v)); c(r).each(function () { var a = []; C(this, "th,td", n, r.length, function (b, c, f) { a.push(B(b, c, f)) }); U.push(a) }); var la = []; t = x(c(v)); c(t).each(function () {
                var a = {}, d = 0; C(this, "td,th", n, r.length + t.length, function (b, c, g) {
                    U.length ?
                    a[U[U.length - 1][d]] = B(b, c, g) : a[d] = B(b, c, g); d++
                }); !1 === c.isEmptyObject(a) && la.push(a); n++
            ...
            n = 0; E = []; var N = '<?xml version="1.0" encoding="utf-8"?>'; N += "<tabledata><fields>"; r = u(c(v)); c(r).each(function () {
                C(this, "th,td",
                n, r.length, function (a, c, e) { N += "<field>" + B(a, c, e) + "</field>" }); n++
            }); N += "</fields><data>"; var xa = 1; t = x(c(v)); c(t).each(function () { var a = 1; p = ""; C(this, "td,th", n, r.length + t.length, function (b, c, f) { p += "<column-" + a + ">" + B(b, c, f) + "</column-" + a + ">"; a++ }); 0 < p.length && "<column-1></column-1>" !== p && (N += '<row id="' + xa + '">' + p + "</row>", xa++); n++ }); N += "</data></tabledata>"; if ("string" === a.outputMode) return N; if ("base64" === a.outputMode) return H(N); J(N, a.fileName + ".xml", "application/xml", "utf-8", "base64", !1)
        } else if ("excel" ===
        a.type && "xmlss" === a.mso.fileFormat) {
            var ma = [], z = []; c(v).filter(function () { return L(c(this)) }).each(function () {
                function b(a, b, d) {
                    var e = []; c(a).each(function () {
                        var b = 0, g = 0; p = ""; C(this, "td,th", n, d + a.length, function (a, d, l) {
                            if (null !== a) {
                                var f = ""; d = B(a, d, l); l = "String"; if (!1 !== jQuery.isNumeric(d)) l = "Number"; else { var h = Fa(d); !1 !== h && (d = h, l = "Number", f += ' ss:StyleID="pct1"') } "Number" !== l && (d = d.replace(/\n/g, "<br>")); h = S(a); a = T(a); c.each(e, function () {
                                    if (n >= this.s.r && n <= this.e.r && g >= this.s.c && g <= this.e.c) for (var a =
                                    0; a <= this.e.c - this.s.c; ++a) g++, b++
                                }); if (a || h) a = a || 1, h = h || 1, e.push({ s: { r: n, c: g }, e: { r: n + a - 1, c: g + h - 1 } }); 1 < h && (f += ' ss:MergeAcross="' + (h - 1) + '"', g += h - 1); 1 < a && (f += ' ss:MergeDown="' + (a - 1) + '" ss:StyleID="rsp1"'); 0 < b && (f += ' ss:Index="' + (g + 1) + '"', b = 0); p += "<Cell" + f + '><Data ss:Type="' + l + '">' + c("<div />").text(d).html() + "</Data></Cell>\r"; g++
                            }
                        }); 0 < p.length && (F += '<Row ss:AutoFitHeight="0">\r' + p + "</Row>\r"); n++
                    }); return a.length
                } var d = c(this), e = ""; "string" === typeof a.mso.worksheetName && a.mso.worksheetName.length ?
                e = a.mso.worksheetName + " " + (z.length + 1) : "undefined" !== typeof a.mso.worksheetName[z.length] && (e = a.mso.worksheetName[z.length]); e.length || (e = d.find("caption").text() || ""); e.length || (e = "Table " + (z.length + 1)); e = c.trim(e.replace(/[\\\/[\]*:?'"]/g, "").substring(0, 31)); z.push(c("<div />").text(e).html()); !1 === a.exportHiddenCells && (G = d.find("tr, th, td").filter(":hidden"), R = 0 < G.length); n = 0; Q = P(this); F = "<Table>\r"; var f = b(u(d), "th,td", f); b(x(d), "td,th", f); F += "</Table>\r"; ma.push(F)
            }); m = {}; for (var D = {}, k, O,
        ...
        a.type && "xlsx" === a.mso.fileFormat) {
            z = []; var ya = XLSX.utils.book_new(); c(v).filter(function () { return L(c(this)) }).each(function () {
            ...
            m = "excel" === a.type || "xls" === a.type ? "excel" : "word"; D = "excel" === m ? "xls" : "doc"; k = 'xmlns:x="urn:schemas-microsoft-com:office:' + m + '"'; var F = "", X = ""; c(v).filter(function () { return L(c(this)) }).each(function () {
                var b =
                c(this); "" === X && (X = a.mso.worksheetName || b.find("caption").text() || "Table", X = c.trim(X.replace(/[\\\/[\]*:?'"]/g, "").substring(0, 31))); !1 === a.exportHiddenCells && (G = b.find("tr, th, td").filter(":hidden"), R = 0 < G.length); n = 0; E = []; Q = P(this); F += "<table><thead>"; r = u(b); c(r).each(function () {
                    var b = c(this); p = ""; C(this, "th,td", n, r.length, function (c, d, g) {
                        if (null !== c) {
                            var e = "", f = document.defaultView.getComputedStyle(c, null), h = document.defaultView.getComputedStyle(b[0], null); p += "<th"; for (var k in a.mso.styles) {
                                var m =
                                f[a.mso.styles[k]]; "" === m && (m = h[a.mso.styles[k]]); "" !== m && "0px none rgb(0, 0, 0)" !== m && "rgba(0, 0, 0, 0)" !== m && (e += "" === e ? 'style="' : ";", e += a.mso.styles[k] + ":" + m)
                            } "" !== e && (p += " " + e + '"'); e = S(c); 0 < e && (p += ' colspan="' + e + '"'); e = T(c); 0 < e && (p += ' rowspan="' + e + '"'); p += ">" + B(c, d, g) + "</th>"
                        }
                    }); 0 < p.length && (F += "<tr>" + p + "</tr>"); n++
                }); F += "</thead><tbody>"; t = x(b); c(t).each(function () {
                    var b = c(this); p = ""; C(this, "td,th", n, r.length + t.length, function (d, f, g) {
                        if (null !== d) {
                            var e = B(d, f, g), h = "", k = c(d).data("tableexport-msonumberformat"),
            ...
            }); k = '<html xmlns:o="urn:schemas-microsoft-com:office:office" ' + k + ' xmlns="http://www.w3.org/TR/REC-html40">' + ('<meta http-equiv="content-type" content="application/vnd.ms-' +
            ...
            k += "br {mso-data-placement:same-cell;}"; k += "</style>"; k += "</head>"; k += "<body>"; k += '<div class="Section' + ("landscape" === a.mso.pageOrientation ? "2" : "1") + '">'; k += F; k += "</div>"; k += "</body>"; k += "</html>"; if ("string" === a.outputMode) return k; if ("base64" === a.outputMode) return H(k); J(k, a.fileName + "." + D, "application/vnd.ms-" + m, "", "base64", !1)
            ...
            } if (null == f.doc && (f.doc = new jsPDF(a.jspdf.orientation, a.jspdf.unit, a.jspdf.format), f.wScaleFactor = 1, f.hScaleFactor = 1, "function" === typeof a.jspdf.onDocCreated)) a.jspdf.onDocCreated(f.doc); !0 === f.outputImages && (f.images = {}); "undefined" !== typeof f.images && (c(v).filter(function () { return L(c(this)) }).each(function () {
                var b =
                0; E = []; !1 === a.exportHiddenCells && (G = c(this).find("tr, th, td").filter(":hidden"), R = 0 < G.length); r = u(c(this)); t = x(c(this)); c(t).each(function () { C(this, "td,th", r.length + b, r.length + t.length, function (a) { qa(a, c(a).children(), f) }); b++ })
            }), r = [], t = []); Ea(f, function () {
                c(v).filter(function () { return L(c(this)) }).each(function () {
                    ...
                    }); f.headerrows = []; r = u(c(this)); c(r).each(function () {
                    ...
                    }); if (0 < n) for (var e = n - 1; 0 <= e;) c.each(f.headerrows[e], function () { var a = this; 0 < e && null === this.rect && (a = f.headerrows[e - 1][this.key]); null !== a && 0 <= a.rowIndex && (!0 !== a.style.hasOwnProperty("hidden") || !0 !== a.style.hidden) && f.columns.push(a) }), e = 0 < f.columns.length ? -1 : e - 1; var h = 0; t = []; t = x(c(this)); c(t).each(function () {
                        var a = []; b = 0; C(this, "td,th", n, r.length + t.length, function (d, e, g) {
