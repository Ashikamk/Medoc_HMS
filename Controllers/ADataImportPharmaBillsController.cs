...
{
    public class ADataImportPharmaBillsController : Controller
    {
        ...
        [HttpPost]
        public String PHBilldataInserted(HttpPostedFileBase filename)
        {
            try
            {
                string dirpath = "";
        ...
        int ConvertToDataTable(long stockistId)
        {
            ...
            DataSet dsDataSet = new DataSet();
                ...
                else
                {
                    ...
                    dsDataSet = obj.PHARMAProductFileUpload(dt, dbName);
                    //message.Visible = true;
